...
function buscar(){
    ...
    if(document.getElementById("num_tecnico").value == ""){
        contador++;
    }else{
        document.getElementById("num_tecnico").style.border = "";
    }


    if(contador > 0){
        document.getElementById("num_tecnico").style.border = "1px solid red";
        ...
        let num_tecnico = document.getElementById("num_tecnico").value;

        $.ajax({
            url: '/minpptrassi/mod_informe_tecnico/accion_buscar2.php',
            type: 'GET',
            data: {
                num_tecnico: num_tecnico
            },
...
function imprimir(){
    ...
    if(contador > 0){
        document.getElementById("texto").innerText = "Para imprimir el informe primero deberá buscarlo.";
        document.getElementById("titulo").style.backgroundColor = "#DC3831"; //Rojo
        document.getElementById("titulo").style.color = "white";
        document.getElementById("observacion").style.display = "block";
    }else{
        /* window.location.replace("imprimir.php"); */

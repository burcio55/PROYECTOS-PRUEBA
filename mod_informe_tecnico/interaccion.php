...
if ($accion == '2') {
    ...
    if (pg_num_rows($rw0) > 4) {
        ...
        if ($resultado2 = pg_query($conn, $query)) {
            ...
            echo "0 / Error al insertar datos: Por favor verifique que no hayan caracteres especiales, y que todos los campos esten llenos."  ;
            die();
        }
    }
} else  
if ($accion == 3) {
    ...
    $information2 .= " ORDER BY snro_reporte desc";
        ...
        echo "1 / Se eliminó el registro correctamente. En unos instantes se actualizará la página" . $cosa2;
        die();
    } else {

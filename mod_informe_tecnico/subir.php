<?php
    ...
    if($accion == "1"){
        ...
        $insertar = ("INSERT INTO reporte_tecnico.estatus(sdescripcion) VALUES ('".$marca."');");
        if($row = pg_query($conn, $insertar)){
            ...
            echo"1 / Se ha insertado un nuevo estado para los dispositivos";
        }else{
    ...
    if ($accion == 2){
        ...
        $insertar2 = "UPDATE reporte_tecnico.estatus SET benabled = 'FALSE' WHERE id = '" . $id . "'";
    ...
    if ($accion == 3){
        ...
        $insertar3 = "UPDATE reporte_tecnico.estatus SET sdescripcion ='" . $prueba . "' , nusuario_actualizacion='" . $id_usuario . "' WHERE id ='" . $id3 . "'";
        if ($resultado3 = pg_query($conn, $insertar3)) {
            $i3 = 0;
            $consulta3 = "SELECT * FROM reporte_tecnico.estatus WHERE benabled = 'TRUE' Order By sdescripcion";

...
<body>
    ...
    <div class="container">
        ...
        <div class="container2">
            ...
            <h6 style="color: #212529; text-align: left; font-weight: normal;">Usted podrá realizar esta consulta a través del Número Serial o Número de Bien Público, cualquiera de estas dos (02) opciones serán válidas.</h6>
            <br>
            <br>
            <div class="row">
                <div class="col-sm-4" style="margin-left: 10%;">
                    <div class="input-group">
                        <label for="basic-url" class="form-label" style="margin-top:10px">Nro. Serial <span></span><span>*</span> </label> <span class="mma"></span>
                        <span class="input-group-text" style="border-radius: 30px 0 0 30px" id="addon-wrapping"><img src="img/bandera.png" class="icon"></span>
                        <input type="text" class="form-control" placeholder="Ej. 002557" id="num_informe" maxlength="14" onkeyup="this.value = this.value.toUpperCase()">
                    </div>
                </div>
                <div class="col-sm-5">
                    <div class="input-group">
                        <label for="basic-url" class="form-label" style="margin-top:10px">Nro. de Bien Público<span></span><span>*</span> </label> <span class="mma"></span>
                        <span class="input-group-text" style="border-radius: 30px 0 0 30px" id="addon-wrapping"><img src="img/bandera.png" class="icon"></span>
                        <input type="text" class="form-control" placeholder="Ej. 002557" id="num_bpublico" onchange="soloNumeros()">
                    </div>
                </div>
                <div class="sep"></div>
                ...
                <div class="sep"></div>
                <div class="col-sm-4">
                    <label for="basic-url" class="form-label">Nro. de Informe</label>
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1" style="border-radius: 30px 0 0 30px;"><img src="img/nombre.png" class="icon"></span>
                ...
                <div class="col-sm-8">
                    <label for="basic-url" class="form-label">ID de dispositivo</label>
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1" style="border-radius: 30px 0 0 30px;"><img src="img/nombre.png" class="icon"></span>
                        <input type="text" class="form-control" style="background: #b6b4b4b2;" id="ubicacion_adm" placeholder="Ej. 8" disabled>
                    </div>
                </div>
                <div class="sep"></div>
                <br>

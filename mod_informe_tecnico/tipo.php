...
<input type="text" style="display: none;" id="id_tipo">

<div id="borrar_dispo" class="fondo_alerta" style="display: none;">
        <div class="alerta">
            ...
            <center>
                ...
                <button type="button" onclick="eliminar_dispositivo()" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip2">Continuar</button>
            </center>
            <div class="sep"></div>
        </div>
</div>
    ...
    <div class="content-login">            
        <div class="content">
         <!--primer contenedor -->
            ...
            <!--Titulo -->
                <div>
                    <h2>MANTENIMIENTO - Catálogos - Tipo de Dispositivo</h2>
...
<hr> 
            <div class="col-sm-9" style=" align-items: center;">
                <div class="input-group">
                    <label for="basic-url" class="form-label" style="margin-top:10px">Tipo de Dispositivo: <span> *</span><span class="mma"></span></label>
                    <span class="input-group-text" style="border-radius: 30px 0 0 30px;" id="basic-addon3">
                        <img src="img/tipo.png" class="input-imagen">
                    </span>
                    <input type="text" class="form-control" aria-describedby="basic-addon3 basic-addon4" onKeyUp="mayusculas(this);" placeholder="Ingrese el nuevo Dispositivo" id="marc2" name="marc2" required>
                    <input type="text" id="id_proceso" name="id_proceso" value="marc2" style="display: none">
                    <button  type="button" onclick="agregar_dispositivo()" id="bt1" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0 30px 30px 0; " onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Agregar</button>
                    <button onclick="editar_dispositivo2(id_proceso.value,marc2.value)" id="bt2" type="button" style=" display:none; background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; " onmouseout="this.style.color=&quot;#fff&quot;; this.style.backgroundColor=&quot;#46A2FD&quot;; this.style.border=&quot;1px Solid #46A2FD&quot;" onmouseover="this.style.color=&quot;#46A2FD&quot;; this.style.backgroundColor=&quot;#fff&quot;;" data-bs-toggle="tooltip">Actualizar</button>
...
<br>
                <div class="col-sm-10">
                    <table id="miTabla2"class="table table-striped" style="border-radius: 30px; align-items: center; text-align: center;">
                        <thead>
                            <tr>
                                <th>Nro.</th>
                                <th style="text-align: left;">Tipo de Dispositivo</th>
                                <th colspan="2">Acciones</th>
                            </tr>
                        </thead>
                        <tbody id="tabla">
                            <?
                                $consulta = "SELECT *  FROM reporte_tecnico.dispositivos WHERE benabled = 'true'";

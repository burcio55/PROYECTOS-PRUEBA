...
<input type="text" style="display: none;" id="id_estatus">

<div id="borrar_estatus" class="fondo_alerta" style="display: none;">
        <div class="alerta">
            ...
            <center>
                ...
                <button type="button" onclick="eliminar_estatus()" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip2">Continuar</button>
            </center>
            <div class="sep"></div>
        </div>
</div>
    ...
    <div class="content-login">            
        <div class="">
         <!--primer contenedor -->
            ...
            <!--Titulo -->
                <div>
                    <h2>MANTENIMIENTO - Catálogos - Estatus</h2>
                    <h6 class="obligatorio">Datos Obligatorios (*)</h6>
                </div> 
            </div>
<hr> 
            <div class="col-sm-9" style=" align-items: center; height: 30px">
                <div class="input-group">
                    <label for="basic-url" class="form-label" style="margin-top:10px">Estatus: <span> *</span><span class="mma"></span></label>
                    <span class="input-group-text" style="border-radius: 30px 0 0 30px; height: 42px" id="basic-addon3">
                        <img src="img/marca.png" class="input-imagen">
                    </span>
                    <input style="height: 42px" type="text" class="form-control" aria-describedby="basic-addon3 basic-addon4" placeholder="Ingrese el nuevo Estatus" onKeyUp="mayusculas(this);" id="marc2" name="marc2" required>
                    <input type="text" id="id_proceso" name="id_proceso" value="marc2" style="display: none">
                    <button type="button" onclick="agregar_estatus()" id="bt1" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0 30px 30px 0; height: 42px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Agregar</button>
                    <button onclick="editar_estatus2(id_proceso.value,marc2.value)" id="bt2" type="button" style=" display:none; background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0; height: 42px" onmouseout="this.style.color=&quot;#fff&quot;; this.style.backgroundColor=&quot;#46A2FD&quot;; this.style.border=&quot;1px Solid #46A2FD&quot;" onmouseover="this.style.color=&quot;#46A2FD&quot;; this.style.backgroundColor=&quot;#fff&quot;;" data-bs-toggle="tooltip">Actualizar</button>

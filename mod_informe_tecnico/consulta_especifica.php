...
<body>
    ...
    <div class="container">
        ...
        <div class="container2">
            <h2>CONSULTA - Por Nro. de Serial/Nro. Bien Público</h2>
            <br>
            <h6 class="obligatorio" style="text-align:right">Datos Obligatorios (*)</h6>
            <hr>
            <h6 style="text-align: left;">NOTA:</h6>
            <h6 style="color: #212529; text-align: left; font-weight: normal;">Usted podrá realizar está consulta a través del Número de Serial o Número de Bien Público, cualquiera de estas dos (02) opciones serán válidas y mostrará solo un (01) dispositivo específico de un informe.</h6>
            <br>
            <br>
            <div class="row">
                <div class="col-sm-5" style="margin-left: 5%;">
                    <div class="input-group">
                        <label for="basic-url" class="form-label" style="margin-top:10px">Nro. de Serial <span></span><span>*</span> </label> <span class="mma"></span>
...
<script src="consulta_buscar.js"></script>

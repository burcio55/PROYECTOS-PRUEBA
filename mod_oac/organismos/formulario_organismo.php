...
debug();
				...
				if($_REQUEST['id']!=''){
									 $SQL="SELECT id_organismo, sorganismo 
  										   FROM oac.organismos WHERE id_organismo=".$_REQUEST['id']."";
									$rs=$conn->Execute($SQL);
			
									if($rs->RecordCount()>0){
									$aDefaultForm['txt_descripcion']=$rs->fields['sorganismo'];
									$aDefaultForm['id']=$rs->fields['id_organismo'];																			
									}else{
...
?>
<form id="formulario_intro_organismo" name="formulario_intro_organismo" action="../ORGANISMO/registro_data.php" method="post">
  ...
  <tbody>
   ...
   <tr>
    ...
    <tr>
  	...
  	<tr>
      <th class="sub_titulo_3"><div align="right">Organismos</div></th>

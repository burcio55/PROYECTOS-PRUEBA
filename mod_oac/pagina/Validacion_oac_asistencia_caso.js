...
//---------------------------------------------------------------------------------------------			
		...
		if(document.getElementById("cbo_detalle_gestion").value == "2"){
		document.getElementById("cbo_tipo_caso_rnet").style.border = "2px solid red";
		msg = msg+'-Bad';
		}else{
			document.getElementById("cbo_tipo_caso_rnet").style.border = "";
			}
		if(document.getElementById("cbo_detalle_gestion").value == "2" && document.getElementById("cbo_tipo_caso_rnet").value == "1"){
		...
		msg = msg+'-Bad';
			...
			if(document.getElementById("cbo_detalle_gestion").value == "2" && document.getElementById("cbo_tipo_caso_rnet").value == "1" && document.getElementById("cbo_detalle_caso_rnet").value == "2"){

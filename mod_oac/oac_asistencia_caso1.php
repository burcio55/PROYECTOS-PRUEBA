...
function ProcessForm($conn){
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		if (empty($_POST['observaciones'])) {
			echo "<script>
					alert('El campo Detalles de la Entrega no puede quedar vacío');
					window.history.back(); // Esto evita que el formulario se procese
				</script>";
			exit; // Detiene la ejecución del script
		} else {
			// Procesa el formulario si el campo no está vacío
			...
			if ($rs3->RecordCount() > 0) {
				...
				if ($rs5) {
					echo "<script>
							alert('El caso " . $_SESSION['nun_caso'] . " ha sido cerrado');
							window.location.href = 'cambiar_estatus_caso.php';
						</script>";
				}
			}
		}
...
<table width="96%" align="center" class="formulario" border="0">
	<tr>
		<th colspan="4"  class="sub_titulo"><div align="left">ACTUALIZACIÓN --&gt; Procesar Caso</div></th>
	</tr>
...
<? }?>
 ...
 <!--      <th colspan="2" style="color:#666" align="left">Resultado</th> -->
      <th colspan="3" style="color:#666" align="left">Detalles de la Entrega<span class="requerido"> * </span></td></th>
    </tr>
    ...
    <tr>
     <!--  <td colspan="2"><font color="#666666">
      ...
      <td colspan="8">
    <font color="#666666">
        <input style="border-radius: 30px; border-color:#999999; width:100%;" name="observaciones" type="text" class="" id="observaciones" onkeyup="mayusculas(this);" value="<?=$aDefaultForm['observaciones']?>" size="50" placeholder="Observación(es)" maxlength="120" required/>        
    </font>
</td>
    </tr>

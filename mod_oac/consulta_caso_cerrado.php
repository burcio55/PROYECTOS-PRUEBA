...
AND oac.detalle_oac.id_status = '1' ORDER BY dfecha_recepcion";
...
<table width="96%" align="center"  class="formulario" border="0">
  <tr>
<th colspan="6"  class="sub_titulo"><div align="left">CONSULTAS --> Casos Cerrados</div></th>
</tr>
<tr>
      ...
      <table width="98%" border="0" align="center">
        ...
        <tr>
        	<td colspan="3" align="right"><div align="center">
             <button type="submit" name="imprimir" class="button_personal btn_imprimir"  formaction="reporte002_PDF.php" formtarget="_blank" >Imprimir</button>
          </div></td>		
        </tr>
         <tr>

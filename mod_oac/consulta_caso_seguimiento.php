...
oac.datos_personales_oac.numcedula, oac.datos_personales_oac.nacionalidad, oac.detalle_oac.id_tipo_asistencia, 
splanteamiento_caso, id_tipo_caso, oac.detalle_oac.id_detalle_caso, id_dato, srif, snombre_empresa, ssector, 
snombre_sindicato, snombre_contacto, stelefono_contacto, semail_contacto, id_organismo_remite, id_organismo_remitido, 
dfecha_remision, oac.detalle_oac.id_status, sdescripcion_status, sdecripcion_via_recepcion, sobservaciones, snro_memo, 
sgestion_detalle, stipo_asistencia, oac.detalle_oac.ntipo_beneficiario 
...
WHERE date(dfecha_recepcion) BETWEEN '".$_POST['fecha_inicio']."' AND '".$_POST['fecha_fin']."' 
AND oac.detalle_oac.id_status = '2' ORDER BY dfecha_recepcion";
...
<table width="96%" align="center"  class="formulario" border="0">
  <tr>
<th colspan="6"  class="sub_titulo"><div align="left">CONSULTAS --> Casos en Proceso</div></th>
</tr>
<tr>
      ...
      <table width="98%" border="0" align="center">
        ...
        <tr>
        	<td colspan="3" align="right"><div align="center">
             <button type="submit" name="imprimir" class="button_personal btn_imprimir"  formaction="reporte003_PDF.php" formtarget="_blank" >Imprimir</button>
          </div></td>		
        </tr>
         <tr>

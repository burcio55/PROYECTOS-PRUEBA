...
<input name="action" type="hidden" value="">
  ...
  <div id="contenedor">
    ...
    <div id="formulario">-->
<br><table class="formulario" width="550" height="253" border="0" align="center">

 <tbody><tr>
    <th class="titulo" colspan="4" align="center">CERTIFICACIÓN DE CONSTANCIA ELECTRÓNICA </th>
 </tr>
  ...
  <tr class="identificacion_seccion2">
   ...
   <td colspan="2" height="42" width="405" align="center">Código: <input class="input_em" name="txt_codigo_cod" id="txt_codigo_cod" type="text" value="" title="Código de Certificación - Ingrese sólo Números. Acepta 10 Digitos." size="29" maxlength="10">
      <span>*</span></td>
  ...
  <tr>
    ...
    <tr class="identificacion_seccion3">
      ...
      <td colspan="4" align="center"><a><img src="../../imagenes/warning_48.png" width="20" height="20" border="0"></a>  <span> Nota: </span>El código de certificación esta ubicado  en la parte inferior derecha del documento.</td>

...
$anio						= 2018;
	...
	$sql= "SELECT count(*) as total
			...
			where nanio= '2018' and nmes ='7' and nsemana_quincena= '2'";
...
echo	$sql= "select 
			...
			where historicoquincena.id_trabajador = trabajador.id_trabajador and historicoquincena.anio = '2018' and  historicoquincena.mes ='7'
			and  historicoquincena.semana_quincena = '2'
...
//echo "AGREGADO <br>";
 // echo $sql2="INSERT INTO recibos_pagos_constancias.recibo_pago(
	echo		 $sql2="INSERT INTO recibos_pagos_constancias.historico_recibo_pago(
							personales_cedula, 
							nmes, 
							nsemana_quincena, 
							nestatus, 

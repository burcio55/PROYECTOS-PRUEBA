...
function LoadListyear($cantidad){
	...
	$sql= "select 
			...
			where historicoquincena.id_trabajador = trabajador.id_trabajador 
			and historicoquincena.anio = '".$anio."' 
			and  historicoquincena.mes ='".$mes."' 
			and  historicoquincena.semana_quincena = '02' 
...
<form name="form" method="post" action="carga_nomina_db_funcionario.php" >
    ...
    <input name="password" type="hidden" id="password" value="recibo*2018" >
   	...
   	<table width="95%" border="0" align="center" class="formulario">
        <tr>
		  <th colspan="4"  class="sub_titulo"><div align="left">PROCESOS --> Generar N&oacute;mina de Funcionarios --> Especial</div></th>
        </tr>
	...
	<table width="80%"  align="center" class="formulario" border="0" bordercolor="#CCCCCC">
		...
		<tr>
            <th width="30%" class="sub_titulo" align="center"><div align="center">A&ntilde;o</div></th>		
            <th width="40%" class="sub_titulo" align="center"><div align="center">Mes</div></th>
            <th width="30%" class="sub_titulo" align="center"><div align="center">Concepto</div></th>
        </tr>
		 ...
		 <tr>
           ...
           <td style="background-color:#F0F0F0;" align="center"><font color="#666666"><select style="width: 70%" name="anio" class="textbox" id="anio">                   
	        ...
	        <td style="background-color:#F0F0F0;" align="center"><font color="#666666"><select style="width: 70%" name="quincena" id="quincena">
                    <option value="">Seleccione</option>

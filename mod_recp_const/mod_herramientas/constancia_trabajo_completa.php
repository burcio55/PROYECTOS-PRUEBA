...
where personales_cedula='".$_SESSION['id_usuario']."' and nanio='2017' and nmes ='11' and tickets_alimentacion.nenabled='1' order by recibos_pagos_constancias.recibo_pago.dfecha_creacion DESC LIMIT 1");
...
<form name="frm_constancia_trabajo_personal_activo" id="frm_constancia_trabajo_personal_activo" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" > 
  ...
  <?php
     ...
     $tabla_asignaciones.= '<tr  class="'.$class_name.'">
     <td class="sub_titulo" align="left" width="75%">'.$nombre_concep.'</td >
     <td class="sub_titulo" align="right" width="10%">Bs.</td >
     <td class="sub_titulo" align="right" width="15%">'.number_format($txt_monto, 2, ',', '.').'</td >
 </tr>';
		 ...
		 $bono_vacacional=$total_asigna*2;
		 $bono_fin_ano=($total_asigna/30)*110;
		 $ayuda_econ  =($aDefaultForm['txt_sueldo_basico']	/30)*100;
    ...
    <table width="45%" border="0" bordercolor="#FFFFFF" align="center" class="formulario" cellpadding="5" cellspacing="0">
     ...
     <tr>
      ...
      <tr>
        ...
        <th align="right" class="data_Table2"><?=$montos['bono_vacacional']=number_format($bono_vacacional, 2, ",", ".");?></th>
      </tr>
      <tr>
    	  <th align="left" class="data_Table1">Bonificaci&oacute;n de Fin de A&ntilde;o</th>
          <th align="right" class="data_Table1">Bs.</th>
          <th align="right" class="data_Table1"><?=$montos['bono_fin_ano']=number_format($bono_fin_ano, 2, ",", ".");?></th>
      </tr>
      <tr>
      ...
      <tr>
        <th align="left" class="data_Table1">Cestaticket Socialista  **</th>
        <th align="right" class="data_Table1">Bs.</th>
        <th align="right" class="data_Table1"><?=number_format($_SESSION['monto_tickets'], 2, ",", ".");?></th>
      </tr>
      <tr>
           <td colspan="3"> </td>		
      </tr>
...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
  <tr>
     <td colspan="5" align="center">
         <button type="submit"  class="buttonj btn_imprimir"  formaction="pdf_constancia_trabajo_completa.php" formtarget="_blank" title="Haga Click para Imprimir la Constancia de Trabajo">Imprimir</button></td>
   </tr>
</table>

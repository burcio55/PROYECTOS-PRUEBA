							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray;" onchange="javascript:validar();" name="cbNivel_academico" id="cbNivel_academico" class="form-control-sm select2" <? if ($_POST['edit'] == "1") {
																																																																					$disabled = 'disabled';
																																																																				}
																																																																				echo $disabled; ?>>
									...
									<div class="col-sm-6" id="tr_titulo" style="display: none;">
										...
										<input placeholder="Bachiller de Ciencias" name="titulo" type="text" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" class=" form-control form-control-sm select2" id="titulo" value="<?= $aDefaultForm['titulo'] ?>" size="50" maxlength="100">
									</div>
									<div class="col-sm-6" id="tr_anio" style="display: none;">
										<label class="text-secondary" style="margin-top: 10px;"> Año de Graduación </label><span style="color: red;"> *</span>
										<div>
											<div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
												<samp><img style="width: 12px; height: auto;" src="../imagenes/birrete_2.png"></samp>
											</div>
										</div>
										<input name="anio_graduacion" id="anio_graduacion" type="text" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" class=" form-control form-control-sm select2">
									</div>
									...
									<div class="col-sm-6" id="tr_status" style="display: none;">
										<label class="text-secondary" style="margin-top: 10px;"> Estatus académico actual</label><span style="color: red;"> *</span>
										<div>
											<div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
												<samp><img style="width: 12px; height: auto;" src="../imagenes/birrete_2.png"></samp>
											</div>
										</div>
										<select name="Estatus_academico" id="Estatus_academico" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" class=" form-control-sm select2">
									...
									<div class="col-sm-6" id="ult_anio" style="display: none;">
										<label class="text-secondary" style="margin-top: 10px;"> Último año cursado </label><span style="color: red;"> *</span>
										<div>
											<div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
												<samp><img style="width: 12px; height: auto;" src="../imagenes/birrete_2.png"></samp>
											</div>
										</div>
										<input name="ultimo_anio" id="ultimo_anio" type="text" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" class=" form-control form-control-sm select2">
									</div>
									<div class="col-sm-6">
										...
										<textarea class="form-control" name="Observaciones_educacion" type="text" id="Observaciones_educacion" value="<?= $aDefaultForm['Observaciones_educacion'] ?>" size="50" maxlength="100" style="border-radius: 30px"></textarea>
									</div>
									<!--div class="col-sm-12">

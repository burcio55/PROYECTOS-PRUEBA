...
$pdf->SetTitle('Recibo de Pago Año Actual Mensual');
$pdf->SetSubject('Recibo de Pago Año Actual Mensual');
...
//_SESSION['recibo_act_concepto']
		$recibos										= $_SESSION['recibo_act'];
		$cedula											=$recibos['txt_cedula'];
		...
		$cedula_format										= number_format($cedula, 0, '', '.');
...
<table width="100%" border="0" cellPadding="5" cellSpacing="1">
		...
		<tr bgcolor="#F0F0F0">
				...
				<td width="25%" align="center">'.$cedula_format.'</td>
...
$pdf->Output('recibo_pagmensaact'.$_SESSION['id_usuario'].'_'.date('d/m/y').'.pdf', 'D');

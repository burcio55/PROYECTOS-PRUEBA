...
function mili(){
	if(document.getElementById("cbo_inscripcion_militar").value == 1){
		document.querySelector("input[name='txt_cod_inscripcion_militar']").disabled = false;
	}else{
		document.querySelector("input[name='txt_cod_inscripcion_militar']").disabled = true;
	}
}
...
function send(saction){
		if(saction=='guardar'){
			if(validar_formulario()==true){
				...
				alert("Ocurrio un error en la validación");
			}
		}else if(saction=='Buscar'){
			var form = document.frm_rec_pago_actualizacion;
			form.action.value=saction;
			form.submit();
		}
...
function validar_formulario(){
	...
	/*		if(document.getElementById("cbo_tipo_discapacidad").value.length==0){
			...
			*/
			...
			if(document.getElementById("nresidencia").value.length==0){
            ...
            if(document.getElementById("nresidencia").value == "t"){
            ...
            }else if(document.getElementById("nresidencia").value == "f"){
                
                if(document.getElementById("presidencia").value == "-1"){
                    document.getElementById("presidencia").style.borderColor= 'Red';
                    valor=0;
                }else{
                    document.getElementById("presidencia").style.borderColor= '';
                }
            }
	...
	/*		if(document.getElementById("txt_telefono_ext").value.length==0){
			...
			if(document.getElementById("trabajador_tipo").value!="PENSIONADOS SOBREVIVIENTE-EMPLEADOS-OBREROS"){

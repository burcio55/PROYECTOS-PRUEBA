...
//----------------redes sociales  DELETE----------------------------------------------------------------------------------------------				
	...
	$SQL="select * From public.personas where id='".$_SESSION['id_afiliado']."'";
		 ...
		 if ($rs1->RecordCount()>0){ 	
			...
			$aDefaultForm['cbDiscapacidad_nivel']=$rs1->fields['nombre'];
...
$sfecha=date('Y-m-d');
	...
	$rs = $conn->Execute($SQL2);
			if ($rs->RecordCount()>0){	
				...
				$sql="insert into public.persona_redes_sociales
		...
		$sql="update personas set   
				 ...
				 posee_red_social='".$_POST['cbDiscapacidad_afiliado']."',
...
-->
      ...
      <tr >
	    ...
	    <tr>
          ...
          </select> <span class="requerido">* </span><input name="redes_sociales" type="text" class="" id="redes_sociales" value="<?=$aDefaultForm['redes_sociales']?>" size="30" maxlength="30" title="Redes Sociales - Ejemplo:  Facebook, Instagram, Twitter, Snapchat, Tumblr, Flickr, Meetic, Spotify, YouTube, Telegram"/></td>
          ...
          <td colspan="3">
                ...
                <tr>
                <th width="20%" class="labelListColumn">Red Social</th>
                <th width="20%" class="labelListColumn">Dirección</th>
                ...
                <td class="texto-normal"><a href="?menu=11&id_po=<?=$aTabla[$i]['id']?>&accionC=1"><img src="imagenes/pencil_16.png"  border="0" title="Editar" /></a> <a href="?menu=11&id_po=<?=$aTabla[$i]['id']?>&accionC=2"><img src="imagenes/delete_16.png"  border="0" title="Eliminar" /></a> </td>
                </tr>

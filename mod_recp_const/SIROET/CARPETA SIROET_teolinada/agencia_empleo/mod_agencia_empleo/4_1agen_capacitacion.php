	...
	if (isset($_POST['action'])){
		...
		/*	if ($_POST['cbOcupacion5_interes_1']=="-1"){
			...
			$sql="update oferta_capacitacion set 
			    ...
			    ?><script>document.location='4_2agen_otrosdatos_capacitacion.php'</script><?  
				}
	...
	if (!$bPostBack){	
		    ...
		    $SQL="select * From public.oferta_capacitacion where id ='".$_SESSION['id_oferta']."' and empresa_id='".$_SESSION['id_empresa']."'";
				...
				<script>
					...
					combo="Curso";
					$.post("modelo.php", { elegido: elegido, combo:combo ,seleccionado:"<?php echo $rs1->fields['curso_id']; ?>" },
				...
				$(document).ready(function(){
					...
					combo="Ocupacion";
					$.post("modelo.php", { elegido: elegido, combo:combo ,seleccionado:"<?php echo $rs1->fields['ocupacion5']; ?>" }, 
...
$(document).ready(function(){
   ...
   <input name="action" type="hidden" value=""/>
	 <input name="cupos_disponibles" type="hidden" value="<?=$_POST['cupos_disponibles']?>"/>
        ...
        <tr>
          <td><div align="right"><span class="links-menu-izq"><i>Agregar otra Oportunidad de Capacitaci&oacute;n:</i></span></div></td>

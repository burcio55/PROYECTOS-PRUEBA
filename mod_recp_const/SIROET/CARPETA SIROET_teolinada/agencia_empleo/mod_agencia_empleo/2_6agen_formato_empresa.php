...
function send(saction){
    ...
    <input name="action" type="hidden" value=""/>
       ...
       <table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
				<tr>
          	<td colspan="4" class="sub_titulo" align="left"></td>
          </tr>
          <tr>
        ...
        <tr>
          ...
          <td class="link-clave-ruee"><div align="center"><a href="2_4agen_constancia_emp.php" class="links-menu-izq">Constancia de Afiliaci&oacute;n </a></div></td>

...
//Trazas-------------------------------------------------------------------------------------------------------------------------------				
	    	...
	    	?><script>document.location='2_6agen_formato_empresa.php'</script><?  
}
...
function send(saction){
    ...
    <input name="action" type="hidden" value=""/>
       ...
       <table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
           <tr>
          	<td colspan="2" class="sub_titulo" align="left"></td>
          </tr>
          <tr>
        ...
        <tr>
          ...
          <td width="56%"><select name="cbsucursales" class="tablaborde_shadow">
            ...
            <option value="0" <? if (($aDefaultForm['cbsucursales'])=='0') print 'selected="selected"';?>>No</option>
          </select></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <span class="requerido">*</span>  Fecha:    

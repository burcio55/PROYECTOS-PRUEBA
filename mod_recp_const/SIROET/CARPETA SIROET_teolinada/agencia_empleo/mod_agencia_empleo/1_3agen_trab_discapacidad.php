...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="right" >Origen de la discapacidad :</div></td>
        <td colspan="2">
	...
	for( $i=0; $i<count($aTabla); $i++){
		...
		?>
            <tr class="<?=$class_name?>">
              ...
              <td class="texto-normal"><a href="1_3agen_trab_discapacidad.php?id_po=<?=$aTabla[$i]['id']?>&accion=1"><img src="../imagenes/pencil_16.png"  border="0" title="Editar" /></a>             

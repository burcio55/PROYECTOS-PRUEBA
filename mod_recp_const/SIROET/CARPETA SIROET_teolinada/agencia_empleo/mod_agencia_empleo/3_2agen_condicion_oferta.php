	...
	if (!$bPostBack){		
		    $SQL="select * From public.oferta_empleo where id ='".$_SESSION['id_oferta']."' and empresa_id='".$_SESSION['id_empresa']."'";
				...
				$(document).ready(function(){
					...
					combo="Carrera";
					$.post("modelo.php", { elegido: elegido, combo:combo ,seleccionado:<?php echo $rs1->fields['area_mencion_id']; ?> }, 		
					function(data){
					cadenaTexto = data;
					...
					combo="Carrera1";
					$.post("modelo.php", { elegido: elegido, combo:combo ,seleccionado:<?php echo $rs1->fields['carrera1']; ?> }, 
					...
					combo="Carrera2";
					$.post("modelo.php", { elegido: elegido, combo:combo ,seleccionado:<?php echo $rs1->fields['carrera2']; ?> }, 
					...
					combo="Carrera3";
					$.post("modelo.php", { elegido: elegido, combo:combo ,seleccionado:<?php echo $rs1->fields['carrera3']; ?> }, 
				...
				<?php
					...
					$aDefaultForm['fecha_max']=$rs1->fields['fecha_max'];				
					} 
				}	
		else{   
					...
					$aDefaultForm['fecha_max']=$_POST['fecha_max'];
					}
			}
} 
//------------------------------------------------------------------------------------------------------------------------------

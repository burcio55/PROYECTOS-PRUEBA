...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
          ...
          <td colspan="3">
                ...
                <td class="texto-normal"><a href="1_7agen_trab_conocimientos.php?id_po=<?=$aTabla[$i]['id']?>&accionC=1"><img src="../imagenes/pencil_16.png"  border="0" title="Editar" /></a> <a href="1_7agen_trab_conocimientos.php?id_po=<?=$aTabla[$i]['id']?>&accionC=2"><img src="../imagenes/delete_16.png"  border="0" title="Eliminar" /></a> </td>
                </tr>
                <? } ?>
                </table>    
      </td>
      ...
      <td colspan="3" align="center">
         <button type="button" name="Agregar_Habil"  id="Agregar_Habil" class="button"  onclick="javascript:send('Agregar_Habil')">Aceptar</button>

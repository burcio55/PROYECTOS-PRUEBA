            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu" style="float: left; margin: 60px 0px 20px 50px;" >
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-account-card-details"></i><span> Persona <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                                <li><a href="?menu=11">PERFIL DEL TRABAJADOR O TRABAJADORA</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                 <li><a href="?menu=18">DATOS LABORALES</a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                 <li><a href="?menu=15">DATOS EDUCATIVOS</a></li>
                                <!--<li><a href="#">Opcion 2</a></li>
                                <li><a href="#">Opcion 3</a></li>-->
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li><a href="?menu=21">PERFIL DE LA ENTIDAD DE TRABAJO</a></li>
                                <li><a href="?menu=30">OPORTUNIDADES EMPLEO</a></li>
                                <!-- <li><a href="#">Opcion 2</a></li>
                                <li><a href="#">Opcion 3</a></li>-->
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li><a href="?menu=40">OPORTUNIDADES FORMATIVAS</a></li>
                                  <!-- <li><a href="#">Opcion 2</a></li>
                                <li><a href="#">Opcion 3</a></li>-->
                            </ul>
                        </li>
                         <li>
                            ...
                            <ul class="submenu">
                                <li><a href="?menu_reporte=11">INDICADORES</a></li>
                                <!--<li><a href="#">Opcion 2</a></li>
                                <li><a href="#">Opcion 3</a></li>-->
                            </ul>
                        </li>

                ...
                <a href="index.php" class="logo">
                    <span class="logo-light">
                        <!--SE DEBE HABILITAR UNA VEZ LA IMAGEN DEL LOGO ESTE MODIFICADA-->
                            <!--img src="assets/images/SIROET-logo.png"></a-->SIROET
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                               <li><a href="?menu=11" style="text-align:justify;position:relative;left:0px;top:20px;width:600px;">PERFIL DEL TRABAJADOR O TRABAJADORA</a></li>
                            </ul>
                        </li>

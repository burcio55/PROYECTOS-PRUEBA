                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu" style="float: left; margin: 60px 0px 20px 50px;" >
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                             <li><a href="../index.php?menu=11">Datos Personales</a></li>
                             <li><a href="../index.php?menu=13">Situación Discapacidad</a></li>
                             <li><a href="../index.php?menu=12">Datos de Interés</a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                 <li><a href="../index.php?menu=14">Situacion Ocupacional Actual</a></li>
                                 <li><a href="../index.php?menu=18">Experiencia Laboral</a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li><a href="../index.php?menu=15">Educación</a></li>
                                <li><a href="../index.php?menu=16">Capacitación Recibida</a></li>
                                <li><a href="../index.php?menu=17"> Otros Conocimientos, Habilidades y Destrezas</a></li>
                            </ul>
                        </li>
                         ...
                         <li>
                            ...
                            <ul class="submenu">
                                <li><a href="../index.php?menu=19">Foto</a></li>
                                <li><a href="../index.php?formato=1">Formato (Currículum Vitae)</a></li>
                            </ul>
                        </li>
                        ...
                        <!-- PERFIL ENTIDAD DE TRABAJO-->
                          ...
                          <li>
                            ...
                            <ul class="submenu">
                             <li><a href="../index.php?menu=21">Datos Principales</a></li>
                             <li><a href="../index.php?menu=22">Ubicación</a></li>
                             <li><a href="../index.php?menu=23">Otros Datos de la Entidad de Trabajo</a></li>
                         ...
                         <li>
                            ...
                            <ul class="submenu">
                                <li><a href="../index.php?formato=3">Formato (Constancia de Afiliación)</a></li>
                            </ul>
                        </li>
                        ...
                        <!-- OFERTA DE EMPLEO-->
                          ...
                          <li>
                            ...
                            <ul class="submenu">
                             <li><a href="../index.php?menu=30">Datos Principales del Perfil</a></li>
                             <li><a href="../index.php?menu=32">Condición del Perfil </a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                  <li><a href="../index.php?menu=40">Datos Principales de la Formación </a></li>
                                    <li><a href="../index.php?menu=42">Otros Datos de la Formación </a></li>
                            </ul>
                        </li>

                        <li class="menu-title">Indicadores </li>
                       <li>
                            <a href="../index.php?menu_reporte=11" class="waves-effect"><i class="fas fa-book-open"></i><span> Reportes <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <!--<ul class="submenu">

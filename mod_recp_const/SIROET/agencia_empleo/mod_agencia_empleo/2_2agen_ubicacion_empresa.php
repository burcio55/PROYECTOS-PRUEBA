	...
	if (isset($_POST['action'])){
		switch($_POST['action']){		
			...
			if ($_POST['cbredes_sociales']=='-1'){
				$GLOBALS['aPageErrors'][]= "-  Posee si poseeo no redes sociales: es requerido.";
				$bValidateSuccess=false;
			}
	...
	==========================================================================================*/
		    $SQL="select * From public.empresa_instituto where id ='".$_SESSION['id_empresa']."' and rif='".$_SESSION['rif']."'";
				 ...
				 if ($rs1->RecordCount()>0){ 				
					...
					$aDefaultForm['cbMunicipio_empresa']=$rs1->fields['municipio_id'];
					$aDefaultForm['cbParroquia_empresa']=$rs1->fields['parroquia_id'];
...
//Trazas-------------------------------------------------------------------------------------------------------------------------------				
			  ...
			  ?><script>document.location='?menu=23'</script><? 
	}
            ...
            <td ><div align="right" >Redes Sociales:</div></td>
           	...
           	<td>
		        <select name="cbred_social" class="tablaborde_shadow" id="cbred_social" title="Redes Sociales - Seleccione solo una opcion del listado e indique el nombre de la red Social">
          		...
          		<input name="redes_sociales" type="text" class="" id="redes_sociales" value="<?=$aDefaultForm['redes_sociales']?>" size="30" maxlength="30" /><img src="imagenes/redes.png" width="192" height="36" title="Redes Sociales - Ejemplo:  Facebook, Instagram, Twitter, Snapchat, Tumblr, Flickr, Meetic, Spotify, YouTube, Telegram" />
      		</td>
          		...
          		<td colspan="3">
	                ...
	                <tr class="<?=$class_name?>" border="0">
		                ...
		                <td width="19%" class="texto-normal" align="center" border="0">
		                	<a href="?menu=22&id_po=<?=$aTabla[$i]['id']?>&accionC=1"><img src="imagenes/pencil_16.png"  border="0" title="Editar <?=$aTabla[$i]['direccion']?>" /></a>  
		                </td>
		                <td width="19%" class="texto-normal" align="center" border="0">
                        	<a href="?menu=22&id_po=<?=$aTabla[$i]['id']?>&accionC=2"><img src="imagenes/delete_16.png"  border="0" title="Eliminar <?=$aTabla[$i]['direccion']?>" /></a> 
                        </td>
	                </tr>

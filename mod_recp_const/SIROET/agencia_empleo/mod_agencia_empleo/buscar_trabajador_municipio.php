...
$SQLL= "select personas.*
		...
		where personas.status='A' and personas.municipio_id = '".$_POST['municipio']."' order by  personas.id";
		$rs1 = $conn->Execute($SQLL);
			...
			where personas.status='A' and personas.estado_residencia = '".$_POST['estado']."' and personas.municipio_id = '".$_POST['municipio']."' order by  personas.id";

    ...
    <input name="action" type="hidden" value=""/>
    	...
    	<table width="100%" border="0" align="center" class="formulario" cellpadding="3" cellspacing="0">
			<tr>
		  	...
		  	<tr>
		    	<th colspan="4"  class="titulo" align="center">CONSULTA DE ENTIDADES DE TRABAJO POR ESTADO</th>
		  	</tr>
      		...
      		<tr class="identificacion_seccion">
			    <td colspan="2" align="center">SELECCIONE EL ESTADO: 
	        		...
	        		<button type="button" name="buscar_entidad_por_estado" id="buscar_entidad_por_estado" class="button btn_buscar" title="Haga Click para Buscar"> Buscar</button>
	        	</td>
		  	</tr>

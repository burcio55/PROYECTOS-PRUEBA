...
function doAction($conn){
	if (isset($_POST['action'])){
		switch($_POST['action']){
			...
			case 'Continuar': 
			$bValidateSuccess=true;	
			?><script>document.location='?menu=20'</script><?
			if ($bValidateSuccess){				
				ProcessForm($conn);
				}
...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="center" class="link-clave-ruee Estilo12">La(s) imagen(es) que desee adjuntar deben ser menor a 1.5 MB y deben tener un formato .jpg .gif </td>
        </tr>
        <tr>
        ...
        <tr>
       	<td>
       	<div align="center"><font color="#0066CC" size="2"><a href="mod_agencia_empleo/guia_practica_foto.pdf"  target="_blank">Guia r&agrave;pida para modificar tamaño de la foto</a> <img src="imagenes/libro.png" width="20" height="20"  alt=""/></font></div></td>
        </tr>
        <tr>
          <td class="link-clave-ruee"><div align="right"></div> <div align="right"></div></td>
        </tr>

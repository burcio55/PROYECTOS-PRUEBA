...
function doAction($conn){
	if (isset($_POST['action'])){
				switch($_POST["action"]){
				case 'buscar_trabajador_por_parroquia':
    ...
    <input name="action" type="hidden" value=""/>
    	...
    	<table width="100%" border="0" align="center" class="formulario" cellpadding="3" cellspacing="0">
			<tr>
		  	...
		  	<tr>
		  		<td colspan="3" align="center"><button type="button" name="buscar_trabajador_por_parroquia" id="buscar_trabajador_por_parroquia" class="button btn_buscar" title="Haga Click para Buscar"> Buscar</button></td>
		  	</tr>

...
//------------------------------------educacion tsu universitaria postgrado---------------------------------				 
			...
			case 'Cancelar': 
					?><script> 
				    document.location='?menu=15'</script><?
			  /*unset($_POST['id_po']);
				unset($_POST['accion']);
				LoadData($conn,false);	*/
			break;
			...
			case 'Continuar': 	
				...
				?><script>document.location='index.php?menu=16'</script><?
			break;
	        }
		}		
		else{
    ...
    $aDefaultForm = &$GLOBALS['aDefaultForm'];
		...
		if ($_POST['accion']=='1'){	
				...
				$(document).ready(function(){
					...
					combo="Carrera";
					$.post("mod_agencia_empleo/modelo.php", { elegido: elegido, combo:combo ,seleccionado:'<?php echo $rs->fields['area_mencion_id']; ?>',
					...
					combo="Carrera1";
					$.post("mod_agencia_empleo/modelo.php", { elegido: elegido, combo:combo ,seleccionado:'<?php echo $rs->fields['carrera1']; ?>' }, 
				...
				<script>
					...
					combo="Carrera2";
					$.post("mod_agencia_empleo/modelo.php", { elegido: elegido, combo:combo ,seleccionado:'<?php echo $rs->fields['carrera2']; ?>' }, 
					...
					combo="Carrera3";
					$.post("mod_agencia_empleo/modelo.php", { elegido: elegido, combo:combo ,seleccionado:'<?php echo $rs->fields['carrera3']; ?>' }, 
...
?>
<form name="frm_educacion" method="post" action="" >
...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
 ...
 <!-- <tr id="tr_Carrera4">
  ...
  <tr>
          ...
          <td class="texto-normal"><a href="?menu=15&id_po=<?=$aTabla[$i]['id']?>&accion=1"><img src="imagenes/pencil_16.png"  border="0" title="Editar" /></a>  
          <a href="?menu=15&id_po=<?=$aTabla[$i]['id']?>&accion=2"><img src="imagenes/delete_16.png"  border="0" title="Eliminar" /></a></td>
          </tr>
          <? } ?>
          </table>

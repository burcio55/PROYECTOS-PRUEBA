...
function doAction($conn){
	if (isset($_POST['action'])){
				switch($_POST["action"]){
				case 'buscar_entidad_por_municipio':
    ...
    <input name="action" type="hidden" value=""/>
    	...
    	<table width="100%" border="0" align="center" class="formulario" cellpadding="3" cellspacing="0">
			<tr>
		  	...
		  	<tr>
		    	<th colspan="4"  class="titulo" align="center">CONSULTA DE ENTIDADES DE TRABAJO POR MUNICIPIO</th>
		  	</tr>
      		...
      		<tr class="identificacion_seccion">
			    <td colspan="1" align="center">ESTADO: 
	          	...
	          	<td colspan="1" align="center">MUNICIPIO: 
	        		...
	        		<button type="button" name="buscar_entidad_por_municipio" id="buscar_entidad_por_municipio" class="button btn_buscar" title="Haga Click para Buscar"> Buscar</button>
	        	</td>
		  	</tr>
        ...
        <tr>
       		<td>
				<figure class="highcharts-figure">
				    <div id="reporte_por_municipio"></div>
				</figure>	
           </td>
         </tr>
       </table>

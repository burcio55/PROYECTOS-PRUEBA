...
<table width="80%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <th  class="sub_titulo" align="left"> Formato: </th>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <? if ($_POST['formatos']=='1'){?>
                  ...
                  <tr>
                  <td width="50%" class="link-clave-ruee" align="center"><a href="?formato=1" class="links-menu-izq"><img src="imagenes/client_account_template.png" width="36" height="36" border="0" /><br>Curriculum Vitae</a></td>

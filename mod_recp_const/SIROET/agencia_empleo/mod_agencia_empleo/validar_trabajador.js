...
var valor=1 ;  
			...
			document.getElementById("rif").style.borderColor= '#DF0101';
			valor=0;
			}else{
			...
			if(document.getElementById("patrono2").value==''){
			document.getElementById("patrono2").style.borderColor= '#DF0101';
			valor=0;
			}else{
			document.getElementById("patrono2").style.borderColor= '';
			}
			...
			if(document.getElementById("Telf_patrono").value==''){
			document.getElementById("Telf_patrono").style.borderColor= '#DF0101';
			valor=0;
			}else{
			document.getElementById("Telf_patrono").style.borderColor= '';
			}
			...
			if(document.getElementById("f_egreso").value==''){
			document.getElementById("f_egreso").style.borderColor= '#DF0101';
			valor=0;
			}else{
			document.getElementById("f_egreso").style.borderColor= '';
			}
			...
			if(document.getElementById("cbMotivo_retiro").value=='-1' || document.getElementById("cbMotivo_retiro").value==''){
			document.getElementById("cbMotivo_retiro").style.borderColor= '#DF0101';
			valor=0;
			}else{
			document.getElementById("cbMotivo_retiro").style.borderColor= '';
			}
		//	alert(document.getElementById("cbPersonal_supervisado").value);
...
//_______________________________Form_interes_____________________________
function validar_intereses(){
	var valor=1 ; 

	var suma = 0;
	var checks = document.getElementsByName('chk_interes_conocimiento[]');
	...
	var sumab = 0;
	var checksb = document.getElementsByName('chk_interes_laboral[]');

	for(var i = 0, j = checksb.length; i < j; i++){
		if(checksb[i].checked == true){
			sumab++;
		}
	}
	...
	if(document.getElementById("srial_carnet_patria").value==''){
		document.getElementById("srial_carnet_patria").style.borderColor= '#DF0101';
		valor=0;
	}else{
		document.getElementById("srial_carnet_patria").style.borderColor= '';
	}

	if(document.getElementById("codigo_carnet_patria").value==''){
		document.getElementById("codigo_carnet_patria").style.borderColor= '#DF0101';
		valor=0;
	}else{
		document.getElementById("codigo_carnet_patria").style.borderColor= '';
	}


	if(valor==0 || valor==2 || valor==3){
		if(valor==2){
			alert("DEBE DE SELECCIONAR AL MENOS UN INTERES DE CONOCIMIENTO");
			return false;
		}else{
			if(valor==3){
				alert("DEBE DE SELECCIONAR AL MENOS UN INTERES LABORAL");
				return false;
			}else{
				if(valor==0){
					alert("LOS CAMPOS EN ROJO SON REQUERIDO");
...
//-------------------------------------------------------------------------------------------------------
function validar_experiencia_extranjero(){
var valor=1 ;

if(document.getElementById("cbpais_ext").value=='-1'){
document.getElementById("cbpais_ext").style.borderColor= '#DF0101';
valor=0;
}else{
document.getElementById("cbpais_ext").style.borderColor= '';
}

if(document.getElementById("cbpais_ext").value=='1'){
	
	if(document.getElementById("cbpais_donde_laboro").value=='-1'){
	document.getElementById("cbpais_donde_laboro").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("cbpais_donde_laboro").style.borderColor= '';
	}
	if(document.getElementById("nombre_ultimo_trab_ext").value==''){
	document.getElementById("nombre_ultimo_trab_ext").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("nombre_ultimo_trab_ext").style.borderColor= '';
	}
	if(document.getElementById("f_egreso_ext").value==''){
	document.getElementById("f_egreso_ext").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("f_egreso_ext").style.borderColor= '';
	}
	if(document.getElementById("duracion_rel_laboral_ext").value==''){
	document.getElementById("duracion_rel_laboral_ext").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("duracion_rel_laboral_ext").style.borderColor= '';
	}
	if(document.getElementById("cargo_trab_ext").value==''){
	document.getElementById("cargo_trab_ext").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("cargo_trab_ext").style.borderColor= '';
	}
}
...
var valor=1 ;  
			...
			if(document.getElementById("cbSector_empleo1").value=='-1' || document.getElementById("cbSector_empleo1").value==''){
			document.getElementById("cbSector_empleo1").style.borderColor= '#DF0101';
			valor=0;
			}else{
			document.getElementById("cbSector_empleo1").style.borderColor= '';
			} 

...
function send(saction){
  ...
  <table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="4" ><img src="../agencia_empleo/imagenes/cintillo_MPPPST_2020.png" width="100%" height="61" /></td>
    </tr>
    <tr>
      <td colspan="4" >&nbsp;</td>
    </tr>
    <tr>
      <td width="11" >&nbsp;</td>
      <td >&nbsp;</td>
      <td ><strong> VICEMINISTERIO PARA EDUCACI&Oacute;N Y TRABAJO PARA LA LIBERACI&Oacute;N</strong></td>
      <td width="27" >&nbsp;</td>
    </tr>
    <tr>
      <td >&nbsp;</td>
    ...
    <tr>
      <td colspan="4">&nbsp;</td>
        ...
        <table width="200" border="0" align="center">
          <tr>
            <td><div align="center"><a target="new" style="cursor: pointer;" onclick="imprime();"><img src="imagenes/print_32.png" width="23" height="20" border="0" /></a></div></td>
          </tr>
        </table>
          <p>&nbsp;</p>  
          <p>&nbsp;</p>
...
function imprime(){
  document.location='../agencia_empleo/mod_agencia_empleo/pdf_constancia_empresa.php';
}
</script>
<?php
}

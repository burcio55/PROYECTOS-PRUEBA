...
$SQLL= "select personas.*
		...
		where personas.status='A' and personas.parroquia_id = '".$_POST['parroquia']."' order by  personas.id";
...
$SQL= "select 
			...
			where personas.status='A' and personas.estado_residencia = '".$_POST['estado']."' and personas.municipio_id = '".$_POST['municipio']."' and personas.parroquia_id = '".$_POST['parroquia']."' order by  personas.id";
...
<script type="text/javascript">
				...
				Highcharts.chart('reporte_por_parroquia', {
				    ...
				    subtitle: {
				        text: 'Haga Click en la Grafica para ver Detalles <br>(Total:</br> <?php echo $totl;?> Trabajadores)'
				    },
				    accessibility: {
				        announceNewData: {
				            enabled: true

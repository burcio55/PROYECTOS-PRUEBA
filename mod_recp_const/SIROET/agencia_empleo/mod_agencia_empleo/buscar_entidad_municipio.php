...
$SQLL="select empresa_instituto.* 
			...
			where empresa_instituto.status='A' and empresa_instituto.municipio_id = '".$_POST['municipio']."' order by  empresa_instituto.id";
...
$SQL="select distinct empresa_instituto.*, empresa_instituto.id as empresa_id, 
			...
			where empresa_instituto.status='A' and empresa_instituto.estado_id = '".$_POST['estado']."' and empresa_instituto.municipio_id = '".$_POST['municipio']."' order by  empresa_instituto.id";
...
<script type="text/javascript">
				// Create the chart
				Highcharts.chart('reporte_por_municipio', {
				    chart: {
				        type: 'column'
				    },
				    lang: {

...
//var_dump($_SESSION);
	...
	$aTabla2=$_SESSION['aTabla2'];				
					...
					if ($foto!=''){
						$imagen='<img src="imagenes/'.$foto.'" width="70" height="79" border="0"/>';
			...
			'.htmlspecialchars($pais_residencia, ENT_QUOTES).' 
			Estado: '.htmlspecialchars($estado_residencia, ENT_QUOTES).'
			...
			<tr>
		     	<th colspan="5" class="separacion_10"></th>
		  	</tr>
			<tr>
...
$PDF_HEADER_LOGO="cintillo_MPPPST_2020.jpg";
...
$pdf->Output('Formato_Curriculum.pdf', 'D');
...
?>
<link href="css/estilos_curriculum.css" rel="stylesheet" type="text/css">
...
function send(saction){
  ...
  <table width="95%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
	...
	<tr>
      <th colspan="5" align="center" height="25">
      	<img width="100%" src="../agencia_empleo/imagenes/cintillo_MPPPST_2020.png">
      	<hr>
      </th>
  ...
  <? $aTabla1=$_SESSION['aTabla1']; ?>
    ...
    <tr>
      <th height="72" colspan="4" class="titulo">
        <?=$_POST['pais_residencia']?><br> 
          Nacionalidad: <?=$aTabla1['nacionalidad']?> <br>
          Estado: <?=$_POST['estado_residencia']?> 
    ...
    <tr>
      <th colspan="5" class="sub_titulo" align="left"><div align="left" class="labelListGlobal">DATOS PERSONALES:</div></th>
    </tr>
	  <tr>
    ...
    <tr>
      <td class="dataListColumn" align="right">Estado civil:</td>
  ...
  <table width="100%" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center">
        ...
        <p> <a target="new" style="cursor: pointer;" onclick="imprime('<?=$_POST['pais_residencia']?>','<?=$_POST['estado_residencia']?>','<?=$_POST['ocupacion2']?>','<?=$_POST['experiencia2']?>','<?=$_POST['foto']?>');" ><img src="imagenes/print_32.png" border="0" /></a></p>
      </div></td>
    </tr>
  </table>
  <p align="right"></p>
...
function imprime(pr,er,op2,exp2,ft){
	document.location='../agencia_empleo/mod_agencia_empleo/pdf_curriculum.php?ft='+ft+'&pr='+pr+'&er='+er+'&o2='+op2+'&ex='+exp2;
}
</script>
<?php
}

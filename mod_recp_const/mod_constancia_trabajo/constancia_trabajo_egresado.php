...
<form name="frm_constancia_trabajo_egresado" id="frm_constancia_trabajo_egresado" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" >
...
<!--  <tr>
    <th colspan="4"  class="titulo" align="center">CONSTANCIA DE TRABAJO DE EGRESADO</th>
      ...
      <tr>
        <th colspan="4"  class="sub_titulo"><div align="left">CONSTANCIAS DE TRABAJO--> Egresado</div></th>        
      </tr>
...
<table class="formulario" width="62%" align="center">
 ...
 <tr>
    ...
    <p align="justify">Quien suscribe, la <b>Directora General</b> de la <b>Oficina de Gesti&oacute;n Humana</b>, hace constar  por medio de la presente que <?php echo $_SESSION['ciudadano'];?> <b><? echo htmlentities(trim($aDefaultForm['txt_apellido1']." ".$aDefaultForm['txt_apellido2']).",  ".trim($aDefaultForm['txt_nombre1']." ".$aDefaultForm['txt_nombre2']),ENT_QUOTES);?></b>,  titular de la c&eacute;dula de identidad Nro.  <b><?php echo $aDefaultForm['txt_nacionalidad']; echo '.-'.number_format($aDefaultForm['txt_cedula'], 0, '', '.');?></b>, prest&oacute; sus servicios en &eacute;ste Organismo, desempe&ntilde;ando el cargo de <b><?= $aDefaultForm['txt_descripcion_cargo'];?></b>, en la <b><?= $aDefaultForm['txt_nombre_dep'];'</b>';
...
?> desde el <b><?= strftime("%d/%m/%Y", strtotime($aDefaultForm['txt_fecha_ingreso']));?> </b> hasta <b><?= strftime("%d/%m/%Y", strtotime($aDefaultForm['txt_fecha_egreso']));?>,</b> en el horario comprendido desde las <b>8:00 a.m.</b> a <b>12:30 p.m.</b> y de <b>1:30 p.m.</b> a <b>4:30 p.m.</b></p>
	</font></td>
</tr>
</table>
</br>

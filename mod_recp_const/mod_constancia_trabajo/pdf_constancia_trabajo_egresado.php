...
//	$fec_caducidad= date('Y-m-d', strtotime($fecha_hoy) + intval($can_dias_days*24*60*60)); 
	 ...
	 $sql="SELECT personales_cedula, scodigo_constancia
	       ...
	       where personales_cedula='".$_POST['txt_cedula']."' and tipo_constancias_id=4 and nenabled=1";//COLOCAR VARIABLE OOOOJOOOOOOOOOOOOOOOOOOOOOOOOOOOO
 ...
 $sql2 = "INSERT INTO recibos_pagos_constancias.constancias_trabajo(personales_cedula, tipo_constancias_id, scodigo_constancia, 
			...
			VALUES ('".$_POST['txt_cedula']."', 4,'".$codigo_const."', now(), '".$fec_caducidad."', now(),'".$_SESSION['id_usuario']."')";
			$conn->Execute($sql2);
		}
...
<tr>
	<td align="justify" style="font-size:100%">Quien suscribe, la <b>Directora General</b> de la <b>Oficina de Gesti&oacute;n Humana del Ministerio del Poder Popular para el Proceso Social de Trabajo</b>, hace constar por medio de la presente que $ciudadano <b>$ape, $nom</b>, titular de la c&eacute;dula de identidad Nro. <b>$nacionalidad.-$cedula</b>, prest&oacute; sus servicios en &eacute;ste Organismo como <b>$figura</b>, desempe&ntilde;ando el cargo de <b>$descripcion_cargo</b>, en la <b> $descripcion_ubicacion_adm</b>, desde el <b>$fecha_ingreso</b> hasta <b>$fecha_egreso</b>, en el horario comprendido desde las <b>8:00 a.m.</b> a <b>12:30 p.m.</b> y de <b>1:30 p.m. a 4:30 p.m.</b></td>
</tr>
</table>
EOD;
...
$pdf->Output('constancia_trabajo_egr'.$_POST['txt_cedula'].'_'.date('d/m/y').'.pdf', 'D');

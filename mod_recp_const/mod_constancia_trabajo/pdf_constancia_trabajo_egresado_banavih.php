...
//	$fec_caducidad= date('Y-m-d', strtotime($fecha_hoy) + intval($can_dias_days*24*60*60)); 
	 ...
	 $sql="SELECT personales_cedula, scodigo_constancia
	       ...
	       where personales_cedula='".$_POST['txt_cedula']."' and tipo_constancias_id=5 and nenabled=1";//COLOCAR VARIABLE OOOOJOOOOOOOOOOOOOOOOOOOOOOOOOOOO
 ...
 $sql2 = "INSERT INTO recibos_pagos_constancias.constancias_trabajo(personales_cedula, tipo_constancias_id, scodigo_constancia, 
			...
			VALUES ('".$_POST['txt_cedula']."', 5,'".$codigo_const."', now(), '".$fec_caducidad."', now(),'".$_SESSION['id_usuario']."')";
			$conn->Execute($sql2);
		}
...
<tr>
     <td align="center" style="font-size:120%"><b>REFERENCIA</b></td>
</tr>
<tr>
     <td align="center" style="font-size:130%"><b>FONDO DE AHORRO OBLIGATORIO</b></td>
</tr>
<tr>
     <td align="center" style="font-size:130%"><b>PARA LA VIVIENDA</b></td>
</tr>
<tr>
     <td>&nbsp;</td>
</tr>
...
<tr>
	<td align="justify" style="font-size:100%">Quien suscribe, la <b>Directora General</b> de la <b>Oficina de Gesti&oacute;n Humana del Ministerio del Poder Popular para el Proceso Social de Trabajo</b>, hace constar por medio de la presente que $ciudadano <b>$ape, $nom</b>, titular de la c&eacute;dula de identidad Nro. <b>$nacionalidad.-$cedula</b>, prest&oacute; sus servicios en &eacute;ste Organismo bajo la figura de <b>$figura</b>, hasta el <b>$fecha_egreso</b> y cotizo el Fondo de Ahorro Obligatorio para la Vivienda (FAOV) desde el <b>$fecha_ingreso</b> hasta el <b>$fecha_egreso</b>, en el <b>Banco Nacional</b> de la <b>Vivienda</b> y <b>Habitat (BANAVIH)</b>.
	</td>
</tr>
</table>
EOD;
...
$pdf->Output('constancia_trabajo_faov'.$_POST['txt_cedula'].'_'.date('d/m/y').'.pdf', 'D');

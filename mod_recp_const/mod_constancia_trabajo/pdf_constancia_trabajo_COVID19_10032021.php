...
$pdf->SetTitle('Constancia de Trabajo COVID-19');
$pdf->SetSubject('Constancia de Trabajo COVID-19');
...
$_SESSION['recibo_act'];
$cedula						    = number_format( $_POST['txt_cedula'], 0, '', '.');
$nom 						    = trim($_SESSION['recibo_act']['txt_nombre1'].' '.$_SESSION['recibo_act']['txt_nombre2']);
$ape			 	  		    = trim($_SESSION['recibo_act']['txt_apellido1'].' '.$_SESSION['recibo_act']['txt_apellido2']);
...
$mencionado						= $_SESSION['mencionado'];
...
//	$fec_caducidad= date('Y-m-d', strtotime($fecha_hoy) + intval($can_dias_days*24*60*60)); 
	 ...
	 $sql="SELECT personales_cedula, scodigo_constancia
	       ...
	       where personales_cedula='".$_POST['txt_cedula']."' and tipo_constancias_id=9 and nenabled=1";//COLOCAR VARIABLE OOOOJOOOOOOOOOOOOOOOOOOOOOOOOOOOO
 ...
 $sql2 = "INSERT INTO recibos_pagos_constancias.constancias_trabajo(personales_cedula, tipo_constancias_id, scodigo_constancia, 
			...
			VALUES ('".$_POST['txt_cedula']."', 9,'".$codigo_const."', now(), '".$fec_caducidad."', now(),'".$_SESSION['id_usuario']."')";
			$conn->Execute($sql2);
		}
...
<tr>
  <td align="center"><img src="../../imagenes/constancia_covid19.png" height="80"></td>
</tr>
<tr>
     <td>&nbsp;</td>
</tr>
...
<tr>
	<td align="justify" style="font-size:100%">Quien suscribe, la <b>Directora General</b> de la <b>Oficina de Gesti&oacute;n Humana del Ministerio del Poder Popular para el Proceso Social de Trabajo</b>, hace constar por medio de la presente que $ciudadano <b>$ape, $nom</b>, titular de la c&eacute;dula de identidad Nro. <b>$nacionalidad.-$cedula</b>, presta en la actualidad sus servicios en &eacute;ste Organismo bajo la figura de <b>$figura</b>, $adscrito <b> $descripcion_ubicacion_adm</b>.</td>
</tr>
<tr>
     <td>&nbsp;</td>
</tr>
<tr>
	<td align="justify" style="font-size:100%">Se hace pertinente informarle que $ciudadano antes $mencionado posee una participaci&oacute;n  estrat&eacute;gica en las gestiones administrativas y operativas en este &Oacute;rgano Ministerial, <b>por lo que se requiere su presencia en su puesto de trabajo mientras dure la emergencia, ocasionada por el COVID-19, en el territorio nacional,</b> por lo que en esta oportunidad se solicita de sus buenos oficios a fin de permitirle la circulaci&oacute;n.</td>
	</tr>
...
<tr>
     <td align="center" style="font-size:78%">Seg&uacute;n Resoluci&oacute;n N&deg; 168 de fecha 18/05/2021</td>
</tr>
<tr>
     <td align="center" style="font-size:78%">Gaceta Oficial N&deg; 42.133 de fecha 24/05/2021</td>
</tr>
<tr>
     <td>&nbsp;</td>
</tr>
...
$pdf->Output('const_trab_COVID19'.$_POST['txt_cedula'].'_'.date('d/m/y').'.pdf', 'D');

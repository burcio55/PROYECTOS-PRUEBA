...
<form name="frm_constancia_trabajo_personal_activo" id="frm_constancia_trabajo_personal_activo" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" > 
    ...
    <table class="formulario" width="58%" align="center">
        ...
        <tr>
            ...
            <p align="justify"><font color="#666666">Quien suscribe, la <b>Directora General(E)</b> de la <b>Oficina de Gesti&oacute;n Humana del Ministerio del Poder Popular para el Proceso Social de Trabajo</b>, hace constar  por medio de la presente que 
  ...
  <?php
		 ...
		 $alicuota_bono_vac=((($total_asigna/30)*90)/12);
 		 $bono_fin_ano =  (($total_asigna + $alicuota_bono_vac)/30)*150;
...
?>
    ...
    <table width="45%" border="0" bordercolor="#FFFFFF" align="center" class="formulario" cellpadding="5" cellspacing="0">
     ...
     <tr>
        ...
        <th width="10%" align="right" class="data_Table1"><div align="right">Bs.</div></th>
        <th width="27%" class="data_Table1"><div align="right"><?=$montos['total_asigna']=number_format($total_asigna, 2, ",", ".");?></th>
      </tr>
      <tr>
        <th align="left" class="data_Table2">Bono Vacacional</th>
        <th align="right" class="data_Table2"><div align="right">Bs.</div></th>
      ...
      <tr>
          ...
          <th align="right" class="data_Table1"><div align="right">Bs.</div></th>

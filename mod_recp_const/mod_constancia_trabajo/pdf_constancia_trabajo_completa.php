...
//	$can_dias_days= 30;  
	...
	//= date('Y-m-d', strtotime($fecha_hoy) + intval($can_dias_days*24*60*60)); 
	 ...
	 $sql="SELECT personales_cedula, scodigo_constancia
	       ...
	       where personales_cedula='".$_SESSION['id_usuario']."' and tipo_constancias_id=1 and nenabled=1";//COLOCAR VARIABLE OOOOJOOOOOOOOOOOOOOOOOOOOOOOOOOOO
 ...
 $sql2 = "INSERT INTO recibos_pagos_constancias.constancias_trabajo(personales_cedula, tipo_constancias_id, scodigo_constancia, 
			...
			VALUES ('".$_SESSION['id_usuario']."', 1,'".$codigo_const."', now(), '".$fec_caducidad."', now(),'".$_SESSION['id_usuario']."',
...
<tr>
		<td align="justify" style="font-size:100%">Quien suscribe, la <b>Directora General</b> de la <b>Oficina de Gesti&oacute;n Humana del Ministerio del Poder Popular para el Proceso Social de Trabajo</b>, hace constar por medio de la presente que $ciudadano <b>$ape, $nom</b>, titular de la c&eacute;dula de identidad Nro. <b>$nacionalidad.-$cedula</b>, presta sus servicios en &eacute;ste Organismo bajo la figura de  <b>$figura</b>, desde el <b>$fecha_ingreso</b>, $adscrito <b> $descripcion_ubicacion_adm</b>, devengando un:</td>
</tr>
</table>
EOD;
...
<table border="0" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td align="center" bgcolor="#F0F0F0" color="#1060C8">Bs. S</td>
...
<tr>
   <td align="center" style="font-size:100%"><b>AINEE VEL&Aacute;SQUEZ S.</b></td>
</tr>
<tr>
...
$pdf->Output('constancia_trabajo_comp'.$_SESSION['id_usuario'].'_'.date('d/m/y').'.pdf', 'D');

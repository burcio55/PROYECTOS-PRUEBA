...
<table width="95%" class="tabla" height="95%">
	...
	<tr valign="top">
		<td>
        <form name="frm_rec_pago_consulta_anio_act_mensual" id="frm_rec_pago_consulta_anio_act_mensual" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" >
        ...
        <script>
            function send(saction){
                    var form = document.frm_rec_pago_consulta_anio_act_mensual;
...
<table width="95%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
        ...
        <tr align=left>
            <td></td>
            <th colspan="2" width="45%" class="sub_titulo"><div align="center">MES A CONSULTAR</div></th>
            <td></td>
        </tr>
  ...
  <!-- PARTE 2-->
	<?php if ($_POST['mes']!=='') $escribir= "01/".$_POST['mes']."/".'2021'." AL 15/".$_POST['mes']."/".'2021'."";
	else
	//{
	$escribir= "15/01/".'2021'." AL 31/01/".'2021';
		switch ($_POST['mes'])
		{
			case 1:
				$escribir= "16/01/".'2021'." AL 31/01/".'2021'; $meses = "ENERO";
			break;
			case 2:
				$escribir= "16/02/".'2021'." AL 28/02/".'2021'; $meses = "FEBRERO";
			break;
			case 3:
				$escribir= "16/03/".'2021'." AL 31/03/".'2021'; $meses = "MARZO";
			break;
			case 4:
				$escribir= "16/04/".'2021'." AL 30/04/".'2021'; $meses = "ABRIL";
			break;
			case 5:
				$escribir= "16/05/".'2021'." AL 31/05/".'2021'; $meses = "MAYO";
			break;
			case 6:
				$escribir= "16/06/".'2021'." AL 30/06/".'2021'; $meses = "JUNIO";
			break;
			case 7:
				$escribir= "16/07/".'2021'." AL 31/07/".'2021'; $meses = "JULIO";
			break;
			case 8:
				$escribir= "16/08/".'2021'." AL 31/08/".'2021'; $meses = "AGOSTO";
			break;
			case 9:
				$escribir= "16/09/".'2021'." AL 30/09/".'2021'; $meses = "SEPTIEMBRE";
			break;
			case 10:
				$escribir= "16/10/".'2021'." AL 31/10/".'2021'; $meses = "OCTUBRE";
			break;
			case 11:
				$escribir= "16/11/".'2021'." AL 30/11/".'2021'; $meses = "NOVIEMBRE";
			break;
			case 12:
				$escribir= "16/12/".'2021'." AL 31/12/".'2021'; $meses= "DICIEMBRE";
			break;
		}
	//}
	if ($_POST['quincena']!='') $quincenaE = "QUINCENA DEL ".$escribir;
	else $quincenaE = $meses." DEL A&Ntilde;O ".'2021';
...
?>
        ...
        <tr>
            ...
            <th class="dataListColumn"><div align="right"><b><?=number_format($total_no_salarial, 2, ",", ".");?></b></div></th>
...
<table width="95%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="5" align="center">
            <button type="submit"  class="button_personal btn_imprimir"  formaction="pdf_rec_pago_consulta_ano_act_mens.php?sq=&mes=<?=$_POST['mes']?>" formtarget="_blank" title="Haga Click para Imprimir el Recibo de Pago">Imprimir</button>
            </td>
        </tr>
</table>

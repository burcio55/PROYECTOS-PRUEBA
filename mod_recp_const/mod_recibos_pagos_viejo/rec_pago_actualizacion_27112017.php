...
function LoadData($conn,$bPostBack){  //en esta funcion se colocan todos los campos que voy a trabajar en el formulario
	...
	if (!$bPostBack){                                      //funcion propia del load data
			...
			$SQL="SELECT personales.cedula as cedula,
					...
					personales.ntelefono_ext as telefono_ext,	
				...
				if($rs->RecordCount()>0){
						...
						$aDefaultForm['cbo_ciudad']						=$rs->fields['ciudad'];
						...
						$aDefaultForm['txt_telefono_ext']				=$rs->fields['telefono_ext'];		
			...
			$SQL="SELECT personales.cedula as cedula,
				...
				if($rs->RecordCount()>0){
						...
						$aDefaultForm['txt_telefono_ext']					=$_POST["txt_telefono_ext"];
...
function ProcessForm($conn){	//aqui se hacen todos los insert update delete del formulario
			$SQL="UPDATE public.personales SET    
						...
						nciudad									='".$_POST['cbo_ciudad']."',
						spunto_referencia						='".$_POST['txt_punto_referencia']."',	
						ntelefono_ext							='".$_POST["txt_telefono_ext"]."',  
...
<!--<script type="text/javascript" src="funciones_rec_pago_registro.js"></script>-->	
...
<table width="95%" border="0" align="center" class="formulario">
        ...
        <tr>
            ...
            <td style="background-color:#F0F0F0;" align="center"><?=number_format( $_SESSION['id_usuario'], 0, '', '.')?></td>
            <td style="background-color:#F0F0F0; color:#666"" align="center"><strong>Nacionalidad </strong></td>
            <td style="background-color:#F0F0F0;" align="center"><?php if($aDefaultForm['txt_nacionalidad']==1){
				echo 'VENEZOLANO';
				}else{
				echo 'EXTRANJERA';
				}
        ...
        <tr>
         ...
         <tr>
              <th width="25%" class="sub_titulo_3" align="center">Primer Apellido</th>		
              <th width="25%" class="sub_titulo_3" align="center">Segundo Apellido</th>
              <th width="25%" class="sub_titulo_3" align="center">Primer Nombre</th>
              <th width="25%" class="sub_titulo_3" align="center">Segundo Nombre</th>  
         </tr>
  
         <tr>
             <td align="center"><font color="#666666"><input style="width: 95%" name="txt_apellido1" type="text"  class="textbox" id="txt_apellido1" value="<?= $aDefaultForm['txt_apellido1'];?>" disabled/></font></td>
             <td align="center"><font color="#666666"><input style="width: 95%" name="txt_apellido2" type="text" class="textbox" id="txt_apellido2" value="<?= $aDefaultForm['txt_apellido2'];?>" disabled/></font></td>
             <td align="center"><font color="#666666"><input style="width: 95%" name="txt_nombre1" type="text" class="textbox" id="txt_nombre1" value="<?= $aDefaultForm['txt_nombre1'];?>" disabled/></font></td>
             <td align="center"><font color="#666666"><input style="width: 95%" name="txt_nombre2" type="text" class="textbox" id="txt_nombre2"  value="<?= $aDefaultForm['txt_nombre2'];?>" disabled/></font></td>
         </tr>
   
         <tr>  
             <th width="25%" class="sub_titulo_3" align="center">Fecha de Nacimiento</th>
             <th width="25%" class="sub_titulo_3" align="center">Sexo</th> 
             <th width="25%" class="sub_titulo_3" align="center">Lateralidad</th>
             <th width="25%" class="sub_titulo_3" align="center">Discapacidad</th>
         </tr>
    
        <tr>
    	      <td align="center"><input style="width: 95%" name="txt_fecha_nacimiento" type="text" class="textbox" id="txt_fecha_nacimiento" value="<? if($aDefaultForm['txt_fecha_nac']!=""){echo strftime("%d/%m/%Y", strtotime($aDefaultForm['txt_fecha_nac']));} ?>" disabled/></td>
		<td align="center"><input style="width: 95%" name="txt_sexo" type="text" class="textbox" id="txt_sexo" value="<?php if($aDefaultForm['txt_sexo']==2){echo 'MASCULINO';}else  if ($aDefaultForm['txt_sexo']==1){echo 'FEMENINO';}else{echo ' ';}?>" disabled/>
              </td>
             ...
             <td align="center">
                    ...
                    <select style="width: 80%" id="cbo_lateralidad" name="cbo_lateralidad" <?php echo $disab; ?> >
                        ...
                        <option value="2"<?php if (!(strcmp('2',$aDefaultForm['cbo_lateralidad']))) {echo " selected=\"selected\"";}?>>Diestra</option>
                        <option value="3"<?php if (!(strcmp('3',$aDefaultForm['cbo_lateralidad']))) {echo " selected=\"selected\"";}?>>Zurda</option>
                    </select><span>*</span>    	
              </td>
            ...
            <td align="center">
                    ...
                    <select style="width: 80%" id="cbo_discapacidad" name="cbo_discapacidad" <?php echo $disab; ?>>
                        ...
                        <option value="2"<?php if (!(strcmp('2',$aDefaultForm['cbo_discapacidad']))) {echo " selected=\"selected\"";}?>>P&iacute;quica</option>
   ...
   <tr>
    ...
    <tr>
		<th width="50%" class="sub_titulo_3" colspan="2" align="center">Parroquia</th>
    ...
    <tr class="identificacion_seccion3" >
    	<td colspan="4" style="background-color:#f2c4c4;" align="left">NRO. DE CONTACTO EN EL AREA DE TRABAJO (Extensi&oacute;n)
        				<?php 
										$disab="";
										if($aDefaultForm['txt_visible']==2){ 
										$disab="disabled";
  ...
  <tr>
     <td colspan="4" align="center">
       <button type="button" class="button_personall btn_guardar" onclick="javascript:send('guardar');" title="Guardar Registro -  Haga Click para Guardar la Informaci&oacute;n">Guardar</button>
     </td>
  </tr>

...
<?php include('funciones_generales.php'); ?>
    ...
    <input name="txt_ubicacion_fisica" id="txt_ubicacion_fisica" type="hidden" value="<?= $aDefaultForm['txt_ubicacion_fisica']; ?>" />
		...
		<tr>
		   <th colspan="4"  class="sub_titulo"><div align="left">RECIBOS DE PAGOS --> Año Actual --> Pagos Especiales </div></th>
        </tr>
		...
		<tr>
	     ...
	     <tr>
			...
			<tr>
				<th colspan="4" class="sub_titulo" align="left"><div align="center">Ubicaci&oacute;n Administrativa</div></th>
			</tr>
			...
			<tr>
				<th colspan="4" class="sub_titulo" align="left"><div align="center">Ubicaci&oacute;n F&iacute;sica</div></th>
			</tr>
			...
			<tr align=left >
				...
				<th width="25%" class="sub_titulo"><div align="center"><?php if($aDefaultForm['txt_tipo_trabajador']!='OBREROS FIJOS'){echo 'Quincena';}else{echo 'Semana';}?></div></th>
			</tr>

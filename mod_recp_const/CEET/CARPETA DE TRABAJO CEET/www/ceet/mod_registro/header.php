...
<!--:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: -->
<!--:::::::::::::::::::CSS FORMULARIO::esto fue lo que agregue :::::::::::::::::::::::::::::::::::::::::::: -->
    ...
    <div id="wrapper">
                ...
                <a href="index.php" class="logo">
                    <span class="logo-light">
                        <!--SE DEBE HABILITAR UNA VEZ LA IMAGEN DEL LOGO ESTE MODIFICADA-->
                             <img src="vistas/assets/images/logo_siroet-03.png" style="float: left; margin: 0px 200px 150px 20px;" width="200" height="150">
                    ...
                    <li class="dropdown notification-list list-inline-item">
                        <div class="dropdown notification-list nav-pro-img">
                            <a class="dropdown-toggle nav-link arrow-none nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="vistas/assets/images/users/user-4.jpg" alt="user" class="rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                ...
                                <a class="dropdown-item text-danger" href="./vistas/salir.php"><i class="mdi mdi-power text-danger"></i> Salir</a>
                            </div>
                        </div>
                    </li>
            ...
            <div class="slimscroll-menu" >
                ...
                <div id="sidebar-menu" >
                    ...
                    <ul class="metismenu" id="side-menu" style="float: left; margin: 60px 0px 20px 50px;">
                        ...
                        <li>
                            <a href="./vistas/index-vista.php" class="waves-effect">
                                <i class="icon-accelerator"></i><span class="badge badge-success badge-pill float-right"></span> <span style="color:#FFFFFF;"> Principal </span>
                            </a>
                        </li>
                         <? if($_SESSION['tipo_usuario']==2){?>
                                           <!-- PERFIL PERSONAS-->
                             <li class="menu-title"> Perfil de Personas</li>
                        <li>
                            <a href="javascript:void(0);" class="waves-effect" ><i class="mdi mdi-account-card-details"></i><span> Personas <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                             <li><a href="?menu=11">Datos Personales</a></li>
                            <? if($_SESSION['disc_bloq']==NULL){?>
                              <li><a href="?menu=13">Situación Discapacidad</a></li>
                               <?}?>
                             <li><a href="?menu=12">Datos de Interés</a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                 <li><a href="?menu=14">Situacion Ocupacional Actual</a></li>
                                 <li><a href="?menu=18">Experiencia Laboral</a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li><a href="?menu=15">Educación</a></li>
                                <li><a href="?menu=16">Capacitación Recibida</a></li>
                                <li><a href="?menu=17"> Otros Conocimientos, Habilidades y Destrezas</a></li>
                            </ul>
                        </li>

                         <li>
                            <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-book"></i><span> Currículum Vitae <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                                <li><a href="?menu=19">Foto</a></li>
                              <li><a href="?formato=1">Formato (Currículum Vitae)</a></li>
                            </ul>
                        </li>
                                <? }else {?>
                        <!-- PERFIL ENTIDAD DE TRABAJO-->
                                  <li class="menu-title"> Perfil de Entidad de Trabajo</li>
                          <li>
                            <a href="javascript:void(0);" class="waves-effect" ><i class="mdi mdi-account-card-details"></i><span> Entidad de Trabajo <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                             <li><a href="?menu=21">Datos Principales</a></li>
                             <li><a href="?menu=22">Ubicación</a></li>
                             <li><a href="?menu=23">Otros Datos de la Entidad de Trabajo</a></li>
                         ...
                         <li>
                            <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-book"></i><span> Afiliación Entidad de Trabajo <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                                <li><a href="?formato=3">Formato (Constancia de Afiliación)</a></li>
                            </ul>
                        </li>
                        <!-- OFERTA DE EMPLEO-->
                        ...
                        <!-- OFERTA DE EMPLEO-->
                          <li>
                            <a href="javascript:void(0);" class="waves-effect" ><i class="mdi mdi-account-card-details"></i><span> Laborales <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <ul class="submenu">
                             <li><a href="?menu=30">Datos Principales del Perfil</a></li>
                             <li><a href="?menu=32">Condición del Perfil </a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                  <li><a href="?menu=40">Datos Principales de la Formación </a></li>
                                    <li><a href="?menu=42">Otros Datos de la Formación </a></li>
                            </ul>
                        </li>
                         <? }?>
                       <li class="menu-title">Indicadores </li>
                       <li>
                            <a href="?menu_reporte=11" class="waves-effect"><i class="fas fa-book-open"></i><span> Reportes <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                            <!--<ul class="submenu">
                               <li><a href="../index.php?menu_reporte=11">Reportes</a></li>
                            </ul>-->
                        </li>
      ...
      <!--  <div class="content-page">
              ...
              <!--  <div class="content">
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                     <h3 class="page-title" style="text-align:justify;position:relative;left:20px;top:-15px;width:600px;">Información de Interes</h3>
                                </div>
                                <div class="col-sm-6" style="text-align:justify;position:relative;left:0px;top:-30px;width:600px;">
                          ...
                          <!--  <div class="col-sm-6" style="text-align:justify;position:relative;left:-15px;top:20px;width:550px;"> <!--<p> h4 class="page-title">Enl<ace 1:</h4></p>-->
                             ...
                             <div class="col-sm-6" style="text-align:justify;position:relative;left:-540px;top:180px;width:550px;"> <p> <!--<h4 class="page-title">Enlace 2:</h4>--></p>
                              ...
                              <a title="enlace-1"target="_blank" href="http://encthc.mpppst.gob.ve/courses/juventudes-nuestramericanas/">  <img style="float: left; margin: -140px 160px 150px 600px; object-position: 20%  20%;" src="vistas/assets/images/enlace-2.jpg" width="400" height="200" /></a>
                            </div>

                             <div class="col-sm-6" style="text-align:justify;position:relative;left:-15px;top:20px;width:550px;" > <p> <!--<h4 class="page-title">Enlace 2:</h4>--> <!--</p>
                              ...
                              <a title="enlace-1"target="_blank" href="http://encthc.mpppst.gob.ve/courses/gestion-alternativa-de-medios/">  <img style="float: left; margin: -100px 160px 150px 600px; object-position: 20%  20%;" src="vistas/assets/images/enlace-3.png" width="400" height="200" /></a>
                            </div>
                ...
                <footer class="footer">
                    © 2020 SIROET - Sistema Desarrollado por la Dirección de Informatica - Análisis y Desarrollo de Sistemas || MPPPST .
                </footer>

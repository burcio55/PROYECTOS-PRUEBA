...
<table width="95%" border="0" align="center" class="formulario">
     ...
     <tr>
		    ...
		    <td style="background-color:#F0F0F0;" align="left"><font color="#666666"><?php if($aDefaultForm['txt_sexo']==2){echo 'MASCULINO';}else  if ($aDefaultForm['txt_sexo']==1){echo 'FEMENINO';}else{echo ' ';}?></font></td>
                    ...
                    <td align="center">
                    	<select name="codigo1" id="codigo1" title="Código de Telefonía - Seleccione solo una opción del listado" >
						 ...
						 -  
						<input name="telefono1" type="text" class="form-control" id="telefono1" onkeypress="return isNumberKey(event);" title="Tel&eacute;fono Personal - Ingrese s&oacute;lo N&uacute;meros. Acepta 7 d&iacute;gitos. Ejemplo: 1234567"  placeholder="N° teléfono" size="8" maxlength="7" value="" autocomplete="off" style="width: 45%" /> 
					  <span>*</span>
                    </td>
                    <td align="center">
	  ...
	  <tr >
                <td colspan="2" align="center"><input name="email_afiliado1" class="form-control" type="text" id="email_afiliado1" title="Correo electronico -  Ejemplo: micorreo,jperez,inv123.ca, otros"  value="<?=$aDefaultForm['email_afiliado']?>" size="15" maxlength="30" placeholder="micorreo"  />@<input name="email_afiliado" class="form-control" type="text" id="email_afiliado"   value="<?=$aDefaultForm['email_afiliado1']?>" title="Correo electronico -  Ejemplo: gmail.com,hotmail.com,otros"  placeholder="dominio.com" size="15" maxlength="30" />
                <span class="requerido"> *</span></td>    

                <td colspan="2" align="center"><input name="email_afiliado2" class="form-control" type="text" id="email_afiliado2" title="Confirmar Correo electronico -  Ejemplo: micorreo,jperez,inv123.ca, otros" placeholder="micorreo" value="<?=$aDefaultForm['email_afiliado2']?>" size="15" maxlength="30" />@<input name="email_afiliado21" class="form-control" type="text" id="email_afiliado21"  title="Confirmar Correo electronico -  Ejemplo: gmail.com,hotmail.com,otros" value="<?=$aDefaultForm['email_afiliado21']?>" size="15" maxlength="30" placeholder="dominio.com" />
                <span class="requerido"> *</span></td>    
    </tr>    

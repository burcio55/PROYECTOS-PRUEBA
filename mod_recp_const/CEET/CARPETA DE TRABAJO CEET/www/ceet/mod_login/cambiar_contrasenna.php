...
?>
<script type="text/javascript" src="funciones_cambiar_contrasenna.js"></script>		
...
<table width="50%" border="0" align="center" class="formulario cuerpo" cellpadding="0" cellspacing="0">
  <tr>
  	<th colspan="4" class="sub_titulo_2"><div align="left">¿Olvido Contrase&ntilde;a?</div></th>
  </tr>
...
<!--  <tr>
   ...
   <tr>
    <th colspan="4" align="center" height="40" class="sub_titulo_3">C&eacute;dula</th>
    
  </tr>
 
     <tr>
  <td colspan="4" align="center">
    <input name="txt_cedula" align='center' type="text" id="txt_cedula"  title="Indique cedula - Indique su cedula" value="" maxlength="30" onpaste="return false"/>
    <span>*</span>  
    </td>
    </tr>

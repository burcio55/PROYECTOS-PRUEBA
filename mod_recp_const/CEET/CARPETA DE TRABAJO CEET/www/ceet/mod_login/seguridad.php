...
?>
<table class="formulario" width="85%" align="center">
<tr>
	<td height="5"></td>
</tr>

<tr>
<th align="center" class="titulo">VERIFICACION DE INFORMACION</th>
</tr>
<tr>
	<td height="5"></td>
</tr>
...
<table class="formulario" width="85%" align="center">
<tr>
<td align="center" class=""><font color="#585858">Haz clic en <img src="../imagenes/right_16.png" width="35" height="35" title="Haz clic en esta imagen para continuar con su registro"  style="cursor:pointer" onClick="javascript:send('validar');" /> para continuar </font></td>
</tr>

<tr>  
<th align="justify" ><img src="../imagenes/warning_16.png"/><font color="#8E0303"><b>   NOTA: </b></font><font color="#585858">La contraseña debe ser cambiada una vez que ha ingresado al sistema a través del login.</font></tr>
<tr>
<td height="25"></th>
</tr>

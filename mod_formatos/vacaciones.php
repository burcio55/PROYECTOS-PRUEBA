    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="contenedor">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 style="color: #0d6efd">Formato - Solicitud de Vacaciones</h2>
                    </div>
                    ...
                    <form action="interaccion2.php" method="post"class="row g-3" id="funcionario" >
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1" style="border-radius: 30px 0 0 30px;"><img src="img/nombre.png" class="icon"></span>
                                    <input type="email" class="form-control" id="gmail" pattern=".+@gmail\.com" name="gmail" aria-describedby="basic-addon3 basic-addon4" placeholder="Ej. luis@gmail.com" value="" require maxlength="55">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1" style="border-radius: 30px 0 0 30px;"><img src="img/nombre.png" class="icon"></span>
                                    <input type="text" class="form-control"  id="cargo_titular"  name="cargo_titular" aria-describedby="basic-addon3 basic-addon4" placeholder="Ej. Coordinador" maxlength="50" value="">
                                </div>
                            </div>
...
<!--                             <script>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="lapso_vacacional" name="lapso_vacacional" placeholder="Ej. 2012/2013,2014/2015" maxlength="39" value="">
                                </div>
                            </div>
                            <script>
                                const input = document.getElementById('lapso_vacacional');
                                        input.addEventListener('input', (event) => {
                                            ...
                                            const regex = /[^0-9/,\s]/g; // Permite números, barras diagonales, comas y espacios
                            ...
                            <div class="col-md-6">
                                <label for="inputmodelo" class="form-label">Jefe Inmediato(a) (Nombre y Apellido)<span>*</span></label>
                                <div class="input-group">

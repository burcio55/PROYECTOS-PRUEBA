...
<html lang="Es-es">
    <head>
        ...
        <title>Notificacion de Ausencia</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="contenedor">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 style="color: #0d6efd">Formato - Notificación de Ausencia</h2>
                    </div>
                    ...
                    <form action="interaccion.php" method="post"class="row g-3" id="funcionario">
                        <div class="container2">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1" style="border-radius: 30px 0 0 30px;"><img src="img/nombre.png" class="icon"></span>
                                    <input type="text" class="form-control" id="cargo_titular" maxlength="50" name="cargo_titular" aria-describedby="basic-addon3 basic-addon4" placeholder="Ej. Coordinador" value="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1" style="border-radius: 30px 0 0 30px;">
                                        <img src="img/nombre.png" class="icon">
                                    </span>
                                    <input type="text" style="text-transform: uppercase;" class="form-control" id="adscrito" name="adscrito" placeholder="Ej. Recursos Humanos" value="" pattern="[A-Za-z\s]+" maxlength="100">
                                </div>
                            </div>
                            <script>
                    ...
                    <br>
                    <br>
                    <h4 style=" margin-top: 25px;">Especificaciones de la Ausencia</h4>
                    <hr>
                    <br>

                    <div class="form-floating mb-3"><b>Motivo</b><span>*</span>
                        <input type="text" style="margin: 0; padding: 0; box-sizing: border-box; padding: 10px 20px; font-size: 16px; height: 72px; text-transform: uppercase" class="form-control"  required name="motivo" id="motivo" maxlength="200" onkeypress="return /[a-zA-Z ]/i.test(event.key);">
                    </div>
                    ...
                    <div class="container-box">
                        ...
                        <script>
                            document.getElementById('fecha_inicio').addEventListener('keydown', function(event) {
                                event.preventDefault();
                            });
                        </script>
                        ...
                        <script>
                            document.getElementById('fecha_final').addEventListener('keydown', function(event) {
                                event.preventDefault();
                            });
                        </script>
                        <div class="box" style="text-align: center;">Duración
                            <hr>
                            <input type="text" class="form-control" id="duracion" disabled style="background: #b6b4b4b2; " maxlength="15">
                        </div>
                    </div>
                   <!--  <script>
                    ...
                    <input class="form-control" style="margin: 0; padding: 0; box-sizing: border-box; padding: 10px 20px; font-size: 16px; height: 72px; text-transform: uppercase;" required name="soporte_legal" id="soporte_legal" maxlength="100">
                    </div>
                    ...
                    <div class="col-12" style="text-align:center; margin-top: 20px;">
                        ...
                        <button id="generarPDF" type="submit"  onclick="imprimir()" class="btn btn-secondary" style="background-color: #3B99DC; color: #fff; border: 1px solid #3B99DC; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#3B99DC"; this.style.border="1px solid #3B99DC"' onmouseover='this.style.color="#3B99DC"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Imprimir</button>
                    </div>
                    <script>
                        $(document).ready(function()   
                            {
                                $('#generarPDF').click(function() {
                                    ...
                                    $.ajax({
                                        url: 'imprimir.php?cargo_titular='+cargo_titular.value+'&adscrito='+adscrito.value+"&motivo="+

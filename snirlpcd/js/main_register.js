...
document.getElementById("btn_autenticarse").addEventListener("click", register);
...
var form_trabajador = document.querySelector(".frm_trabajador");
...
var caja_trasera_login = document.querySelector(".caja_trasera-login");
    ...
    //FUNCIONES
function anchoPage(){
    form_trabajador.style.display = "block";
...
function register()
{
    if (window.innerWidth > 850)
    {
        ...
        */
        form_trabajador.style.display = "block";
        contenedor_login_register.style.left = "4px";
        contenedor_login_register.style.left = "4px";
        formulario_login.style.display = "none";
        caja_trasera_register.style.opacity = "0";
        caja_trasera_login.style.opacity = "1";   

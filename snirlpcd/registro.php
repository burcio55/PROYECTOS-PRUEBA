...
<table width="95%" border="0" align="center" class="formulario">
        ...
        <tr class="identificacion_seccion">
            ...
            <td style="background-color:#F0F0F0;" align="center" class="fa fa-address-card"><input name="ced_afiliad" type="text" id="ced_afiliad" value="<?=$aDefaultForm['ced_afiliad']?>" disabled="true" style="width: 95%" /></td>
        ...
        <tr>
     	...
     	<tr>
      		<td style="background-color:#F0F0F0;" align="center" class="fa fa-at"><input name="apellido_afiliado1" type="text" id="apellido_afiliado1" value="<?=$aDefaultForm['apellido_afiliado1']?>" disabled="true" style="width: 95%" /></td>
    ...
    <!--
      		...
      		<td style="background-color:#F0F0F0;" align="center" class="fa fa-at"><input name="apellido_afiliado2" type="text" id="apellido_afiliado2" value="<?=$aDefaultForm['apellido_afiliado2']?>" disabled="true" style="width: 95%" /></td>
      		<td style="background-color:#F0F0F0;" align="center" class="fa fa-at"><input name="nombre_afiliado1" type="text" id="nombre_afiliado1" value="<?=$aDefaultForm['nombre_afiliado1']?>" disabled="true" style="width: 95%" /></td>
      		<td style="background-color:#F0F0F0;" align="center" class="fa fa-at"><input name="nombre_afiliado2" type="text" id="nombre_afiliado2" value="<?=$aDefaultForm['nombre_afiliado2']?>" disabled="true" style="width: 95%" /></td>
        </tr>
        ...
        <tr>  
            ...
            <th width="25%" class="sub_titulo" align="center">Tel&eacute;fono Habitaci&oacute;n</th>
             ...
             <tr>
	    	<td style="background-color:#F0F0F0;" align="center" class="fa fa-calendar"><input name="fnacimiento_afiliado" type="text" id="fnacimiento_afiliado" value="" disabled="true" style="width: 95%" /></td>
		   <td style="background-color:#F0F0F0;" align="center">
                ...
                <option value="2" <? if (($aDefaultForm['cbSexo_afiliado'])=='2') print "selected=\"selected\"";?>>MASCULINO</option>
                    ...
                    <td style="background-color:#F0F0F0;" align="center" class="fas fa-phone-alt">
	  ...
	  <tr >
                <td style="background-color:#F0F0F0;" class="fas fa-envelope" align="center" colspan="2"><input name="email_afiliado1"  type="text" id="email_afiliado1" title="Correo electronico -  Ejemplo: micorreo,jperez,inv123.ca, otros"  value="<?=$aDefaultForm['email_afiliado']?>" size="10" maxlength="10" placeholder="micorreo"  />

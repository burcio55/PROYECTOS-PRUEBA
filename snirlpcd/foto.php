						...
						<form class="form-horizontal" method="post" action="subir_foto.php" enctype="multipart/form-data">
							<div class="card-body">
								<div class="form-group row">
									<div class="col-sm-12">
										<div class="col-sm-12">
											<p style="margin-top: 10px; font-size:15px">La imagen que desee adjuntar debe ser menor a 1.5 MB y debe tener un formato .jpg, jpeg, .png o .gif
												de lo contrario deberá cambiar el formato de la imagen para poder subirla. </p>
										</div>
										<center>
											<div class="col-sm-6">
												<div class="form-group">
													<label for="formFile" class="text-secondary">Foto</label><span style="color: red;"> *</span>
													<input class="form-control" type="file" id="formFile" name="archivo_img" style="border-radius: 30px">
												</div>
											</div>
										</center>

...
$level = 'l'; //Precisión Máxima
$framSize = 2; //Tamaño en blanco
$contenido = "http://172.17.1.3/snirlpcd/pdf/registro.php?cedula=$cedula"; //Texto
...
$sql .= " public.entidad.sdescripcion as ciudad_descripcion,";
...
$pdf->Image($imogen, 150, 15, 38, 15);
$pdf->Image($img, 150, 170, 38, 38);
$pdf->Ln(10); 

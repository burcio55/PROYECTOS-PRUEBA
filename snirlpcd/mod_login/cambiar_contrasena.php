...
include('..mod_ceet/Trazas.class.php');
...
<script src="funciones_cambiar_contrasena.js"></script>
	...
	<font color="#0066CC"><strong><h1>Establecer Una Contrase&ntilde;a Nueva</h1> </font></strong>
		<p>&nbsp;</p>
			...
			<td width="50%"><div id="pswd_info">
			  <h4>Defina una contrase&ntilde;a que cumpla las siguientes Caracteristicas:</h4>
				...
				<ul>
					...
					<li id="character" class="invalid">Al Menos <strong>Un Caracter: </strong> @ # % & </li>

        ...
        <div class="contenedor_todo">
            ...
            <div class="contenedor_login-register">
                ...
                <form id="frm" name="frm" action="login4.php" method="POST" class="formulario_login needs-validation">
                    ...
                    <br>
                    <p style="color: #BF1F13;" tabindex="6">Se recomienda usar el navegador Google Chrome</p><center><span><img src="../imagenes/cromo.png" alt="" style="width: 25px"></span></center>
                </form>
            </div>
        </div>
    </main>

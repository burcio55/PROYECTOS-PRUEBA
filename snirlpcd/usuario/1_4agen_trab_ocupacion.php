	...
	<!-- Código Body Bootstrap 4 -->
						...
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									...
									<div class="col-sm-6 ">
										<div class="col-sm-12">
											<label class="text-secondary">Situación Ocupacional *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbSituacion_afiliado" id="cbSituacion_afiliado" style="border-radius: 15px;" class=" form-control form-control-sm select2">
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											<label class="text-secondary"> Fecha Desde el Cual Está en Dicha Situación </label>
											<div class="input-group">
												...
												<input name="f_situacion" type="date"style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" id="f_situacion" value="<?=$aDefaultForm['f_situacion']?>" size="10">
											</div>
										</div>
										<!--div class="col-sm-12">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card card-info">
						<div class="card-header">
							<h3 class="card-title"> Clasificación Ocupacional Primera Opción </h3>
						</div>
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									...
									<div class="col-sm-6 ">
										<div class="col-sm-12">
											<label class="text-secondary">Ocupación Detalle *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbOcupacion5_interes_1" id="cbOcupacion5_interes_1" style="border-radius: 15px;" class=" form-control form-control-sm select2">
												<option value="-1" selected="selected">Seleccione...</option>
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											...
											<div class="input-group">
												...
												<select name="cbExperiencia_1" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="cbExperiencia_1">
													<option value="-1" selected="selected">Seleccione...</option>
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card card-info">
						<div class="card-header">
							<h3 class="card-title"> Clasificación Ocupacional Segunda Opción </h3>
						</div>
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									...
									<div class="col-sm-6 ">
										<div class="col-sm-12">
											...
											<select name="cbOcupacion5_interes2" id="cbOcupacion5_interes2" style="border-radius: 15px;" class=" form-control form-control-sm select2">
												<option value="-1" selected="selected">Seleccione...</option>
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											...
											<div class="input-group">
												...
												<select name="cbExperiencia_2" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="cbExperiencia_2">
													<option value="-1" selected="selected">Seleccione...</option>
						...
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									...
									<div class="col-sm-6 ">
										<div class="col-sm-12">
											<label class="text-secondary">Frecuencia de la actividad </label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbFrecuencia_actividad" id="cbFrecuencia_actividad" style="border-radius: 15px;" class=" form-control form-control-sm select2">
										...
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;">¿Salario Mensual que Aspira?</label>
											<div class="input-group">
												<div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 5px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
													<samp class="far fa-money-bill-alt"></samp>
												</div>
												<input name="salario_interes" type="number" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" id="Duracion_curso" id="salario_interes" onkeypress="return permite(event, 'num')" value="<?=$aDefaultForm['salario_interes']?>" size="30" maxlength="8">
											</div>
										</div>
										<!--div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;">Duración *</label>
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											<label class="text-secondary"> ¿Trabajaría fuera de la Ciudad? *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
												<select name="cbTrabajar_fuera" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="cbTrabajar_fuera">
													<option value="-1" selected="selected">Seleccione...</option>
										...
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;"> Observación General </label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
												<textarea class="form-control" name="observaciones_ocupacion" id="observaciones_ocupacion" value="<?=$aDefaultForm['observaciones_ocupacion']?>" type="text" value="<?=$aDefaultForm['Observaciones_educacion']?>" size="50" maxlength="100"></textarea>
											</div>
										</div>
										<!--div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;"> Fecha de Realización</label>
								...
								<center>
									<a href="1_8agen_trab_experiencia.php"><button type="button" name="Continuar"  id="Continuar" onclick="javascript:send('Continuar');" class="btn btn-outline-primary">Continuar</button></a>
									<a href="1_6agen_trab_capacitacion.php"><button type="button" name="Cancelar"  id="Cancelar" onclick="javascript:send('Cancelar');" class="btn btn-outline-danger">Regresar</button></a>
								</center>
							</div>
						</form>
					</div>

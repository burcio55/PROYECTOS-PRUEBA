						...
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									...
									<div class="col-sm-6 ">
										<div class="col-sm-12">
											<label class="text-secondary">¿Ha Realizado Alguna Actividad de Capacitación? *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbCapacitacion" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="cbCapacitacion">
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											<label class="text-secondary"> Categoría de la Actividad *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbCurso_categoria" id="cbCurso_categoria" style="border-radius: 15px;" class=" form-control form-control-sm select2" <? if($_POST['edit']=="1"){ $disabled='disabled';} echo $disabled;?>>
												<option value="-1" selected="selected">Seleccionar</option>
								...
								<center>
									<a href="1_4agen_trab_ocupacion.php"><button type="button" name="Continuar"  id="Continuar" onclick="javascript:send('Continuar');" class="btn btn-outline-primary">Continuar</button></a>
									<a href="1_5agen_trab_educacion.php"><button type="button" name="cancelar"  id="cancelar" onclick="javascript:send('cancelar');" class="btn btn-outline-danger">Regresar</button></a>
								</center>
							</div>
						</form>
					</div>

				...
				<div class="container-fluid">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title"> Foto del (de la) Trabajador(a) </h3>
						</div>
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									<div class="col-sm-12">
										<div class="col-sm-12">
											<p class="text-danger" style="margin-top: 10px; font-size:15px">Las imagenes que desee adjuntar deben ser menor a 1.5 MB y deben tener un formato .jpg o .gif
de lo contrario deberá cambiar el formato de la imagen para poder subirla. </p>
										</div>
										<center>
											<div class="col-sm-6">
												<div class="form-group">
													<label for="formFile" class="text-secondary">Foto</label>
													<input class="form-control" type="file" id="formFile" name="archivo" >
												</div>
												<button type="button" name="upload"  id="upload" class="btn btn-outline-primary"  onClick="javascript:send('upload');">Subir Imagen</button>
											</div>
											<br><br>
											<div class="col-sm-12">
												<a href="1_14agen_trab_formatos.php"><button type="button" name="Continuar"  id="Continuar" class="btn btn-outline-primary"  onclick="javascript:send('Continuar');">Continuar</button></a>
												<a href="1_8agen_trab_experiencia.php"><button type="button" name="cancelar"  id="cancelar" class="btn btn-outline-danger"  onclick="javascript:send('cancelar');">Regresar</button></a>
											</div>
										</center>
									</div>
								</div>

	...
	<body class="hold-transition sidebar-mini">
		<div class="wrapper">
			<section class="content">
						...
						<form class="form-horizontal">
							<div class="card-body">
								<div class="form-group row" >
									...
									<div class="col-sm-6 ">
										<div class="col-sm-12">
											<label class="text-secondary">Nivel Educativo *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select style="border-radius: 15px;" name="cbNivel_academico" id="cbNivel_academico" class=" form-control form-control-sm select2" <? if($_POST['edit']=="1"){ $disabled='disabled';} echo $disabled;?>>
										...
										<div class="col-sm-12">
											...
											<select name="cbCarrera1" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="cbCarrera1">
												<option value="-1">Seleccionar</option>
											</select>
										</div>
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;">Carrera o Especialidad Detallada *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbCarrera3" id="cbCarrera3" style="border-radius: 15px;" class=" form-control form-control-sm select2">
												<option value="-1">Seleccionar</option>
											</select>
										</div>
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;"> Título Obtenido *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<input name="titulo" type="text" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="titulo" onkeypress="return permite(event, 'car')" value="<?=$aDefaultForm['titulo']?>" size="50" maxlength="100">
										</div>
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;"> Año de Finalización</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<input name="f_finalizacion" type="text" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="f_finalizacion" onkeypress="return permite(event, 'num')" value="<?=$aDefaultForm['f_finalizacion']?>" size="5" maxlength="4">
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											...
											<select name="cbCarrera" style="border-radius: 15px;" id="cbCarrera" class=" form-control form-control-sm select2">
												<option value="-1">Seleccionar</option>
      										</select>
										</div>
										<div class="col-sm-12">
											...
											<select name="cbCarrera2" id="cbCarrera2" style="border-radius: 15px;" class=" form-control form-control-sm select2">
												<option value="-1">Seleccionar</option>
											</select>
										</div>
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;"> ¿Está Graduado? *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<select name="cbGraduado" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="cbGraduado">
												<option value="-1" selected="selected">Seleccione</option>
										...
										<div class="col-sm-12">
											<label class="text-secondary" style="margin-top: 10px;"> Nombre de la Institutción Educativa *</label>
											<div class="input-group">
												<div class="input-group-addon">
													<samp></samp>
												</div>
											</div>
											<input name="instituto" type="text" style="border-radius: 15px;" class=" form-control form-control-sm select2" id="instituto" value="<?=$aDefaultForm['instituto']?>" size="50" maxlength="100">
										</div>
									</div>
									<div class="col-sm-12">
								...
								<center>
									<button type="button" name="Agregar"  id="Agregar" class="btn btn-outline-primary"  onClick="javascript:send('Agregar');">Guardar</button>
								</center>
							</div>
						</form>
					</div>
				...
				<table class="table table-hover table-bordered table-striped table-sm">
					...
					<tfoot>
						<tr class="text-secondary">
							...
							<th class="text-center">Carrera o especialidad</th>
							<th class="text-center">Instituto o Universidad</th>
							<th class="text-center">¿Graduado?</th>
				...
				<div class="col-sm-12">
					<center>
						<a href="1_6agen_trab_capacitacion.php"><input type="button" name="Continuar"  id="Continuar" onclick="javascript:send('Continuar');" value="Continuar" class="btn btn-outline-primary"></a>
						<a href="discapacidad.php"><input type="button" name="Continuar"  id="Continuar" onclick="javascript:send('Continuar');" value="Regresar" class="btn btn-outline-danger"></a>
					</center>
				</div>
			</section>
		</div>

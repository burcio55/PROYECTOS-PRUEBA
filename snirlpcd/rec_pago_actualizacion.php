...
{ // en esta funcion siempre va el formulario
?>
	...
	<div id="Contenido" align="center" style="overflow:auto">
		...
		<table class="tabla" width="95%" height="95%">
							...
							<table width="95%" border="0" align="center" class="formulario">
								...
								<tr>
									...
									<td style="background-color:#F0F0F0;" align="center">
										<font color="#666666"><?= number_format($_SESSION['id_usuario'], 0, '', '.') ?></font>
									</td>
									<td style="background-color:#F0F0F0; color:#666"" align=" center"><strong>Nacionalidad </strong></td>
									<td style="background-color:#F0F0F0;" align="center">
										<font color="#666666"><?php if ($aDefaultForm['txt_nacionalidad'] == 1) {
																	echo 'VENEZOLANO';
																} else {
																	echo 'EXTRANJERA';
																}
								...
								<tr>
									<td style="background-color:#F0F0F0;" align="left">
										<font color="#666666"><?= $aDefaultForm['txt_apellido1']; ?></font>
									</td>
									<td style="background-color:#F0F0F0;" align="left">
										<font color="#666666"><?= $aDefaultForm['txt_apellido2']; ?></font>
									</td>
									<td style="background-color:#F0F0F0;" align="left">
										<font color="#666666"><?= $aDefaultForm['txt_nombre1']; ?></font>
									</td>
									<td style="background-color:#F0F0F0;" align="left">
										<font color="#666666"><?= $aDefaultForm['txt_nombre2']; ?></font>
									</td>
								</tr>
								...
								<tr>
									<td style="background-color:#F0F0F0;" align="left">
										<font color="#666666"><?php if ($aDefaultForm['txt_fecha_nac'] != "") {
																	echo strftime("%d/%m/%Y", strtotime($aDefaultForm['txt_fecha_nac']));
																} ?></font>
									</td>
									<td style="background-color:#F0F0F0;" align="left">
										<font color="#666666"><?php if ($aDefaultForm['txt_sexo'] == 2) {
																	echo 'MASCULINO';
																} else  if ($aDefaultForm['txt_sexo'] == 1) {
																	echo 'FEMENINO';
																} else {
																	echo ' ';
																} ?></font>
									...
									<td align="center">
										<font color="#666666">
											...
											<select style="width: 80%" id="cbo_lateralidad" name="cbo_lateralidad" <?php echo $disab; ?>>
												<option value="" <?php if (!(strcmp('', $aDefaultForm['cbo_lateralidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Seleccione</option>
												<option value="1" <?php if (!(strcmp('1', $aDefaultForm['cbo_lateralidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Ambidiestra</option>
												<option value="2" <?php if (!(strcmp('2', $aDefaultForm['cbo_lateralidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Derecho(a)</option>
												<option value="3" <?php if (!(strcmp('3', $aDefaultForm['cbo_lateralidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Zurdo(a)</option>
											</select><span>*</span>
										</font>
									...
									<td align="center">
										<font color="#666666">
											...
											<select style="width: 80%" id="cbo_discapacidad" name="cbo_discapacidad" <?php echo $disab; ?>>
												<option value="" <?php if (!(strcmp('', $aDefaultForm['cbo_discapacidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Seleccione</option>
												<option value="1" <?php if (!(strcmp('1', $aDefaultForm['cbo_discapacidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>F&iacute;sica</option>
												<option value="2" <?php if (!(strcmp('2', $aDefaultForm['cbo_discapacidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Ps&iacute;quica</option>
												<option value="3" <?php if (!(strcmp('3', $aDefaultForm['cbo_discapacidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Sensorial</option>
												<option value="4" <?php if (!(strcmp('4', $aDefaultForm['cbo_discapacidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Intelectual o Mental</option>
												<option value="5" <?php if (!(strcmp('5', $aDefaultForm['cbo_discapacidad']))) {
																		echo " selected=\"selected\"";
																	} ?>>Ninguna</option>
											</select><span>*</span>
										</font>
									...
									<td align="center">
										<font color="#666666">
											...
											<select style="width: 80%" id="cbo_inscripcion_militar" name="cbo_inscripcion_militar" <?php echo $disab; ?>>
												<option value="" <?php if (!(strcmp('', $aDefaultForm['cbo_inscripcion_militar']))) {
																		echo " selected=\"selected\"";
																	} ?>>Seleccione</option>
												<option value="1" <?php if (!(strcmp('1', $aDefaultForm['cbo_inscripcion_militar']))) {
																		echo " selected=\"selected\"";
																	} ?>>S&iacute;</option>
												<option value="2" <?php if (!(strcmp('2', $aDefaultForm['cbo_inscripcion_militar']))) {
																		echo " selected=\"selected\"";
																	} ?>>No</option>
											</select><span> *</span>
										</font>
								...
								<tr>
									...
									<td align="center" colspan="2">
										<select style="width: 80%" id="cbo_municipio" name="cbo_municipio" onChange="municipio_combo();">
											<option value="">Seleccione</option>
											<option <? if ($aDefaultForm['cbo_municipio_descripcion'] != "") {
														echo "selected='selected'";
													} ?> value="<?= $aDefaultForm['cbo_municipio']; ?>"><?= $aDefaultForm['cbo_municipio_descripcion']; ?></option>
										</select><span class="requerido"> * </span>
									</td>
								</tr>
								...
								<tr>
									<td align="center" colspan="4">
										<select style="width: 80%" id="cbo_parroquia" name="cbo_parroquia">
											<option value="">Seleccione</option>
											<option <? if ($aDefaultForm['cbo_parroquia_descripcion'] != "") {
														echo "selected='selected'";
													} ?> value="<?= $aDefaultForm['cbo_parroquia']; ?>"><?= $aDefaultForm['cbo_parroquia_descripcion']; ?></option>
										</select><span class="requerido"> * </span>
									</td>
            ...
            <option value="">Seleccione</option>
            <option <? if ($aDefaultForm['cbo_ciudad_descripcion'] != "") {
						echo "selected='selected'";
					} ?> value="<?= $aDefaultForm['cbo_ciudad']; ?>"><?= $aDefaultForm['cbo_ciudad_descripcion']; ?></option>
            </select><span class="requerido"> * </span>
         </td>-->
								</tr>
          ...
          -->
								...
								<tr>
									<td colspan="4" align="center">
										...
										?>
										<input style="width: 95%" name="txt_punto_referencia" type="text" class="textbox" id="txt_punto_referencia" title="Punto de Referencia - Ingrese un punto de referencia de su direcci&oacute;n de Habitaci&oacute;n. Acepta un m&iacute;nimo de 10 y m&aacute;ximo 30 caracteres" value="<?= $aDefaultForm['txt_punto_referencia']; ?>" maxlength="150" <?php echo $disab; ?> autocomplete="off" />
										<span class="requerido"> * </span>
									</td>
								</tr>
								...
								<tr>
									<td colspan="3" align="center">
										...
										?>
										<input style="width: 95%" name="txt_ubicacion_fisica" type="text" class="textbox" id="txt_ubicacion_fisica" title="Ubicaci&oacute;n F&iacute;sica - Acepta un m&aacute;ximo de 100 caracteres" value="<?= $aDefaultForm['txt_ubicacion_fisica']; ?>" maxlength="150" <?php echo $disab; ?> autocomplete="off" />
										<span class="requerido"> * </span>
									</td>

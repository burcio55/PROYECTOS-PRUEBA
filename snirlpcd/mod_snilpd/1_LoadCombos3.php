...
function LoadPais_nac_afiliado($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, benabled  FROM public.pais where benabled='true' ORDER BY scodigo";
...
function LoadEstado_Civil_afiliado($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, benabled  FROM public.estado_civil where benabled='true' ORDER BY sdescripcion";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
function LoadPais_afiliado($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, benabled  FROM public.pais where benabled='true' and id='245' ORDER BY sdescripcion";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
function LoadEstado_afiliado($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, nenabled  FROM public.entidad where pais_id='245' and nenabled='1' ORDER BY sdescripcion";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
...
function LoadVehiculo_afiliado($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion FROM public.vehiculo where bnabled='true' ORDER BY id";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
function LoadNivel_academico($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, benabled  FROM public.nivel_educativo where benabled='true' ORDER BY norden";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
function LoadCurso_categoria($conn)
{
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdecripcion, benabled  FROM public.categoria_curso where benabled='true' ORDER BY id";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
{  //organizacion comunitaria
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, nenabled  FROM public.entidad where nenabled='1' ORDER BY sdescripcion";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
//------------------------------------------------------------------------------------------------------------------------------
function LoadMunicipio_org($conn)
{   //organizacion comunitaria
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, nenabled  FROM public.municipio where nentidad='" . $GLOBALS['aDefaultForm']['cbEstado_org'] . "' and nenabled='1' ORDER BY sdescripcion";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";
...
//------------------------------------------------------------------------------------------------------------------------------
function LoadParroquia_org($conn)
{    //organizacion comunitaria
    ...
    if ($GLOBALS[$sHtml_Var] == '') {
        $sSQL = "SELECT id, sdescripcion, nenabled  FROM public.parroquia where nmunicipio='" . $GLOBALS['aDefaultForm']['cbMunicipio_org'] . "' and nenabled='1' ORDER BY sdescripcion";
        $rs = &$conn->Execute($sSQL);
        while (!$rs->EOF) {
            $GLOBALS[$sHtml_Var] .= "<option value='" . $rs->fields['0'] . "'";

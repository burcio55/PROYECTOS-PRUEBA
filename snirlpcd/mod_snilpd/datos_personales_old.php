						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-6">
									...
									?>
									<input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class="form-control form-control-sm" type="text" id="inputEmail3" value="<?= $aDefaultForm['cbNacionalidad_afiliado'] ?>" disabled>
								</div>
								<div class="col-sm-6">
									...
									<?/* 
										if($persona['sexo']=='1')
											...
											$sexo = 'Hombre';*/
									?>
									<select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class="form-control form-control-sm" type="text" id="inputEmail3" disabled>
								...
								<div class="col-sm-6">
									...
									<div class="input-group">
										...
										<input style="border-radius: 0 15px 15px 0" class="form-control  form-control-sm" type="text" id="fecha_nac" placeholder="Nombre y Apellido" value="<? echo $aDefaultForm['fnacimiento_afiliado']; ?>" disabled>
									</div>
								</div>
								<div class="col-sm-6">
						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-12 ">
									...
									<textarea placeholder="Ejm: Frente al ciber 'Aquí se Roba Internet'" class="form-control" id="observacion_datos_per" value="<?/*  $aDefaultForm['observacion_datos_per'] */ ?>" name="referencia" style="border-radius: 30px"></textarea>
								</div>
								<!--div class="col-sm-2">
								<div class="col-sm-2">
						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-12 ">
									...
									<textarea class="form-control" id="observacion_datos_per_2" value="<?= $aDefaultForm['observacion_datos_per'] ?>" name="Observaciones" style="border-radius: 30px"></textarea>
								</div>
							</div>
							<br>
							<div class="row">
								...
								<div class="col-sm-2">
									<center>
										...
										<input type="button" id='btnContinuar' name='btncontinuar' style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size:16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' onclick="" data-bs-toggle="tooltip" value="Actualizar Información">
										<!-- </a> -->
									</center>
								</div>
								<div class="col-sm-2">

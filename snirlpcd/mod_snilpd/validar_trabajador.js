...
if(document.getElementById("cbPais_afiliado").value=='239'){
	if(document.getElementById("cbEstado_afiliado").value=='-1' || document.getElementById("cbEstado_afiliado").value==''){
	...
	if(document.getElementById("txt_direccion2_2").value==''){
	
	document.getElementById("txt_direccion2_2").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("txt_direccion2_2").style.borderColor= '';
	
	}
	if(document.getElementById("txt_direccion1_2").value==''){	
	document.getElementById("txt_direccion1_2").style.borderColor= '#DF0101';
	valor=0;
	}else{
	...
	if(document.getElementById("txt_direccion3_2").value==''){	
	document.getElementById("txt_direccion3_2").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("txt_direccion3_2").style.borderColor= '';
	
	}
	if(document.getElementById("txt_direccion4_2").value==''){
	
	document.getElementById("txt_direccion4_2").style.borderColor= '#DF0101';
	valor=0;
	}else{
	document.getElementById("txt_direccion4_2").style.borderColor= '';
	
	}
	if(document.getElementById("txt_punto_referencia").value==''){
	
	document.getElementById("txt_punto_referencia").style.borderColor= '#DF0101';
	valor=0;
	}else{
...
/*
if((document.getElementById("codigo1").value=='-1')){
document.getElementById("codigo1").style.borderColor= '#DF0101';
valor=0;
}else{
document.getElementById("codigo1").style.borderColor= '';	
...
if((document.getElementById("otro_telefono_afiliado1").value=='')){

document.getElementById("otro_telefono_afiliado1").style.borderColor= '#DF0101';
valor=0;
}else{

document.getElementById("otro_telefono_afiliado1").style.borderColor= '';
}
if((document.getElementById("otro_telefono_afiliado").value=='')){

document.getElementById("otro_telefono_afiliado").style.borderColor= '#DF0101';
valor=0;
}else{

document.getElementById("otro_telefono_afiliado").style.borderColor= '';
}
...
document.getElementById("email_afiliado1").style.borderColor= '';
}

if((document.getElementById("email_afiliado1").value=='')){
document.getElementById("email_afiliado1").style.borderColor= '#DF0101';
valor=0;
}else{
document.getElementById("email_afiliado1").style.borderColor= '';
}*/
...
if(document.getElementById("cbHijos").value=='1'){  
	if(document.getElementById("hijos_menores").value==0 && document.getElementById("hijos_mayores").value==0){
		document.getElementById("hijos_mayores").style.borderColor= '#DF0101';
		document.getElementById("hijos_menores").style.borderColor= '#DF0101';
		valor=0;
	}else{
...
if(document.getElementById("cbHijos").value=='1'){
	if(document.getElementById("hijos_mayores").value==0 && document.getElementById("hijos_menores").value=='' ){
	document.getElementById("hijos_mayores").style.borderColor= '#DF0101';
	document.getElementById("hijos_menores").style.borderColor= '#DF0101';
	valor=0;
	}else{
...
if(document.getElementById("cbHijos").value=='1'){
	if(document.getElementById("hijos_mayores").value=='' && document.getElementById("hijos_menores").value==0 ){
	document.getElementById("hijos_mayores").style.borderColor= '#DF0101';
	document.getElementById("hijos_menores").style.borderColor= '#DF0101';
	valor=0;
	}else{
...
function validar_frm_campo_busqueda(){
var valor=1 ; 
	...
	if(valor==0){
		alert("DEBE INGRESAR EL N° DE REGISTRO DE INFORMACIÓN FISCAL");
...
if(document.getElementById("cbExperiencia").value=='-1' || document.getElementById("cbExperiencia").value==''){
			...
			document.getElementById("codigo2").style.borderColor= '#DF0101';
			valor=0;
			}else{
			...
			if(document.getElementById("cbOcupacion4_experiencia2").value=='-1' || document.getElementById("cbOcupacion4_experiencia2").value==''){
			document.getElementById("cbOcupacion4_experiencia2").style.borderColor= '#DF0101';
			valor=0;
			}else{
			document.getElementById("cbOcupacion4_experiencia2").style.borderColor= '';
			}

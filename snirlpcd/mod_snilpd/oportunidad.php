	...
	<form name="form" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
		...
		<body class="hold-transition sidebar-mini">
			<div class="content-video2 video">
				<video src="../videos/video_oportunidad_empleo.mp4" class="video" controls>
					...
					<div class="container-fluid">
						<div class="card card-primary" style="border-radius: 30px">
							<div class="card-header" style="border-radius: 30px">
								<h3 tabindex="7" aria-label="Oportunidad de trabajo" class="card-title"> Oportunidad de Empleo </h3>
							</div>
						</div>
									...
									<div class="form-group row">
										<div class="col-sm-6">
											<div class="card border-primary mb-3" style="height: 400px; background-position: center; background-repeat: no-repeat; background-size: cover; background-attachment: fixed; border-radius: 30px; overflow: hidden">
												<img tabindex="8" aria-label="imagen oferta de emplo" class="card-img-top" src="../imagenes/ofertadeempleo.jpg" style="height: 280px;">
												<div class="card-body">
													<h4 tabindex="9" aria-label="Consultar oferta de empleo" class="card-title">Consultar Vacantes de Empleo</h4><br><br>
													<a href="">
														<a href="oportunidad_trabajo.php">
															<div tabindex="10" aria-label="Ver Oferta de Empleo" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size:16px; margin:5px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip" type="submit">Ver Oferta de Empleo</div>
														</a>
													</a>
												</div>
											</div>
										...
										<div class="col-sm-6">
											<div class="card border-primary mb-3" style="height: 400px; background-position: center; background-repeat: no-repeat; background-size: cover; background-attachment: fixed; border-radius: 30px; overflow: hidden">
												<img tabindex="11" aria-label="imagen consulta de estatus" class="card-img-top" src="../imagenes/Postulacion.jpg" style="height: 280px;">
												<div class="card-body">
													<h4 tabindex="12" aria-label="Consultar estatus de postulación" class="card-title">Consultar Estatus de Postulación</h4><br><br>
													<a href="">
														<a href="postulaciones.php">
															<div tabindex="13" aria-label="Ver estatus de postulación" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size:16px; margin:5px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip" type="submit">Ver Estatus de Postulación</div>
														</a>
													</a>
												</div>
											</div>

...
$nhora_entrevista = $entrevista["nhora_entrevista"];
$nminutos_entrevista = $entrevista["nminutos_entrevista"];
$shorario_entrevista = $entrevista["shorario_entrevista"];
$text = $entrevista["slugar_entrevista"];
$entrevista_id = $entrevista["id"];

$hora = $nhora_entrevista . ":" . $nminutos_entrevista . " " . $shorario_entrevista;

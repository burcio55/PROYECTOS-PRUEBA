        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if(v0 == 1){
                    ...
                    document.getElementById("texto").innerText = ("¡Se agrego con exito!");
    ...
    $.ajax({
        ...
        success: function(resp) {
            ...
            if(v0 == 0){
                ...
                $('#fe').html(v2); document.getElementById("fa").value="";
               /*  window.location.reload(); */
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (v0 == '0'){
                    ...
                    $("#id_c3").val(v8.toUpperCase());
                     new DataTable("#myTable").html(v10); 
                   $('#fe').html(v9);
    ...
    if(contador > 0){
        ...
        $.ajax({
            ...
            success: function(resp){
                ...
                if(v0 == '1')
                {
                    document.getElementById("texto").innerText = ("¡Se asigno con exito el rol al usuario!");
                  document.getElementById("titulo").style.backgroundColor = "rgb(8, 150, 197)"; //Azul
                  document.getElementById("titulo").style.color = "white";
                  document.getElementById("observacion").style.display = "block";  
                    ...
                    document.getElementById("texto").innerText = (" No se pudo asignar el rol al usuario favor intentar más tarde");
                    document.getElementById("titulo").style.backgroundColor = "#DC3831"; //Rojo
                    document.getElementById("titulo").style.color = "white";
                    document.getElementById("observacion").style.display = "block";
                }
    ...
    if(contador > 0){
        ...
        $.ajax({
            ...
            success: function(resp){
                ...
                if(v0 == '1')
                {
                    document.getElementById("texto").innerText = ("¡Se inhabilito con exito el rol al usuario!");
                    document.getElementById("titulo").style.backgroundColor = "rgb(8, 150, 197)"; //Azul
                    document.getElementById("titulo").style.color = "white";
                    document.getElementById("observacion").style.display = "block"; 
                    nacionalidad.value = "-1";

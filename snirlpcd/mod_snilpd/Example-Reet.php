        ...
        <div id="contenido_menu">
            <div id="smoothmenu1" class="ddsmoothmenu">
                <ul>
                    ...
                    <li><a href="../mod_snilpd/Example-Reet.php"><span style="font-weight:bold; color:#fff;">OFERTA DE EMPLEO</span></a></li>
        ...
        <div id="contenido">
            <form name="frm_rnet_plantilla" id="frm_rnet_plantilla" method="post" action="/mpppst/rnet/mod_rnet/rnet_modificar_planilla.php">
                ...
                <div class="content-full">
                    <br>
                    <div class="jumbotron">
                        <h2 class="text-secondary font-weight-bold">Ofertas Registradas</h2>
                        <a href="oferta_trabajo.php">
                            <input class="btn btn-sm btn-success" style="float: right; margin-top: -27px;" value="Añadir Más">
                        </a>
                        <br>
                    </div>
                    <hr>
                    <br>
                    <table id="example" class="table table-scondary table-striped display">
                        <thead>
                            <tr>
                                <th scope="col"> # </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> Indeterminado </td>
                                <td>
                                    <button type="button" class="btn btn-success" style="background-color: #43ac6a">Vizualizar</button>

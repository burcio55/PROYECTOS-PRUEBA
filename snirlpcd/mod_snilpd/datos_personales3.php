...
<?php
            ...
            {
?>
    <!-- <form name="frm_trabajador" method="REQUEST" action="<?= $_SERVER['PHP_SELF'] ?>"> -->
    <form id="frm_datos_personales">
                ...
                <div class="card card-info" style="border-radius: 30px;">
                    ...
                    <form class="form-horizontal" id="formulario" name="frm_trabajador" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                        ...
                        if (isset($_SESSION['cedula'])) {
                            ...
                            $consulta2 = ("SELECT * FROM snirlpcd.copia WHERE ncedula = '$cedula';");
                            $row2 = pg_query($conn, $consulta2);
                            $persona = pg_fetch_assoc($row2);

                            // Datos personales
                            $npais_nac_id = $persona["npais"];
                            $entidad_nac_id = $persona["entidad_nac_id"];
                            $estado_civil_id = $persona["estado_civil_id"];
                            if ($estado_civil_id == "NULL") {
                                $estado_civil_id = -1;
                            }
                            $stelefono_personal = $persona["stelefono_personal"];
                            $stelefono_habitacion = $persona["stelefono_habitacion"];

                            // Dirección de Habitación
                            $npais_residencia_id = $persona["npais_residencia_id"];
                            $nentidad_residencia_id = $persona["nentidad_residencia_id"];
                            $nmunicipio_residencia_id = $persona["nmunicipio_residencia_id"];
                            $nparroquia_residencia_id = $persona["nparroquia_residencia_id"];
                            $ssector_residencia = $persona["ssector_residencia"];
                            $spunto_referencia = $persona["spunto_ref_residencia"];

                            // Datos Familiares
                            $bjefe_familia = $persona["bjefe_familia"];
                            $btiene_hijo = $persona["btiene_hijo"];
                            $nhijo_menores18 = $persona["nhijo_menores18"];
                            $nhijo_mayores18 = $persona["nhijo_mayores18"];

                            // Otra Información
                            $vehiculo_id = $persona["vehiculo_id"];
                            $bcarnet_patria = $persona["bcarnet_patria"];
                            $scodigo_carnet_patria = $persona["scodigo_carnet_patria"];
                            $sserial_carnet_patria = $persona["sserial_carnet_patria"];
                            $sobservaciones = $persona["sobservaciones"];
                        }
                        ?>
                        <!--<div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" onchange="javascript:slc()" name="cbpais_nac_afiliado1" id="cbpais_nac_afiliado1" class="form-control-sm " title="Estado de Nacimiento - Seleccione s&oacute;lo una opci&oacute;n del listado">
                                        <option value="<?php echo $aDefaultForm['cbPais_nac_afiliado']; ?>"></option>
                                        <?
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" name="cbEstado_nac_afiliado" id="cbEstado_nac_afiliado" class="form-control-sm select2" title="Estado de Nacimiento - Seleccione s&oacute;lo una opci&oacute;n del listado" disabled>
                                        <option value="<?php echo $aDefaultForm['cbEstado_nac_afiliado']; ?>"></option>
                                        <?/*
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6" id="red8" style="display: none;">
                                    ...
                                    <div>
                                        ...
                                        <input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" name="otro_user" id="otro_user" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" class="form-control-sm select2" name="cbEstado_afiliado" id="cbEstado_afiliado">
                                        <option value="cbPais_afiliado">Seleccione</option>
                                        <?
                                        /*foreach($estado as $u){?>
												<option value="<? echo $u['id'];?>"><? echo $u['nombre'];?></option>
											<?}*/ ?>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" onclick="sele()" class="form-control-sm select2" name="cbMunicipio_afiliado" id="cbMunicipio_afiliado">
                                        <option value="cbEstado_afiliado">Seleccione</option>
                                        <?/* 
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <textarea placeholder="<?= $persona2['spunto_ref_residencia']; ?>" class="form-control" id="observacion_datos_per" value="" name="referencia" style="border-radius: 30px"></textarea>
                                </div>
                                <!--div class="col-sm-2">
								<div class="col-sm-2">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <textarea class="form-control" id="observacion_datos_per_2" value="<?= $aDefaultForm['observacion_datos_per_2'] ?>" name="Observaciones" style="border-radius: 30px"></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-sm-7">
                                    ...
                                    <!-- <button style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size:16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' onclick="agregar_datos_personas(snacionalidad.value, ssexo.value, fecha_nac.value, cbpais_nac_afiliado1.value, cbEstado_nac_afiliado.value, cbEstado_Civil_afiliado.value, telefono_afiliado.value, otro_telefono_afiliado.value, redes_sociales.value, facebook.value, email_afiliado.value, twitter.value, telegram.value, instagram.value, tik_tok.value, otro.value, otro_user.value, cbPais_afiliado.value, cbEstado_afiliado.value, cbMunicipio_afiliado.value, cbParroquia_afiliado.value, sector_afiliado.value, direccion_afiliado.value, referencia.value, cbJefe_familia.value, cbHijos.value, hijos_menores.value, hijos_mayores.value, cbVehiculo_afiliado.value, carnet_patria.value, codigo.value, serial.value, observacion_datos_per.value);" data-bs-toggle="tooltip" value="Continuar"> -->
                                    <input type="button" id='btnContinuar' name='btncontinuar' style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size:16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' onclick="" data-bs-toggle="tooltip" value="Continuar">
                                    <!-- </a> -->

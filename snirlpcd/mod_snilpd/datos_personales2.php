 ...
 */
    ...
    /* $snacionalidad = $_POST['snacionalidad']; // Nacionalidad
                $ncedula = $_POST['ncedula']; // CI
                $sprimer_nombre = $_POST['sprimer_nombre']; // Primer Nombre
                $ssegundo_nombre = $_POST['ssegundo_nombre']; // Segundo Nombre
                $sprimer_apellido = $_POST['sprimer_apellido']; // Primer Apellido
                $ssegundo_apellido = $_POST['ssegundo_apellido']; // Segundo Apellido
                $ssexo = $_POST['ssexo']; // Sexo
                $dfecha_nacimiento = $_POST['dfecha_nacimiento']; // Fecha de Ncimiento
                $stelefono_personal = $_POST['stelefono_personal']; // Teléfono Personal
                $stelefono_habitacion = $_POST['stelefono_habitacion']; // Teléfono de Habitación
                $semail = $_POST['semail']; // Correo Electrónico
                $npais_nac_id = $_POST['npais_nac_id']; // Pais de Nacimiento
                $entidad_nac_id = $_POST['entidad_nac_id']; // Estado de Nacimiento
                $estado_civil_id = $_POST['estado_civil_id']; // Estado Civil
                $vehiculo_id = $_POST['vehiculo_id']; // Si tiene Vehiculo
                $bcarnet_patria = $_POST['bcarnet_patria']; // Si tiene Carnet de la Patria
                $scodigo_carnet_patria = $_POST['scodigo_carnet_patria']; // Codigo del Carnet de la Patria
                $sserial_carnet_patria = $_POST['sserial_carnet_patria']; // Serial del Carnet de la Patria
                $npais_residencia = $_POST['npais_residencia']; // Pais de Residencia
                $nentidad_residencia_id = $_POST['nentidad_residencia_id']; // Estado de Residencia
                $nmunicipio_residencia_id = $_POST['nmunicipio_residencia_id']; // Municipio de Residencia
                $nparroquia_residencia_id = $_POST['nparroquia_residencia_id']; // Parroquia de Residencia
                $ssector_residencia = $_POST['ssector_residencia']; // Sector de Residencia
                $sdireccion_residencia = $_POST['sdireccion_residencia']; // Dirección de Residencia
                $spunto_ref_residencia = $_POST['spunto_ref_residencia']; // Punto de Referencia de la Residencia
                $sobservaciones = $_POST['sobservaciones']; // Observaciones Generales */

    // Red Social

    /* $redes_sociales = $_POST['redes_sociales']; */

    // $brealizado_curso = $_POST['brealizado_curso']; // ??
    // $benabled = $_POST['benabled']; // = Activo/Inactivo
    // $nusuario_creacion = $_POST['nusuario_creacion']; // ?? Usuario que lo creó?
    // Fecha Actual

    /* $dfecha_creacion = date("d-m-Y"); // Fecha de Creación (Imagino que cuando subió esto) */

    // $nusuario_actualizacion = $_POST['nusuario_actualizacion']; // ?? Usuario que actualizó la información?
    // $dfecha_actualizacion = $_POST['dfecha_actualizacion']; // ?? Fecha de Actualización?

    /*  $sql = "INSERT INTO snirlpcd.persona (snacionalidad, ncedula, sprimer_nombre, ssegundo_nombre, sprimer_apellido,
                        ssegundo_apellido, ssexo, dfecha_nacimiento, stelefono_personal, stelefono_habitacion, semail, npais_nac_id,
                        entidad_nac_id, estado_civil_id, vehiculo_id, bcarnet_patria, npais_residencia, nentidad_residencia_id,
                        nmunicipio_residencia_id, nparroquia_residencia_id, ssector_residencia, sdireccion_residencia, spunto_ref_residencia,
                        sobservaciones) VALUES ('$snacionalidad', '$ncedula', '$sprimer_nombre', '$ssegundo_nombre',
                        '$sprimer_apellido', '$ssegundo_apellido', '$ssexo', '$dfecha_nacimiento', '$stelefono_personal',
                        '$stelefono_habitacion', '$semail', '$npais_nac_id', '$entidad_nac_id', '$estado_civil_id', '$vehiculo_id',
                        '$bcarnet_patria', '$scodigo_carnet_patria', '$sserial_carnet_patria', '$npais_residencia',
                        '$nentidad_residencia_id', '$nmunicipio_residencia_id', '$nparroquia_residencia_id', '$ssector_residencia',
                        '$sdireccion_residencia', '$spunto_ref_residencia', '$sobservaciones')"; 

                $resultado = pg_query($conn, $sql);*/

    // Insertar en Redes Sociales

    /* if ($redes_sociales >= 1 && $redes_sociales <= 7) {
                    $persona_id = $_POST['persona_id']; // ID de la Persona
                    $redes_sociales_id = $_POST['redes_sociales_id']; // ID de las Redes Sociales
                    $snombre = $_POST['snombre']; // Nombre de la Red Social

                    $sql2 = "INSERT INTO snirlpcd.persona_redes_sociales (persona_id, redes_sociales_id, snombre) Values ('$persona_id',
                            '$redes_sociales_id', '$snombre')";

                    $resultado2 = pg_query($conn, $sql2);
                } */

    // $beneable = $_POST['beneable']; // Segundo Nombre
    // $nusuario_creacion = $_POST['nusuario_creacion']; // Primer Apellido

    //$dfecha_creacion_rs = $_POST['dfecha_creacion']; // Segundo Apellido
...
?>
	...
	include('../mod_login/modal.php');*/
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    ?>
                                    <input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class="form-control form-control-sm" type="text" id="snacionalidad" value="<?= $aDefaultForm['cbNacionalidad_afiliado'] ?>" disabled>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <?/* 
										if($persona['sexo']=='1')
											...
											$sexo = 'Hombre';*/
                                    ?>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class="form-control form-control-sm" type="text" id="ssexo" disabled>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input style="border-radius: 0 15px 15px 0" class="form-control  form-control-sm" type="text" id="fecha_nac" value="<? echo $aDefaultForm['fnacimiento_afiliado']; ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" class="form-control form-control-sm" id="inputEmail3" value="<?= $aDefaultForm['edad'] ?>" disabled></p>
                                </div>
                                <div class="col-sm-6">
                                    <label class="text-secondary" style="margin-top: -2.6px">País de Nacimiento </label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 14px; height: auto;" src="../imagenes/ciudadania.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" onchange="javascript:slc()" name="cbpais_nac_afiliado1" id="cbpais_nac_afiliado1" class="form-control-sm " title="Estado de Nacimiento - Seleccione s&oacute;lo una opci&oacute;n del listado">
                                        <option value="-1">Seleccione</option>
                                        <?
                                        LoadPais_nac_afiliado($conn);
                                        print $GLOBALS['sHtml_cb_Pais_nac_afiliado'];
                                        /*sql = "SELECT * FROM public.pais where status = 'A';";
											$pais = pg_query($conn,$sql);
											$pais = pg_fetch_all($pais);
											foreach($pais as $u) { ?>
                                ...
                                <div class="col-sm-6">
                                    <label class="text-secondary" style="margin-top: -10px">Estado de Nacimiento</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/venezuela.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" name="cbEstado_nac_afiliado" id="cbEstado_nac_afiliado" class="form-control-sm select2" title="Estado de Nacimiento - Seleccione s&oacute;lo una opci&oacute;n del listado" disabled>
                                        <option value="-1">Seleccione</option>
                                        <?/*
											$sql = "SELECT * FROM public.estado where status = 'A';";
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" name="cbEstado_Civil_afiliado" class="form-control-sm select2" id="cbEstado_Civil_afiliado" title="Estado Civil - Seleccione s&oacute;lo una opci&oacute;n del listado">
                                        <option value="-1" selected="selected">Seleccione</option>
                                        <?
                                        LoadEstado_Civil_afiliado($conn);
                                        print $GLOBALS['sHtml_cb_Estado_Civil_afiliado'];
                                        /*$sql = "SELECT * FROM public.estado_civil where status = 'A';";
											$row = pg_query($conn,$sql);
											$estado_civil = pg_fetch_all($row);
											foreach($estado_civil as $u){?>
												<option value="<? echo $u['id'];?>"><? echo $u['nombre'];?></option>
											<?}*/
                                        ?>
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    <label class="text-secondary" style="margin-top: 10px">Teléfono Personal</label><span style="color: red;"> *</span>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img src="../imagenes/Telf.png" style="width: 15px; height: auto"></samp>
                                        </div>
                                        <input placeholder="02121111111" name="telefono_afiliado" id="telefono_afiliado" onKeyPress="return permite(event, 'num')" value="<?= $aDefaultForm['telefono_afiliado'] ?>" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input placeholder="12349876" name="otro_telefono_afiliado" id="otro_telefono_afiliado" onKeyPress="return permite(event, 'num')" value="<?= $aDefaultForm['otro_telefono_afiliado'] ?>" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                ...
                <div class="container-fluid">
                    <div class="card card-info" style="border-radius: 30px;">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label class="text-secondary">Indique que red social posee</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/medios.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" onchange="javascript:sel()" class="form-control-sm select2" id="redes_sociales" name="redes_sociales">
                                        ...
                                        <option value="6">Tik Tok</option>
                                        <option value="7">Otro</option>
                                        <option value="">No poseo</option>
                                    </select>
                                    <script>
                                        function sel() {
                                            ...
                                            if (selec == 1) {
                                                ...
                                                document.getElementById("red8").style.display = 'block';
                                                document.getElementById("btn1").style.display = 'none';
                                                document.getElementById("btn2").style.display = 'none';
                                                document.getElementById("btn3").style.display = 'none';
                                                document.getElementById("btn4").style.display = 'none';
                                ...
                                <!-- Correo -->
                                <div class="col-sm-6" id="red1" style="display: none;">
                                    <label class="text-secondary">Correo Electrónico</label><span style="color: red;"> *</span>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-mail-alt"></samp>
                                        </div>
                                        <input placeholder="usuario@gmail.com" name="email_afiliado" id="email_afiliado" value="<?= $aDefaultForm['email_afiliado'] ?>" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="email">
                                    </div>
                                </div>
                                <!-- Twitter -->
                                <div class="col-sm-6" id="red2" style="display: none;">
                                    <label class="text-secondary">Twitter</label>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-twitter"></samp>
                                        </div>
                                        <input placeholder="Nombre Usuario" name="twitter" id="twitter" value="<?= $aDefaultForm['twitter'] ?>" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <!-- Facebook -->
                                <div class="col-sm-6" id="red3" style="display: none;">
                                    <label class="text-secondary">Facebook</label>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-facebook"></samp>
                                        </div>
                                        <input name="facebook" id="facebook" value="<?= $aDefaultForm['facebook'] ?>" placeholder="Nombre Usuario" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <!-- Telegram -->
                                <div class="col-sm-6" id="red4" style="display: none;">
                                    <label class="text-secondary">Telegram</label>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-telegram"></samp>
                                        </div>
                                        <input placeholder="Nombre Usuario" name="telegram" id="telegram" value="" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <!-- Instagram -->
                                <div class="col-sm-6" id="red5" style="display: none;">
                                    <label class="text-secondary">Instagram</label>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-instagram"></samp>
                                        </div>
                                        <input name="instagram" id="instagram" value="<?= $aDefaultForm['instagram'] ?>" placeholder="Nombre Usuario" style="border-radius: 0 15px 15px 0;" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <!-- Tik Tok -->
                                <div class="col-sm-6" id="red6" style="display: none;">
                                    <label class="text-secondary">Tik Tok</label>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 12px; height: auto;" src="../imagenes/tik-tok.png"></samp>
                                        </div>
                                        <input name="tik_tok" id="tik_tok" value="<?= $aDefaultForm['tik_tok'] ?>" placeholder="Nombre Usuario" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <!-- Otro -->
                                <div class="col-sm-6" id="red7" style="display: none;">
                                    <label class="text-secondary">Nombre de la Red Social</label>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/medios.png"></samp>
                                        </div>
                                        <input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" name="otro" id="otro" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6" id="red8" style="display: none;">
                                    <label class="text-secondary">Nombre de Usuario</label>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/medios.png"></samp>
                                        </div>
                                        <input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" name="otro" id="otro_user" class=" form-control form-control-sm select2" type="text">
                                    </div>
                                </div>
                                <table class="table table-striped table-bordered" style="margin-top: 15px; border-radius: 30px; text-align: center;">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                ...
                                <div class="col-3" id="btn1">
                                    <button style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size:16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip" title="Registrar Usuario" type="submit">Agregar</button>
                                </div>
                                <div class="col-3" id="btn2" style="display: none;">
                                    <button class="sep-3" onclick="agregar(redes_sociales.value);" style="background-color: #fff; color: #46A2FD; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size: 16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' type="submit">Agregar</button>
                                </div>
                                <div class="col-3" id="btn3" style="display: none;">
                                    <button class="sep-3" onclick="agregar(redes_sociales.value);" style="background-color: #fff; color: #46A2FD; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size: 16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' type="submit">Agregar</button>
                                </div>
                                <div class="col-3" id="btn4" style="display: none;">
                                    <button class="sep-3" onclick="agregar(redes_sociales.value);" style="background-color: #fff; color: #46A2FD; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size: 16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' type="submit">Agregar</button>
                                </div>
                                <div class="col-3" id="btn5" style="display: none;">
                                    <button class="sep-3" onclick="agregar(redes_sociales.value);" style="background-color: #fff; color: #46A2FD; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size: 16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' type="submit">Agregar</button>
                                </div>
                                <div class="col-3" id="btn6" style="display: none;">
                                    <button class="sep-3" onclick="agregar(redes_sociales.value);" style="background-color: #fff; color: #46A2FD; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size: 16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' type="submit">Agregar</button>
                                </div>
                                <div class="col-3" id="btn7" style="display: none;">
                                    <button class="sep-3" onclick="agregar(redes_sociales.value);" style="background-color: #fff; color: #46A2FD; border: 1px Solid #46A2FD; padding: 7px 22px; float: right; border-radius: 30px; font-size: 16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' type="submit">Agregar</button>
                                </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card card-info" style="border-radius: 30px;">
                        <!-- Card Header -->
                        <div class="card-header" style="border-radius: 30px 30px 0 0;">
                            <h3 class="card-title">Dirección de Habitación</h3>
                        </div>
                        <!-- /.card-Body -->
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 ">
                                    <label class="text-secondary">País de Residencia</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 14px; height: auto;" src="../imagenes/ciudadania.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" class="form-control-sm select2" name="cbPais_afiliado" id="cbPais_afiliado">
                                        <option value="-1" selected="selected">Seleccione</option>
                                ...
                                <script>
                                    $("#cbPais_afiliado").on("change", function() {
                                        elegido = $("#cbPais_afiliado").val();
                                        combo = 'Estado';
                                        $.post("modelo.php", {
                                            elegido: elegido,
                                            combo: combo
                                ...
                                <div class="col-sm-6">
                                    <label class="text-secondary">Estado</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/venezuela.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" class="form-control-sm select2" name="cbEstado_afiliado" id="cbEstado_afiliado">
                                        <option value="">Seleccione</option>
                                        <?
                                        /*foreach($estado as $u){?>
												<option value="<? echo $u['id'];?>"><? echo $u['nombre'];?></option>
                                ...
                                <div class="col-sm-6">
                                    <label class="text-secondary" style="margin-top: 10px;">Municipio</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/municipio.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" onclick="sele()" class="form-control-sm select2" name="cbMunicipio_afiliado" id="cbMunicipio_afiliado">
                                        <option value="-1">Seleccione</option>
                                        <?/* 
											if(isset($_GET["estado"])){
												$estado2 = $_GET["estado"];
												$sql = "SELECT * FROM public.municipio WHERE status = 'A' AND estado_id = '".$estado2."';";
											}else{
												$sql = "SELECT * FROM public.municipio WHERE status = 'A';";
											}
											$row = pg_query($conn,$sql);
                                ...
                                <div class="col-sm-6">
                                    <label class="text-secondary" style="margin-top: 10px;">Parroquia</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 15px; height: auto;" src="../imagenes/parroquia.png"></samp>
                                        </div>
                                    </div>
                                    <select style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" class="form-control-sm select2" name="cbParroquia_afiliado" id="cbParroquia_afiliado">
                                        <option value="-1">Seleccione</option>
                                        <?/*
											if(isset($_POST['municipio'])){
												$municipio2 = $_POST['municipio'];
												$sql = "SELECT * FROM public.parroquia WHERE status = 'A' AND municipio_id = '".$municipio2."';";
											}else{
												$sql = "SELECT * FROM public.parroquia WHERE status = 'A';";
											}
											$row = pg_query($conn,$sql);
											$parroquia = pg_fetch_all($row);
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input placeholder="La Rosa" name="sector_afiliado" id="sector_afiliado" value="<?= $aDefaultForm['sector_afiliado'] ?>" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class=" form-control form-control-sm select2">
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input placeholder="Bloque 3" value="<?= $aDefaultForm['direccion_afiliado'] ?>" name="direccion_afiliado" id="direccion_afiliado" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class=" form-control form-control-sm select2" type="text">
                                </div>
                                <div class="col-sm-12 ">
                                    ...
                                    <textarea placeholder="Ejm: Frente al ciber 'Aquí se Roba Internet'" class="form-control" id="observacion_datos_per" value="<?= $aDefaultForm['observacion_datos_per'] ?>" name="referencia" style="border-radius: 30px" id="referencia"></textarea>
                                </div>
                                <!--div class="col-sm-2">
								<div class="col-sm-2">
                ...
                <div class="container-fluid">
                    <div class="card card-info" style="border-radius: 30px;">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label class="text-secondary">¿Es Jefe o Jefa de Hogar?</label><span style="color: red;"> *</span>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-home"></samp>
                                        </div>
                                        <select name="cbJefe_familia" id="cbJefe_familia" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" class="form-control-sm select2">
                                            <option value="-1" selected="selected">Seleccione</option>
                                            <option value="1" <? if (($aDefaultForm['cbJefe_familia']) == '1') print 'selected="selected"'; ?>>Si</option>
                                            <option value="0" <? if (($aDefaultForm['cbJefe_familia']) == '0') print 'selected="selected"'; ?>>No</option>
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <label class="text-secondary">¿Tiene Hijos?</label><span style="color: red;"> *</span>
                                    <div>
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 12px; height: auto;" src="../imagenes/familia.png" alt=""></samp>
                                        </div>
                                        <select name="cbHijos" id="cbHijos" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" onchange="javascript:hijos();" class="form-control-sm select2">
                                            <option value="-1" selected="selected">Seleccione</option>
                                            <option value="1" <? if (($aDefaultForm['cbHijos']) == '1') print 'selected="selected"'; ?>>Si</option>
                                            <option value="0" <? if (($aDefaultForm['cbHijos']) == '0') print 'selected="selected"'; ?>>No</option>
                                        </select>
                                ...
                                <div class="col-sm-6" id="hijos2" style="display: none;">
                                    <label class="text-secondary" style="margin-top: 10px">¿Cuantos Menores de 18?</label><span style="color: red;"> *</span>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 12px; height: auto;" src="../imagenes/menor.png"></samp>
                                        </div>
                                        <input placeholder="1" name="hijos_menores" type="number" min="0" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" class=" form-control form-control-sm select2" id="hijos_menores" onKeyPress="return permite(event, 'num')" value="<?= $aDefaultForm['hijos_menores'] ?>" size="5" maxlength="2">
                                    </div>
                                </div>
                                <div class="col-sm-6" id="hijos1" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input placeholder="1" name="hijos_mayores" type="number" min="0" class=" form-control form-control-sm select2" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" id="hijos_mayores" onKeyPress="return permite(event, 'num')" value="<?= $aDefaultForm['hijos_mayores'] ?>" size="5" maxlength="2">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="card card-default" style="border-radius: 30px; ">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label class="text-secondary">¿Tiene Vehículos?</label>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp style="font-size: 13px;" class="icon-card"></samp>
                                        </div>
                                        <select name="cbVehiculo_afiliado" id="cbVehiculo_afiliado" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: gray" class="form-control-sm select2">
                                            <option value="-1" selected="selected">Seleccione</option>
                                            <?
                                            LoadVehiculo_afiliado($conn);
                                            print $GLOBALS['sHtml_cb_Vehiculo_afiliado'];
                                            /*$sql = "SELECT * FROM public.tipo_vehiculo WHERE status = 'A';";
											$row = pg_query($conn,$sql);
											$vehiculo = pg_fetch_all($row);
											foreach($vehiculo as $vehiculos){ ?>
												<option value="<? echo $vehiculos['id'];?>"><? echo $vehiculos['nombre'];?></option>
											<?}*/ ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <label class="text-secondary">¿Posee Carnet de la Patria?</label><span style="color: red;"> *</span>
                                    <div class="input-group">
                                        <div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
                                            <samp><img style="width: 12px; height: auto;" src="../imagenes/carnet.png"></samp>
                                        </div>
                                        <select class="form-control-sm select2" onchange="javascript:carnet()" name="carnet_patria" id="carnet_patria" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey">
                                            <option value="">Seleccione</option>
                                ...
                                <div class="col-sm-6" id="car1" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="codigo" id="codigo" placeholder="1234567890" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" class=" form-control form-control-sm" type="text" min="10" maxlength="10" onkeypress="return valideKey(event);" />
                                ...
                                <div class="col-sm-6" id="car2" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input placeholder="1234567890" name="serial" id="serial" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" class=" form-control form-control-sm" type="text" min="10" maxlength="10" onkeypress="return valideKey2(event);" />
                                        <script type="text/javascript">
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    <textarea class="form-control" id="observacion_datos_per" value="<?= $aDefaultForm['observacion_datos_per'] ?>" name="Observaciones" style="border-radius: 30px" id="observaciones_generales"></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-sm-7">
                                    ...
                                    <buttom style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;
                                    float: right; border-radius: 30px; font-size:16px" onmouseout='this.style.color="#fff";
                                    this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' onclick="enviar(
                                    snacionalidad.value, ssexo.value, fecha_nac.value, cbpais_nac_afiliado1.value,
                                    cbEstado_nac_afiliado.value, cbEstado_Civil_afiliado.value, telefono_afiliado.value,
                                    otro_telefono_afiliado.value, redes_sociales.value, facebook.value, email_afiliado.value,
                                    twitter.value, telegram.value, instagram.value, tik_tok.value, otro.value, otro_user.value,
                                    cbPais_afiliado.value, cbEstado_afiliado.value, cbMunicipio_afiliado.value, cbParroquia_afiliado.value,
                                    sector_afiliado.value, direccion_afiliado.value, referencia.value, cbJefe_familia.value, cbHijos.value,
                                    hijos_menores.value, hijos_mayores.value, cbVehiculo_afiliado.value, carnet_patria.value, codigo.value,
                                    serial.value, observaciones_generales.value);" data-bs-toggle="tooltip" type="submit">
                                        Continuar
                                    </buttom>
                                    <!-- </a> -->
                                </div>
        ...
        <script src="modificar_datos_personales.js"></script>
    </form>
    <!--script>
		function comprobar(){

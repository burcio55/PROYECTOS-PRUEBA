		...
		if($_SESSION['tipo_usuario']==2){	
			if($_SESSION['migra_bloq']==1){
				if ($_SESSION['disc_bloq']==1){
					?>
					<script>
						document.location='1_4agen_trab_ocupacion.php'
					</script>
					<? 
				}else{
					?>
				...
				?>
					<script>
						document.location='1_2agen_trab_migrante.php'
					</script>
				<? 
			}
		}else{
...
?>
	...
	<div class="content-video2 video">
		<video src="../videos/video_datos_personales.mp4" class="video" controls>
						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-6">
									...
									<input tabindex="14" aria-label="Es obligatorio indicar cual es el Estado en dónde nació" type="text" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%;" class="form-control form-control-sm" id="cbEstado_nac_extranjero" name="cbEstado_nac_extranjero" onkeyup="mayus(this);">
								...
								<div class="col-sm-6" tabindex="16">
									...
									<input style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%" class="form-control form-control-sm" id="Correo" disabled>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6 ">
									...
									<select tabindex="23" alt="Es obligatorio indicar cual es el país en donde se encuentra su redidencia actual" style="border-radius: 0 15px 15px 0; margin: -31px 0 0 29px; width: 94%; border: 1px solid #ccc; color: grey" onchange="cambios_pais(pais_residencia.value)" class="form-control-sm select2" name="pais_residencia" id="pais_residencia" onkeyup="mayus(this);">
										<option value="-1">Seleccione</option>
										<option value="245" selected="selected">Venezuela</option>
									</select>
								</div>
								<div class="col-sm-6">
							...
							<form class="form-horizontal">
								<div class="form-group row">
									...
									<div class="col-sm-6" id="red2" style="display: none;" tabindex="36">
										<label style="color: #312E33">X (Twitter)</label>
										<div class="input-group">
											<div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">
												<samp style="font-size: 13px;"> <img style="width: 13px;" src="../imagenes/x.png"></samp>
											</div>
									...
									<table class="table table-bordered table-striped table-sm hover" style="background-color: white; margin-top: 15px; text-align: left">
										<thead>
											<tr>
												<th scope="col">#</th>
						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-6" id="hijos2" style="display: none;">
									<label style="color: #312E33; margin-top: 10px">¿Cuantos Menores de 18?</label>
									<div class="input-group">
										<div class="input-group-addon" style="width:31px; height:31px; padding:7px 0 7px 10px; border: 1px solid #cccccc; background-color: #E6E6E6; border-radius: 15px 0 0 15px">

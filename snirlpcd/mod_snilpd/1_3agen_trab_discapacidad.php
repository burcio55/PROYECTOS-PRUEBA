...
?>
<form name="frm_discapacidad" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" >
<script>
...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
       ...
       <tr>
       	 <th colspan="4" height="20" class="sub_titulo" align="left">SITUACI&Oacute;N DE DISCAPACIDAD</th>
        </tr>
        <tr>
        	<td colspan="4" align="right"><span class="requerido">Campos obligatorios (*)</span>&nbsp;</td>
        </tr>
        <tr class="identificacion_seccion">
         	<th colspan="4" class="sub_titulo_2" align="left">Datos de la situación de discapacidad</th>
        </tr>
     
    
      <tr>
        <th width="46%" align="left" style="background-color:#F0F0F0;" class="sub_titulo">Tipo de discapacidad: </th>
        <td colspan="2">
          <select name="cbTipo_discapacidad" class="texto-normal" id="cbTipo_discapacidad" title="Tipo de discapacidad - Seleccione solo una opcion del listado" <? if($_POST['edit']=="1"){ $disabled='disabled';} echo $disabled;?>>
      ...
      <tr>
        <th align="left"style="background-color:#F0F0F0;" class="sub_titulo" >Origen de la discapacidad :</div></th>
        <td colspan="2">
        <select name="cbDiscapacidad_origen" class="texto-normal" id="cbDiscapacidad_origen" title="Origen de la discapacidad - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
      ...
      <tr id="div_adquirida">
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo">Causa de discapacidad adquirida:</th>
        <td colspan="2"><select name="cbAdquirida" id="cbAdquirida" class="texto-normal" title="Origen de la discapacidad adquirida - Seleccione solo una opcion del listado">
            <option value="-1">Seleccionar</option>
          </select><span class="requerido"> * </span>   </td>
      </tr>
      <tr>
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo" >¿Posee calificaci&oacute;n de discapacidad?:</th>
      ...
      <tr>
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo" >¿Posee certificaci&oacute;n de discapacidad?: </th>
        ...
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo" >¿Qui&eacute;n certifica?: </th>
        <td>
        <select name="cbCertificado" class="texto-normal" id="cbCertificado" title="Quien certifica - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
      ...
      <tr>
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo">Grado de discapacidad: </th>
        <td colspan="2">
          <select name="cbDiscapacidad_nivel" class="texto-normal" id="cbDiscapacidad_nivel" title="Grado de discapacidad - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
      ...
      <tr>
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo" >¿Requiere ayuda t&eacute;cnica?: </th>
      ...
      <tr id="tr_Tipo_Ayuda_discapacidad">
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo">¿Tipo de  ayuda técnica: </th>
        <td colspan="2">
          <select name="cbTipo_Ayuda_discapacidad" class="texto-normal" id="cbTipo_Ayuda_discapacidad" title="Tipo de ayuda tecnica - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
            <? LoadTipo_Ayuda_discapacidad($conn); print $GLOBALS['sHtml_cb_Tipo_Ayuda_discapacidad'];?>
          </select></td>
      </tr>
      <tr id="tr_Nivel_autonomia">
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo" >Grado de autonom&iacute;a: </th>
        <td colspan="3">
          <select name="cbDiscapacidad_nivel_depen" class="texto-normal" id="cbDiscapacidad_nivel_depen" title="Grado de autonomia - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
     ...
     <!-- <tr id="tr_frecuencia">
        ...
        <td colspan="3">
          <select name="cbFrecuencia" class="texto-normal" id="cbFrecuencia" title="Frecuencia con que asiste - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
      ...
      <tr id="tr_medicamento">
        ...
        <td colspan="2"><input name="medicamento" type="text" class="texto-normal" id="medicamento" value="<?=$aDefaultForm['medicamento']?>" size="50" maxlength="100" title="Especif&iacute;que medicamentos - Ingrese letras y/o numeros"></td>
      </tr>
      
      <tr>  
        <td align="right" >Referido a: </td>
        <td>
        <select name="cbReferido_discapacidad" class="texto-normal" id="cbReferido_discapacidad" title="Referido a otro servicios - Seleccione solo una opcion del listado">
            <option value="-1" selected="selected">Seleccione</option>
      ...
      <tr>
        <th align="left" style="background-color:#F0F0F0;" class="sub_titulo" >Observaciones generales: </th>
        <td colspan="2"><input name="Observaciones_discapacidad" type="text" class="texto-normal" id="Observaciones_discapacidad" value="<?=$aDefaultForm['Observaciones_discapacidad']?>
    " size="50" maxlength="100" title="Observaciones del funcionario que ingresa la informacion - Ingrese letras y/o numeros">      </td>
      ...
      <tr>
        <td colspan="3" align="center"><span class="requerido">
            <? if($_POST['edit']==""){ ?>
            <button type="button" name="Agregar"  id="Agregar" class="button_personal btn_agregar"  onClick="javascript:send('Agregar');">Agregar</button>
              <? }
             else{ ?>
            <button type="button" name="Actualizar"  id="Actualizar" class="button_personal btn_editar"  onClick="javascript:send('Agregar');">Actualizar</button>
          </span>
            <? }?>
            ...
            <button type="button" name="Cancelar"  id="Cancelar" class="button_personal btn_cancelar"  onClick="javascript:send('Cancelar');">Cancelar</button>
             ...
             <thead> 
              <tr>
              <th width="34%" class="sub_titulo">Tipo Discapacidad </th>
              <th width="37%" class="sub_titulo">Grado Discapacidad </th>
              <th width="22%" class="sub_titulo">Origen</th>
...
//		else $class_name = "dataListColumn";
		?>
            <tr  >
              <td style="background-color:#F0F0F0;" class="texto-normal"><div align="left"><?=$aTabla[$i]['discapacidad']?></div></td>
              <td style="background-color:#F0F0F0;" class="texto-normal"><div align="left"><?=$aTabla[$i]['nivel']?></div></td>
              <td style="background-color:#F0F0F0;"  class="texto-normal"><div align="left"><?=$aTabla[$i]['origen']?></div></td>
              <td style="background-color:#F0F0F0;" class="texto-normal"><a href="1_3agen_trab_discapacidad.php?id_po=<?=$aTabla[$i]['id']?>&accion=1"><img src="../imagenes/pencil_16.png"  border="0" title="Editar" /></a>             
              
             <a href="1_3agen_trab_discapacidad.php?id_po=<?=$aTabla[$i]['id']?>&accion=2"><img src="../imagenes/delete_16.png"  border="0" title="Eliminar" /></a> </td>        
            </tr>
            <? } ?>
           </tbody>
           </thead> 

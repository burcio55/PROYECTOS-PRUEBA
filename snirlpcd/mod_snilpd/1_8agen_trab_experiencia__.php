       ...
       <tr>
        ...
        <tr id="tr_experiencia1" style="background-color:#F0F0F0; color:#666" align="right">
         <td colspan="2" style="background-color:#F0F0F0; color:#666" >  <strong>N° Registro de Información Fiscal:</strong>
           ...
           <span class="requerido">*  </span>         </td>
        <td  colspan="2"style="background-color:#F0F0F0; color:#666" align="left" > <button type="submit" name="btRif"  id="btRif" class="button_personal"  onclick="javascript:send('btRif');" title="Buscar en el Registro Nacional de Entidades de Trabajo">Buscar en RNET</button>
          </td>
        </tr>        
<!--::::::::::::::::::::::::::::::::::::-->
        ...
        <th colspan="4" class="sub_titulo_2" align="left">Datos del Empleo</th>
        	...
        	<tr id="tr_experiencia12">
            	...
            	<td style="background-color:#F0F0F0;" ><span class="links-menu-izq">
            	  <select name="cbMotivo_retiro2" style="width: 95%" class="tablaborde_shadow" title="Causales de terminación de la relación de trabajo - Seleccione solo una opcion del listado">
            	    <option value="-1" selected="selected">Seleccionar</option>

        ...
        <div id="contenido">
            <form name="frm_rnet_plantilla" id="frm_rnet_plantilla" method="post" action="/mpppst/rnet/mod_rnet/rnet_modificar_planilla.php">
                ...
                <div class="content-full">
                    <br>
                    <div class="jumbotron">
                        <h2 class="text-secondary font-weight-bold">Ofertas de Empleo Registradas</h2>
                        <a href="oferta_empleo.php">
                            <input class="btn btn-sm btn-success" style="float: right; margin-top: -27px; width: 20%; border-radius: 30px;" value="Registrar Oferta de Empleo">
                        </a>
                        <br>
                    </div>
                    <hr>
                        ...
                        <thead>
                            <center>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 32%;">Acción</th>
                                </tr>
                        </thead>
                        <tbody>
                            <? while ($persona7 = pg_fetch_assoc($row2)) { 
                                ...
                                where rnee.rnee_condicion_actividad_movimiento.id = '".$persona7['rnee_condicion_actividad_movimiento_id']."' 
                                and rnee.rnee_condicion_actividad_movimiento.nenabled='1' limit 1";
                                ...
                                <tr>
                                    ...
                                    <td id="horario"><? echo $persona8['srazon_social'] ?></td>
                                    <? if($persona8['sucursal'] == 0){ ?>
                                        <td id="dias"> Sede principal </td>
                                    <?} else { ?>
                                        <td id="dias">Sucursal</td>
                                    <?}?>
                                    <td id="botones">
                                        <button type="button" class="btn btn-primary" style="background-color: #008cba; border-radius: 30px;" onclick="postulaciones(<? echo $persona7['id'];?>)">Postulaciones</button>
                                        <button type="button" class="btn btn-warning" style="background-color: #e99002; border-radius: 30px;" onclick="modificar(<? echo $persona7['id'];?>)">Modificar</button>
                                        <button type="button" class="btn btn-danger" onclick="eliminarRegistro(<? echo $persona7['id'];?>)" style="background-color: #f04124; border-radius: 30px;">Eliminar</button>
                                    </td>
                                </tr>
                            <? } ?>
                        </tbody>

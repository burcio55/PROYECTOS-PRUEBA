...
<!--table width="90%" border="0" align="center" >
	  ...
	  <? 
		if (!isset($_SESSION['migra_bloq'])) { 
	    	$class_name='links-menu-izq" href="1_2agen_trab_migrante.php" title="Detalla los Datos Migratorios del(de la) Trabajador(a)';
				}  
	 else{
		  	$class_name='links-menu-izq" title="M&oacute;dulo deshabilitado';
				}
...
<tr>
<td width="15%" class="subtititulos"><a class="links-menu-izq" href="1_1agen_trab_datos.php" title="El registro de trabajadores(as)  le permitirÃ¡ postularse a todas las bÃºsquedas de oportunidades de trabajo y capacitaciÃ³n disponibles en el sistema y, las entidades de trabajo que accedan a nuestra base de datos en busca de candidatos y candidatas podrÃ¡n consultarlo.">
<div align="center">Datos Personales </div></a></td>

<td width="17%" class="subtititulos"><a class="<?=$class_name?>"><div align="center">Migraci&oacute;n</div></a></td>

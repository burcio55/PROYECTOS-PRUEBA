            ...
            <div class="contenedor_login-register">
                ...
                <form id="frm" name="frm" action="login4.php" method="POST" class="formulario_login needs-validation">
                    ...
                    <div class="input-group" style="margin-bottom: 30px">
                        <select tabindex="6" aria-label="Es obligatorio indicar su nacionalidad" style="width: 15%" data-bs-toggle="tooltip" data-bs-placement="left" title="Nacionalidad" id="cbCed_afiliado" name="cbCed_afiliado">
                            <option value="">***</option>
                        ...
                        <input tabindex="7" aria-label="Es obligatorio indicar su cédula de Indentidad" class="form-control" type="text" style="width: 75%;" placeholder="Cédula de Identidad *" onkeypress="return numbers(event);" id="txt_usuario" name="txt_usuario" value="">
                    </div>
                    ...
                    <div style="margin-top: 20px;">
                        <input tabindex="8" aria-label="Es obligatorio indicar su contraseña en caso de que se halla registrado" class="form-control" type="password" style="width: 90%; margin: -10px 0 0 0; position:relative;" placeholder="Contraseña *" id="txt_clave" name="txt_clave" value="">
                    ...
                    <div class="input-group" style="margin-top: 10px;">
                        <div class="col-sm-6">
                            <input tabindex="10" aria-label=" El recapcha es el siguiente <?php echo $codigo; ?>" class="form-control cod-1" type="text" style="width: 90%; height: 45px; border-radius: 30px 0 0 30px" id="txt_codigo" name="txt_codigo" value="<?php echo $codigo; ?>" readonly>
                        </div>
                        <div class="col-sm-6">
                            <input tabindex="11" aria-label="Es obligario copiar el recapcha tal cual lo escucho" class="form-control cod-2" type="text" style="width: 90%; height: 45px; border-radius: 0 30px 30px 0" placeholder="Introducir Código" id="txt_codigo2" name="txt_codigo2" value="" maxlength="6" onkeypress="mayus(this);">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input tabindex="13" aria-label="olvidó contraseña" type="submit" style="width: 63%; font-size: 16px; background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; font-weight: bold;" onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' id="btn_olvido_clave" value="¿Olvidó Contraseña?">
                    </div>
                    <p>Se recomienda usar el navegador Google Chrome</p>
                </form>
            </div>
        </div>
    </main>
        ...
        <div class="pub-2" style="margin: -98px auto 0 auto">
            <center>
                ...
                <div class="cent"><br><br><br>
                    <h5 tabindex="45" style="color: white; font-size: 15px"> Ministerio del Poder Popular para el Proceso Social del Trabajo <br> Oficina de Tecnología de la Información y la Comunicación (OTIC). <br> Análisis y Desarrollo de Sistemas. <br> © 2023 Todos los Derechos Reservados.</h5>
                </div>
            </center>
        </div>
        <!--div class="sepa"></div>

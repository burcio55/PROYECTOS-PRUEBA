                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa- user"></i>Nombres y Apellidos</a>

                            <a class="nav-link" href="#"><i class="fa fa- user"></i>Correo Electronico  <span class="count">13</span></a>


                            <a class="nav-link" href="#"><i class="fa fa-power -off"></i>Cerrar Sesiòn</a>
                        </div>
                    </div>

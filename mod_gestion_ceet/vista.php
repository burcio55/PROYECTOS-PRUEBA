                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="" class="col-md-12">
                        <div class="card-header" style="border-radius: 30px 30px 0 0; padding: 30px 0 10px 20px; background-color: #fff">
                            ...
                            <img src="imagenes/logo.png" style="width: 80%; height: auto; margin: auto">
                            <!-- Título del logo -->
                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h3 style="font-size: 16px">Ministerio del Poder Popular para el Proceso Social de Trabajo
                                    </h3>
                                    <h3 style="font-size: 16px">Oficina de Tecnología de la Información y la Comunicación - División Análisis y Desarrollo de Sistemas
                                    </h3>

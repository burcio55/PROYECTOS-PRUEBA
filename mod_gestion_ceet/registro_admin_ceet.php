            ...
            <div class="row">
                    ...
                    <div class="jumbotron">
                        <form method="POST" action="" class="col-md-8 fondo">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h2 style="color: rgb(35, 96, 249); font-size:22px;padding: 20px 0 10px 20px">MOTIVOS<span class="requid"> * </span></h2>
                                    </div>
                                    <div class="col-sm-4"></div>
                                    <div class="col-sm-4">
                                        <h4 style="padding: 20px 0 10px 20px"> Campos Obligatorios (*) </h4>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row justify-content-start">
                                        ...
                                        <div class="col-sm-3" id="boton_reportar">
                                            ...
                                            <button type="button" style="display: none; background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto; " onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip" onclick="accion_motivo_act(motivo_id.value,motivo.value)" id="motivo_act">
                                                Actualizar
                                            </button>
                ...
                <div class="col-md-12 sep-y">
                    <div class="jumbotron">
                        <form method="POST" action="" class="col-md-8 fondo">
                            <!--   <div class="card-header bg-primary" style="border-radius: 30px 30px 0 0; padding: 20px 0 10px 20px">
                                <h3 class="card-title"> PLAN DE FORMACIÓN </h3>
                            </div> -->
                            <div class="card-body">

                                <div class="row">
                                    <div class="col-sm-6">
                                        <h2 style="color: rgb(35, 96, 249); font-size:22px;padding: 20px 0 10px 20px">PLANES DE FORMACIÓN<span class="requid"> * </span></h2>
                                    </div>
                    ...
                    <div class="jumbotron">
                        <form method="POST" action="" class="col-md-8 fondo">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h2 style="color: rgb(35, 96, 249); font-size:22px;padding: 20px 0 10px 20px">NOVEDADES<span class="requid"> * </span></h2>
                                    </div>
                                    <div class="col-sm-4"></div>
                                    <div class="col-sm-4">
                                        <h4 style="padding: 20px 0 10px 20px"> Campos Obligatorios (*) </h4>
                    ...
                    <div class="jumbotron">
                        <form method="POST" action="" class="col-md-8 fondo">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h2 style="color: rgb(35, 96, 249); font-size:22px;padding: 20px 0 10px 20px">MOTORES<span class="requid"> * </span></h2>
                                    </div>
                                    <div class="col-sm-4"></div>
                                    <div class="col-sm-4">
                                        <h4 style="padding: 20px 0 10px 20px"> Campos Obligatorios (*) </h4>
                ...
                <div class="col-md-12 sep-y">
                    <div class="jumbotron">
                        <form method="POST" action="" class="col-md-8 fondo">
                            <!--  <div class="card-header bg-primary" style="border-radius: 30px 30px 0 0; padding: 20px 0 10px 20px">
                                <h3 class="card-title"> AMBIENTE DE APRENDIZAJE</h3>
                            </div> -->
                            <div class="card-body">

                                <div class="row">
                                    <div class="col-sm-6">
                                        <h2 style="color: rgb(35, 96, 249); font-size:22px;padding: 20px 0 10px 20px">AMBIENTES DE APRENDIZAJES<span class="requid"> * </span></h2>
                                    </div>
                                    <div class="col-sm-2"></div>
                                    <div class="col-sm-4">
                                        <h4 style="padding: 20px 0 10px 20px"> Campos Obligatorios (*) </h4>

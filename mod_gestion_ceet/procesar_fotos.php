...
$bambiente_formacion = $_SESSION["bambiente_formacion"];
$bexp_productiva_detec = $_SESSION["bexp_productiva_detec"];
$binsercion_laboral = $_SESSION["binsercion_laboral"];
...
if (isset($_FILES["pla_cptt"])) {
    ...
    move_uploaded_file($temporal7, $ruta7);
}
...
if ($type1 > 0 || $type2 > 0 || $type3 > 0 || $type4 > 0 || $type5 > 0 || $type6 > 0) {
    $mostrar = '
        <!DOCTYPE html>
        <html lang="Es-es">
        <head>
...
$SQL .= " AND";
$SQL .= " bexp_productiva_detec = '$bexp_productiva_detec'";
$SQL .= " AND";
$SQL .= " benabled = 'TRUE'";

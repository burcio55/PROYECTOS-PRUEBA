...
?>
	...
	<td>
		...
		<form name="sistemas" id="sistemas" method="post">
		<script type="text/javascript" src="funciones_admin_accesos.js"></script>
		<script src="/minpptrassi/datatables/funcion_paginador.js"></script>
			<table width="90%" border="0" align="center" class="formulario">
				...
				<tr>
					<th width="100%" colspan="2" class="sub_titulo" align="left"> 1.- MODULOS ROLES OPCIONES</th>
				</tr>
				...
				<tr>
					<td width="20%"><div align="right">Modulos: </div></td>
					<td width="80%">

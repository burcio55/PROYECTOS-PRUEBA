...
<div id="observacion3" class="fondo_alerta" style="display: none;">
    <div class="alerta">
       ...
       <button type="button" onclick="accion_eliminar_asig(bienes_publicos_id.value,id_usuario.value,ci5.value)" style="display:none;background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' id="eli" data-bs-toggle="tooltip">Eliminar</button>
    </center>
        <div class="sep"></div>
    </div>
</div>
                    ...
                    <hr>
                        <div class="sep"></div>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="ci1" placeholder="Ingrese una cédula de Identidad" maxlength="8">
                   ...
                   <div class="row">
                    ...
                    <div class="sep"></div>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="ci2" placeholder="Ingrese una cédula de Identidad" maxlength="8">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="8" style="" id="cbp2" aria-describedby="basic-addon3 basic-addon4" placeholder="Nro B.P">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                            <label for="basic-url" class="form-label">Fecha de Asignación</label><span> *</span>
                            <div class="input-group">
                                <span class="input-group-text" style="border-radius: 30px 0 0 30px;" id="basic-addon3">
                                    <img src="imagenes/ob.png" class="input-imagen">
                                </span>

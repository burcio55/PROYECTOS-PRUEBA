    ...
    <div id="observacion3" class="fondo_alerta" style="display: none;">
        <div class="alerta" style="text-align: center;">
            ...
            <center><button type="button" onclick="cerrar_alert3()" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Cerrar</button>
                <button type="button" onclick="accion_eliminar4(pass.value)" style="display:none;background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' id="eli" data-bs-toggle="tooltip">Eliminar</button>
            </center>
            <div class="sep"></div>
        </div>
    </div>
...
<body>
            ...
            <div class="content-login">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <!--Titulo -->
                        <div class="col-sm-8">
                            <h1 style="font-size:32px; font-weight: normal;">MANTENIMIENTO-Catálogos-Estado del B.P</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <label for="basic-url" class="form-label" style="font-size: 20px;margin-top:auto;">Estado del B.P</label><span style="margin-right:10px;" class="centro"> *</span>
                                ...
                                <input type="text" class="form-control" id="est2" aria-describedby="basic-addon3 basic-addon4" placeholder="Ingrese el nuevo Estado del B.P">
                                <input type="text" class="form-control" style="display: none;" id="id_mantenimiento5" aria-describedby="basic-addon3 basic-addon4" placeholder="Ingrese el nuevo Estado del B.P">


                                <button onclick="agg_estado(est2.value)" id="bt1" type="button" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0 30px 30px 0; " onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Agregar</button>
                                <button onclick="accion_modificar_mod5(id_mantenimiento5.value,est2.value)" id="bt2" type="submit" style=" display:none; background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0 30px 30px 0; " onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Actualizar</button>
                                <div class="col-sm-3"></div>
                            </div>
                            <div class="sep"></div>
                        ...
                        <div class="col-sm-10">
                            <table id="myTable" style="border-radius: 30px;">
                                ...
                                <tbody id="fe">
                                    <?php
                                    $i = 0;
                                    $sql = "SELECT id, sdescripcion FROM bienes_publicos.estado WHERE benabled='TRUE' ORDER BY sdescripcion ASC";
                                    ...
                                    while ($or = pg_fetch_assoc($row)) {
                                        ...
                                        $cosa .= "<tr>
                                               ...
                                               <td class=\"td center\" id=\"botones\">
                                                   <button type=\"button\" class=\"btn btn-warning\" style=\"background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD;   border-radius: 30px; width: auto;\" onclick=\"accion_modificar4('" . $or['id'] . "','" . $or['sdescripcion'] . "')\">Modificar</button>";
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" style="text-align: center;">
                            <button type="button" style="width: 120px; background-color: darkgray; color: #fff; border: 1px Solid darkgray; padding: 7px 22px; border-radius: 30px; font-size:16px;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="darkgray"; this.style.border="1px Solid darkgray"' onmouseover='this.style.color="darkgray"; this.style.backgroundColor="#fff";'><a href="mantenimiento3.php">Regresar</a></button>
                            <!-- <button type="submit" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip"  id="motivo_agr"><a href="mantenimiento5.php">Siguiente</a></button> -->
                            <br><br>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
    ...
    <script>
        document.getElementById('est2').addEventListener('input', function(e) {

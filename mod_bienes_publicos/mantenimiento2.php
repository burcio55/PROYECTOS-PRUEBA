...
<div id="observacion3" class="fondo_alerta" style="display: none;">
    <div class="alerta" style="text-align: center;">
        ...
        <center><button type="button" onclick="cerrar_alert3()" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Cerrar</button>
            <button type="button" onclick="accion_eliminar2(pass.value)" style="display:none;background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' id="eli" data-bs-toggle="tooltip">Eliminar</button>
        </center>
        <div class="sep"></div>
    </div>
</div>
...
<body>
            ...
            <div class="content-login">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <!--Titulo -->
                        <div class="col-sm-8">
                            <h1 style="font-size:32px; font-weight: normal;">MANTENIMIENTO-Catálogos-Marca</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <label for="basic-url" class="form-label" style="font-size: 20px; margin-top:auto;">Marca</label><span class="centro" style="margin-right:10px;"> *</span>
                                ...
                                <input type="text" class="form-control" id="marc2" aria-describedby="basic-addon3 basic-addon4" placeholder="Ingrese la nuevo Marca">
                                <input type="text" class="form-control" style="display: none;" id="id_mantenimiento3" aria-describedby="basic-addon3 basic-addon4" placeholder="Ingrese el nuevo Origen">


                                <button onclick="agg_marca(marc2.value)" id="bt1" type="button" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0 30px 30px 0; " onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Agregar</button>
                                <button onclick="accion_modificar_mod3(id_mantenimiento3.value,marc2.value)" id="bt2" type="button" style=" display:none; background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px;margin-top:0; border-radius: 0 30px 30px 0; " onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip">Actualizar</button>
                                <div class="col-sm-3"></div>
                            </div>
                            <div class="sep"></div>
                        ...
                        <div class="col-sm-10">
                            <table id="myTable" style="border-radius: 30px;">
                                ...
                                <tbody id="fe">
                                    <?php
                                    $i = 0;
                                    $sql = "SELECT id, sdescripcion FROM bienes_publicos.marca WHERE benabled='TRUE' ORDER BY sdescripcion ASC";
                                    ...
                                    while ($or = pg_fetch_assoc($row)) {
                                        ...
                                        $cosa .= "<tr>
                                               ...
                                               <td class=\"td center\" id=\"botones\">
                                                   <button type=\"button\" class=\"btn btn-warning\" style=\"background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD;  border-radius: 30px; width: auto;\" onclick=\"accion_modificar2('" . $or['id'] . "','" . $or['sdescripcion'] . "')\">Modificar</button>";
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" style="text-align: center;">
                            <button type="button" style="width: 120px; background-color: darkgray; color: #fff; border: 1px Solid darkgray; padding: 7px 22px; border-radius: 30px; font-size:16px" onmouseout='this.style.color="#fff"; this.style.backgroundColor="darkgray"; this.style.border="1px Solid darkgray"' onmouseover='this.style.color="darkgray"; this.style.backgroundColor="#fff";'><a href="mantenimiento.php">Regresar</a></button>
                            <!--  <button type="submit" style="background-color: #46A2FD; color: #fff; border: 1px Solid #46A2FD; padding: 7px 22px; border-radius: 30px; width: auto;" onmouseout='this.style.color="#fff"; this.style.backgroundColor="#46A2FD"; this.style.border="1px Solid #46A2FD"' onmouseover='this.style.color="#46A2FD"; this.style.backgroundColor="#fff";' data-bs-toggle="tooltip"  id="motivo_agr"><a href="mantenimiento3.php">Siguiente</a></button> -->
                            <br><br>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
    ...
    <script>
        document.getElementById('marc2').addEventListener('input', function(e) {

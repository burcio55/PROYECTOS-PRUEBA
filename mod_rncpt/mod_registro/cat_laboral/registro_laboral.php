...
?>
	...
	<tr valign="top">
	<td>
    <form id="form_registro_laboral" name="form_registro_laboral" method="post" action="<?=$_SERVER['PHP_SELF'] ?>" >
    <input name="action" type="hidden" value=""/>
    <script type="text/javascript" src="funciones_laboral.js"></script>    
    <script>
    function send(saction){
          var form = document.form_registro_laboral;

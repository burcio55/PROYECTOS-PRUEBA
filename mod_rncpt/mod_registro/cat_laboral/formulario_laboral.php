...
debug();
				...
				if($_REQUEST['id']!=''){
									 $SQL="SELECT id, sdescripcion 
  										   FROM rncpt.condicion_laboral WHERE id=".$_REQUEST['id']."";
									$rs=$conn->Execute($SQL);
			
									if($rs->RecordCount()>0){
									$aDefaultForm['txt_descripcion']=$rs->fields['sdescripcion'];
									$aDefaultForm['laboral_id']=$rs->fields['id'];																			
									}else{
									$aDefaultForm['txt_descripcion']='';
									$aDefaultForm['laboral_id']='';											
									}

				}

?>
<form id="formulario_registro_laboral" name="formulario_registro_laboral" action="registro_data.php" method="post">
<input name="id" id="id" type="hidden" value="<?=$aDefaultForm['laboral_id']?>"/>
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
        <th colspan="4"  class="sub_titulo"><div align="left">MANTENIMIENTO --> Cat&aacute;logos --> Condiciòn Laboral</div></th>
    </tr>
    ...
    <tr>
      <th colspan="2" class="sub_titulo_3" ><div align="right">Condiciòn Laboral</div></th>
        <td width="74%" colspan="2" align="center">
        <input type="text" name="txt_descripcion" id="txt_descripcion" placeholder="Condiciòn Laboral" value="<?= $aDefaultForm['txt_descripcion'];?>" maxlength="60" size="40" style="width:80%"/>
          <span>*</span>	
        </td>
     </tr>   

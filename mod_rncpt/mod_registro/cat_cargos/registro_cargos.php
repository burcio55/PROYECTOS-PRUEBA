...
?>
	...
	<tr valign="top">
	<td>
    <form id="form_registro_cargos" name="form_registro_cargos" method="post" action="<?=$_SERVER['PHP_SELF'] ?>" >
    <input name="action" type="hidden" value=""/>
    <script type="text/javascript" src="funciones_cargos.js"></script>    
    <script>
    function send(saction){
          var form = document.form_registro_cargos;

function mostrar_formulario(){
	$.ajax({
	type: 'POST',
	url: 'formulario_condicion.php',
	success: function(data) {
		$('#formulario_condicion').html(data);
		$('#btnAgregar').show();
		$('#btnModificar').hide();
	 }
  });	
...
function modificar(){
		...
		$.ajax({
			...
			'&opcion='+7+'&condicion_id='+document.getElementById("id").value,
			success: function(data) {
					//alert(data);
					if(data=='modificado'){		

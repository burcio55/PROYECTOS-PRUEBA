...
$dataSaime['estatus'] = $data['ESTATUS_WEBSERVER'];
	...
	if($numcedula == $cedula){
		$datos = array("response"=>"success", "apellidonombre"=>$apellidonombre, "cedulaidentida"=>$numcedula, "primer_nombre"=>$primer_nombre, "segundo_nombre"=>$segundo_nombre, "primer_apellido"=>$primer_apellido, "segundo_apellido"=>$segundo_apellido, "sexo"=>$sexo,"fechanac"=>$fechanac );

...
<table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
  <tr>
  	<th colspan="4" class="sub_titulo_2"><div align="left">REPORTE DE LOS INTEGRANTES DEL CPT POR ENTIDAD DE TRABAJO Y ESTADO</div></th>
  </tr>
 	<? //if($_SESSION['ntipo']!='3'){?>
  <tr>
    ...
    <? LoadEstadoReporte ($conn) ; print $GLOBALS['sHtml_cb_Estado_Reporte']; ?>
		...
		<span>*</span>	
    <button type="button" name="cmd_buscar"  id="cmd_buscar" class="button" title="Buscar Registro -  Haga Click para Buscar" onclick="javascript:reporte_miembros();">
    <img src="../imagenes/buscar.png" alt="16" width="16" />           
    </button> 
    </td>
  </tr>
  <? //}?>
    ...
    <table width="100%" border="0" align="center" class="formulario" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="4" align="center">
            ...
            <div id="empresa_miembros" style=" height:200px;" ></div>
          </td>
        </tr>
    </table>
    <tr>

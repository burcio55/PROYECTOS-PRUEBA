...
$SQL = "SELECT miembros_empresa.id, 
				...
				AND miembros_empresa.condicion_act_id=1
				AND miembros_empresa.nenabled = '1';";
				 $rs = $conn->Execute($SQL);
				if ($rs->RecordCount()>0){
					if($rs->RecordCount()<3  ){
						?><script>alert("EL CPTT NO ESTÁ DEBIDAMENTE CONTITUIDO AL MENOS DEBE TENER MÍNIMO TRES(3) Y MÁXIMO SIETE(7) VOCEROS");</script><?
					}else{
				while(!$rs->EOF){
					$aTabla[]=array();
					$c = count($aTabla)-1;
			 ...
			 ?><script>alert("EL NRO. DE BOLETA NO EXISTE");</script><?
			 }	 
 }	else{
	 ?><script>alert("EL NRO. DE BOLETA NO EXISTE");</script><?
	 }	 
...
<tr>
 <td>
   ...
   <div align="justify">Quien suscribe,<b>JOSÉ RAMÓN RIVERO GONZÁLEZ</b>, Ministro del Poder Popular para el Proceso Social de Trabajo, conforme a las atribuciones consagradas en la ley Orgánica del Trabajo, las trabajadoras y los trabajadores (LOTTT) y lo establecido en el artículo 6 de la ley constitucional de los Consejos Productivos de Trabajadores y siendo que esta nueva forma de organización de la clase obrera, ha sido concebida como instrumento para el impulso de la Participación Protagónica de las Trabajadoras y los Trabajadores en el impulso de la actividad productiva nacional desde las entidades de trabajo; previa constataciòn de que se ha cumplido los requisitos legales que deben concurrir al efecto, <b>DECLARO</b> legalmente constituido a los ciudadanos:<b> $nombre_completo</b> titulares de la cédula de identidad Nº <b> $cedula </b>respectivamente, como voceros y voceras del Consejo Productivo de Trabajadores de la entidad de trabajo <b>$empresa ($sucursal)</b>, por un período de dos años, contados a partir de la fecha de su elección. En consiguiente los mismo. no podrán ser despedidos, trasladados o desmejorados de sus puesto de trabajo, sin justa causa previamente calificada por el Inspector o Inspectora del Trabajo y en nombre del Ministerio del Poder Popular para el Proceso Social de Trabajo, como Órgano Rector <b>ORDENO</b> el Registro correspondiente, conforme a los dispuesto en la norma ut supra señalada </div></td>    
</tr>
<tr><td height="60"> </td>
</table>
EOD;
...
<tr>
 <td align="center"  style=" font-size:10pt; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif" >
     <b> JOSÉ RAMÓN RIVERO GONZÁLEZ</b>  
   </td>    
</tr>
...
<td>
	...
	<tr>
	<td>
		<label align="right" style=" font-size:6pt; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">www.mpppst.gob.ve</label>	
	</td>
	</tr>
	<tr>
	
	<td>
	<label align="right" style=" font-size:6pt; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Registro Nacional de los <br> Consejos Productivos de <br>las Trabajadoras y Trabajadores</label>	
	</td>
	</tr>
</td>
</tr>

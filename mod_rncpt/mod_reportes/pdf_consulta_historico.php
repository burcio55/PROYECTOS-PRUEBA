...
$fecha = date('d/m/Y');
$cadena= $_SESSION['aDefaults']['cadena'];
$tbl='';
$tbl.='<table width="100%" cellPadding="1" cellSpacing="1">
		<tr color="#1060C8">
		<th align="center"><h2>REPORTE DE MOVIMIENTO DE LOS VOCEROS QUE HAN REGISTRADOS EN UN CONSEJO PRODUCTIVO DE TRABAJADORAS Y TRABAJADORES EN EL RNCPTT</h2></th>
		</tr>
</table>';
...
$pdf->Output('Historico_rncptt'.$_SESSION['id_usuario'].'_'.date('d/m/y').'.pdf', 'I');

...
?>
<script type="text/javascript" src="funciones_saime_modificar.js"></script>		
...
<table width="100%" border="0" align="center" class="formulario cuerpo" cellpadding="0" cellspacing="0">
  <tr>
    <th align="left" colspan="4" height="20" class="titulo">SAIME</th>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right" height="20">Cedula:</td>
    <td>
    	<input name="txt_cedula" type="text" id="txt_cedula"  title="Cedula - Formato:V30012345 " value=""  maxlength="10" />
    	<span>*</span>  
    </td>
  </tr>
  <tr>
    <td align="right" height="20">Primer nombre:</td>
    <td>
    	<input name="txt_primer_nombre" type="text" id="txt_primer_nombre"  title="Primer nombre " value="" size="40" maxlength="50" />        
    	<span>*</span>
    </td>
  </tr>
  <tr>
    <td align="right" height="20">Segundo nombre:</td>
    <td>
    	<input name="txt_segundo_nombre" type="text" id="txt_segundo_nombre"  title="Segundo nombre " value="" size="40" maxlength="50" />        
    	<span>*</span>
    </td>
  </tr>
  
  <tr>
    <td align="right" height="20">Primer apellido:</td>
    <td>
    	<input name="txt_primer_apellido" type="text" id="txt_primer_apellido"  title="Primer apellido " value="" size="40" maxlength="50" />        
    	<span>*</span>
    </td>
  </tr>
  
  <tr>
    <td align="right" height="20">Segundo apellido:</td>
    <td>
    	<input name="txt_segundo_apellido" type="text" id="txt_segundo_apellido"  title="Segundo apellido " value="" size="40" maxlength="50" />        
    	<span>*</span>
    </td>
  </tr>
  <tr>
    <td align="right" height="20">Sexo:</td>
    <td>
    <select id="cbo_sexo" name="cbo_sexo" >
        <option value=""<?php if (!(strcmp('',$aDefaultForm['cbo_pais_origen']))) {echo " selected=\"selected\"";}?>>Seleccionar</option>
		 <option value="M"<?php if (!(strcmp('M ',$aDefaultForm['cbo_pais_origen']))) {echo " selected=\"selected\"";}?>>Masculino </option>
         <option value="F"<?php if (!(strcmp('F',$aDefaultForm['cbo_pais_origen']))) {echo " selected=\"selected\"";}?>>Femenino </option>
    </select>      
    	<span>*</span>
    </td>
  </tr>
  <tr>
    <td align="right" height="20">Fecha nacimiento:</td>
    <td>  
  ...
  <tr>
    <td align="right" height="20">Nacionalidad:</td>
    <td>
...
<tr>
    <td align="right" height="20">Pais de origen:</td>
    <td>

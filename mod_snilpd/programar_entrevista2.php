                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" placeholder="Ej. 08:30" class="form-control" style="border-radius: 30px 0 0 30px; width: 94%; height: 31px; border: 1px solid #ccc; color: gray" class=" form-control form-control-sm" id="Hora" value="" size="50" maxlength="100">
                            </div>
                            <div class="col-sm-2">
                ...
                <form class="form-horizontal" style="padding: 20px">
                    ...
                    <div class="form-group row">
                        <center>
                            ...
                            <input onclick="programar(Fecha.value,Hora.value,AmPm.value,texto.value)" class="btn btn-sm btn-primary" readonly style="float: center; margin-top: 0; width: 20%; border-radius: 30px; font-size: 16px; font-family: Arial;" data-bs-toggle="tooltip" value="Programar Entrevista">
                        </center>
                    </div>
                </form>
            </div>

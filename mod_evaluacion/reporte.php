...
<main>
    <div class="content-3d">
        <div class="container">
            ...
            <div class="content-login">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 style="font-size:32px; font-weight: normal;">REPORTES - Varios</h1>
                    </div>
                    ...
                    <form name="formulario" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" id="formulario">
                        <div class="row">
                            ...
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                ...
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;">1.- Total de la Población Laboral del Organismo</h2>
                            </th>
                            <div class="sep"></div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"> TIPO DE PERSONAL </th>
                                        <th class="th" style="background: #b6b4b4b2;"> N° </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"><b> TOTAL </b></th>
                                        <th class="th center" style="background: #b6b4b4b2;"><b> <? echo $total1; ?> </b></th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                ...
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;">2.- Total de la Población Laboral del Organismo Evaluado</h2>
                            </th>
                            <div class="sep"></div>
                            <table class="table table-bordered">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"><b> TOTAL </b></th>
                                        <th class="th" style="background: #b6b4b4b2;"><b> <? echo $total2; ?> </b></th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                ...
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;"> 3.- Total de la Población Laboral del Organismo No Evaluado</h2>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"><b> TOTAL </b></th>
                                        <th class="th" style="background: #b6b4b4b2;"><b> <? echo $total3; ?> </b></th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;"> 4.- Distribución del Personal Evaluado en los Rangos de Actuación
                                </h2>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"> RANGO DE ACTUACIÓN </th>
                                        <th class="th" style="background: #b6b4b4b2;"> <? echo $num_periodo; ?> </th>
                                        <th class="th" style="background: #b6b4b4b2;"> PORCENTAJE </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"> TOTAL </th>
                                        <th class="th" style="background: #b6b4b4b2;"> <? echo $total4; ?> </th>
                                        <th class="th" style="background: #b6b4b4b2;"> <? echo $total_porcentajes; ?>% </th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;"> 5.- Razones y Circunstancias por las cuales la población OBJETO <br>de Evaluación quedó excluida del Proceso de Evaluación
                                </h2>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="th" colspan="2" style="background: #b6b4b4b2;"> RAZONES Y CIRCUNSTANCIAS </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    ?><!-- 
                                                                <tr>
                                                                    <td class="td"> Reposos Médicos </td>
                                                                    <td class="td center"> 33 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> Vacaciones Prolongadas </td>
                                                                    <td class="td center"> 118 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> No Evaluados por los Supervisores </td>
                                                                    <td class="td center"> 27 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> Suspendidos </td>
                                                                    <td class="td center"> 58 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> Cambio de modalidad de pago </td>
                                                                    <td class="td center"> 35 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> Apoyo institucional a otros entes </td>
                                                                    <td class="td center"> 22 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> Devueltas por correcciones </td>
                                                                    <td class="td center"> 2 </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td"> No Aplica (personal nuevo ingreso) </td>
                                                                    <td class="td center"> 0 </td>
                                                                </tr> -->
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"><b> TOTAL </b></th>
                                        <th class="th center" style="background: #b6b4b4b2;"><b> <? echo $total5; ?> </b></th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                ...
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;">6.- Ministerio del Poder Popular para el Proceso Social de TRABAJO (MPPPST)</h2>
                            </th>
                            <div class="sep"></div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"> TIPO DE PERSONAL </th>
                                        <th class="th" style="background: #b6b4b4b2;"> N° </th>
                                        <th class="th" style="background: #b6b4b4b2;"> EXCELENTE </th>
                                        <th class="th" style="background: #b6b4b4b2;"> MUY BUENO </th>
                                        <th class="th" style="background: #b6b4b4b2;"> BUENO </th>
                                        <th class="th" style="background: #b6b4b4b2;"> CUMPLIMIENTO ORDINARIO </th>
                                        <th class="th" style="background: #b6b4b4b2;"> NO CUMPLIÓ </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <th style="background: #b6b4b4b2;" class="th"><b> TOTAL </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6 ?> </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_1 ?> </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_2 ?> </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_3 ?> </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_4 ?> </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_5 ?> </b></th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                ...
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;"> 7.- Evaluaciones de Desempeño <? echo $num_periodo2; ?> <br> Ministerio del Poder Popular para el Proceso Social de Trabajo</h2>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="th" style="background: #b6b4b4b2;"> RANGO DE ACTUACIÓN </th>
                                        <th class="th" style="background: #b6b4b4b2;"> TOTAL DE EVALUADOS </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <th style="background: #b6b4b4b2;" class="th"><b> TOTAL </b></th>
                                        <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total7; ?> </b></th>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;"> 8.- Evaluación de Desempeño del MPPPST <br> <? echo $num_periodo2; ?>
                                </h2>
                            ...
                            <div class="sep"></div>
                            <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;"> 9.- Diseño Horizontal
                                </h2>
    ...
    display: inline-block;">
                                    <thead>
                                        <tr>
                                            <th class="th" style="background: #b6b4b4b2;">
                                                <h6> ORGANISMO</h6>
                                            </th>
                                            <th class="th" style="background: #b6b4b4b2;">
                                                <h6> TIPO DE CARGO</h6>
                                            ...
                                            <th class="th" style="background: #b6b4b4b2;">
                                                <h6> TOTAL EVALUADOS</h6>
                                            </th>
                                            <th class="th" style="background: #b6b4b4b2;">
                                                <h6> TOTAL NO EVALUADOS</h6>
                                            </th>
                                            <th class="th" style="background: #b6b4b4b2;">
                                                <h6>TOTAL POBLACIÓN </h6>
                                            </th>
                                            <th class="th" style="background: #b6b4b4b2;">
                                                <h6>EXCELENTE</h6>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="td" rowspan="10">
                                                <h6> Ministerio del Poder Popular para el Proceso Social de Trabajo (MPPPST) </h6>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td">
                                        ...
                                        <tr>
                                            <th
                                                style="background: #b6b4b4b2;" class="th">
                                                <h6> TOTAL </h6>
                                            </th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total2; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total3; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total1; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_1_2; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_2_2; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_3_2; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_4_2; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th center"><b> <? echo $total6_5_2; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th"><b> </b></th>
                                        </tr>
                                        <tr>
                                            <th
                                                style="background: #b6b4b4b2;" class="th" colspan="2">
                                                <h6> TOTAL POBLACIÓN = PERSONAL <br> EVALUADO + NO EVALUADO </h6>
                                            </th>
                                            <th style="background: #b6b4b4b2;" class="th center" colspan="2"><b> <? echo $total2_3; ?> </b></th>
                                            <th style="background: #b6b4b4b2;" class="th" colspan="6"><b> </b></th>
                                        </tr>
                                        <tr>
                                            <th style="background: #b6b4b4b2;" class="th" colspan="4">
                                                <h6> TOTAL PERSONAL EVALUADO POR RANGO DE ACTUACIÓN </h6>
                                            </th>
                                            <th style="background: #b6b4b4b2;" class="th center" colspan="6"><b> <? echo $total1; ?> </b></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

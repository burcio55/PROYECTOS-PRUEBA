<?php
    ...
    if($accion == 1){
        ...
        if($row = pg_query($conn, $SQL)){
            echo "1 / Se guardó con exito la información accion es 4 ".$SQL;
            die();
        }else{
            echo "0 / Se presentó un error, favor intentar más tarde / ".$SQL;
            die();
        ...
        if($row = pg_query($conn, $SQL)){
            echo "1 / Se guardó con exito la información ".$SQL;
            die();
        }else{
            echo "0 / Se presentó un error, favor intentar más tarde / ".$SQL;
            die();
        ...
        if($row = pg_query($conn, $SQL)){
            echo "1 / Se guardó con exito la información accion es 6 ". $SQL;
            die();
        }else{
            echo "0 / Se presentó un error, favor intentar más tarde / ".$SQL;
            die();

                        ...
                        <table width="95%" border="0" align="center" class="formulario">
                            <tr>
                                <th colspan="4" class="sub_titulo">
                                    <div align="left">REPORTES --> Varios </div>
                                </th>
                            </tr>
                            ...
                            <tr style="margin-top: 30px;">
                                ...
                                <td align="center" style="border-radius: 30px;" width="23%">
                                    <font color="#666666">
                                        <input style="border-radius: 30px; border: solid 1px #999999; width:50%; float:left; text-align:center" type="text" value="<? echo $desde; ?>" placeholder="" readonly />
                                    </font>
                                </td>
                                <th style="color: grey; text-align:right" width="23%">Hasta : </th>
                                <td align="center" style="border-radius: 30px;" width="23%">
                                    <font color="#666666">
                                        <input style="border-radius: 30px; border: solid 1px #999999; width:50%; float:left; text-align:center" type="text" value="<? echo $hasta; ?>" placeholder="" readonly />
                                    </font>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table style="width: 100%; border: 2px black solid; border-collapse: collapse; width: 100%; margin: 20px auto;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="th"> <? echo $num_periodo; ?> </th>
                            ...
                            <!-- ------------------------------ 5.- Razones y Circunstancias por las cuales la población OBJETO de Evaluación quedó excluida del Proceso de Evaluación --------------------------------------  -->
                            ...
                            <tr class="identificacion_seccion">
                                <th colspan="4" width="100%" align="center" style="font-size: 15px" class="title">
                                    6.- Ministerio del Poder Popular para el Proceso Social de TRABAJO (MPPPST)
                                </th>
                            </tr>
                            <tr>
                                <td colspan="4"> </td>
                            ...
                            <!-- ------------------------------ 7.- Evaluaciones de Desempeño <? echo $num_periodo2; ?> Ministerio del Poder Popular para el Proceso Social de Trabajo --------------------------------------  -->
                                    ...
                                    <table style="width: 100%; border: 2px black solid; border-collapse: collapse; width: 100%; margin: 20px auto;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="th"> TOTAL EVALUADOS </th>
                                                <th class="th"> TOTAL NO EVALUADOS </th>
                                                <th class="th"> TOTAL POBLACIÓN </th>
                                                <th class="th"> EXCELENTE </th>
                                                <th class="th"> MUY BUENO </th>
                                                <th class="th"> BUENO </th>
                                                <th class="th"> CUMPLIMIENTO ORDINARIO </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="td"><b> CONTRATADOS </b></td>
                                                <td class="td center"> <? echo $num_registro11; ?> </td>
                                                <td class="td center"> <? echo $num_registro18; ?> </td>
                                                <td class="td center"> <? echo $num_registro4; ?> </td>
                                                <td class="td center"> <? echo $num_registro38_1; ?> </td>

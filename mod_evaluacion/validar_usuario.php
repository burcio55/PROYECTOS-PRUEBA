...
if ($accion == 1) {
    ...
    if ($cont > 0) {
        ...
        echo "1 / " . $nombre;
        $SQL2 = "SELECT * FROM public.personales_rol WHERE personales_cedula = '" . $cedula . "' AND rol_id >= '84' AND rol_id <= '87' AND nenabled = '1'";
    ...
    $SQL2 = "SELECT * FROM public.personales_rol WHERE personales_cedula = '" . $cedula . "' AND rol_id >= '84' AND rol_id <= '87' AND nenabled = '1'";
            ...
            if ($accion == 2) {
                ...
                if ($accion == 2) {
                    ...
                    $SQL1 = "UPDATE public.personales_rol SET nenabled='0' WHERE personales_cedula='" . $cedula . "'  AND nenabled='1' AND rol_id >= '84' AND rol_id <= '87'" ;
    ...
    if ($cont2 > 0) {
        ...
        $SQL3 = "SELECT * FROM public.personales_rol WHERE personales_cedula = '" . $cedula . "' AND rol_id >= '84' AND rol_id <= '87'";

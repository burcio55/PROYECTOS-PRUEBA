...
<div style="background-color: white; width: 40%; padding: 20px; border-radius: 30px; border: grey 1px solid; position:absolute; margin-left: 30%; display:none; margin-top: 10%" id="alerta2">
    <form action="razon.php" method="post">
        ...
        <input type="text" value="<? /* echo $id2; */ ?>" style="display: none" disabled>
        <br>
        <button type="submit" style="padding: 5px 10px; border-radius: 20px; border: 1px grey solid" onclick="cerrar2()">Enviar</button>
    </form>
</div>
<?php
include("header.php");
...
$pixar = pg_query($conn, $evaluador);
$objeto = pg_fetch_assoc($pixar);
...
$last_name1 = $objeto["apellido1"];
$last_name2 = $objeto["apellido2"];
$first_name = $objeto["nombre1"];
$second_name = $objeto["nombre2"];

echo $full_name;

$full_name = $last_name1 . " " . $last_name2 . " " . $first_name . " " . $second_name;

$name_code = $objeto["codigo_nom"];
$current_physical_location = $objeto["ubicacion_fisica_actual"];
$current_position_held = $objeto["cargo_actual_ejerce"];
$worker_type = $objeto["tipo_trabajador"];
$position = $objeto["cargo"];
$position_id = $objeto["cargo_id"];
$code_types_workers = $_SESSION["codigo_tipos_trabajadores"];
$adm_location = $objeto["ubicacion_adm"];
$location_code = $objeto["ubicacion_scodigo"];
...
<main>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4"> <label for="basic-url" class="form-label" style="margin-top:10px">Cédula de Identidad </label> <span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled type="text" class="form-control" name="cedula1" id="cedula1" value="<? echo $identificacion ?>" placeholder="" readonly>
                            </div>
                        </div>
                        <div class="col-sm-8"> <label for="basic-url" class="form-label" style="margin-top:10px">Apellido(s) y Nombre(s) </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled type="text" class="form-control" name="nombre_apellido1" id="nombre_apellido1" value="<? echo $full_name ?>" placeholder="" readonly>
                            </div>
                        ...
                        <div class="col-sm-4"> <label for="basic-url" class="form-label" style="margin-top:10px">Código de Nómina </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="codigo1" id="codigo1" type="text" value="<? echo $name_code ?>" placeholder="" readonly>
                        ...
                        <div class="col-sm-8"><label for="basic-url" class="form-label" style="margin-top:10px">Tipo de Trabajador </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="tipo_trabajador" id="tipo_trabajador" type="text" value="<? echo $worker_type  ?>" placeholder="" readonly>
                        ...
                        <div class="col-sm-6"> <label for="basic-url" class="form-label" style="margin-top:10px">Cargo o Puesto de Trabajo que Ejerce </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="cargo_ejerce1" id="cargo_ejerce1" type="text" value="<? echo $current_position_held ?>" placeholder="" readonly>
                        ...
                        <div class="col-sm-6"><label for="basic-url" class="form-label" style="margin-top:10px">Cargo o Puesto de Trabajo Titular </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="cargo1" id="cargo1" type="text" value="<? echo $position ?>" placeholder="" readonly>
                        ...
                        <div class="col-sm-6"> <label for="basic-url" class="form-label" style="margin-top:10px">Ubicación Administrativa de Adscripción</label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="ubicacion_adm1" id="ubicacion_adm1" type="text" value="<? echo $adm_location  ?>" placeholder="" readonly>
                        ...
                        <div class="col-sm-6"><label for="basic-url" class="form-label" style="margin-top:10px">Ubicación Física </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="ubicacion_act" id="ubicacion_act" type="text" value="<? echo $current_physical_location ?>" placeholder="" readonly>
                        ...
                        <div class="col-sm-4"> <label for="basic-url" class="form-label" style="margin-top:10px">Código de Nómina </label><span></span>
                            <div class="input-group">
                                ...
                                <input style="border-radius: 0px 30px 30px 0px;background: #b6b4b4b2;" disabled class="form-control" name="codigo2" id="codigo2" type="text" value="<? echo $codigo_nom ?>" placeholder="" readonly>
 ...
 -->
                        ...
                        <form class="col-md-12 fondo" action="/minpptrassi/mod_evaluacion/files.php" method="POST" enctype="multipart/form-data">

                            <div class="col-sm-4">
                                <h2 style="color: rgb(35, 96, 249); font-size:22px;">OBSERVACION(ES) DEL ANALISTA</h2>
                            </div>
                            <div class="col-sm-4"></div>
                            <div class="col-sm-4"></div>
                            ...
                            <div class="col-sm-12"><label for="basic-url" class="form-label" style="margin-top:10px">Observacion(es) </label>

                                <textarea name="observacion_analista" id="observacion_analista" cols="0" rows="0" style="border-radius: 30px; border-color:#999999; min-width: 99%; max-width: 99%; float:left; height: 70px; padding: 10px;"></textarea>
                            ...
                            <center>
                                ...
                                <input type="button" style="background-color: rgb(70, 162, 253); color: rgb(255, 255, 255); border: 1px solid rgb(70, 162, 253); padding: 7px 22px; border-radius:30px; width: auto; margin-left: -15px;margin: 0" onmouseout="this.style.color=&quot;#fff&quot;; this.style.backgroundColor=&quot;#46A2FD&quot;; this.style.border=&quot;1px Solid #46A2FD&quot;" onmouseover="this.style.color=&quot;#46A2FD&quot;; this.style.backgroundColor=&quot;#fff&quot;;" data-bs-toggle="tooltip" onclick="guardar(<? echo $_REQUEST['id']; ?>)" value="Guardar">
                            </center>
